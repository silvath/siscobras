...
namespace Report
{
	#region SDReport
	/// <summary>
	/// SDReport encapsulates the mechanism for creating 
	/// pdf document. Use SDReport to create pdf document. To 
	/// start print job, call the BeginDoc method.To print page,
	/// call the Print method. And call the EndDoc method to 
	/// terminate print job.If you want to terminate print job 
	/// unless saving document, call the Abort method.
	/// </summary>
	[ToolboxItem(true)]
	internal class SDReport:AbstractSDReport
	{
		...
		/// <summary>
		/// Set FileName to specify the file name to save 
		/// document.
		/// </summary>
		...
		/// If UseOutline property set to false, OutlineRoot 
		/// peoperty returns null.
		/// </summary>
		[Browsable(false)]
		...
		/// <summary>
		/// PageNumber contains the current page number being 
		/// printed.
		/// </summary>
		[Browsable(false)]
		...
		/// <summary>
		/// Set CreationDate to specify the date and time when
		...
		/// <summary>
		/// Set Keywords to specify the date and time when the 
		...
		/// <summary>
		/// PageLayout specifies the layout for the page when 
		...
		/// <summary>
		/// PageMode property specifies how the document should 
		...
		/// <summary>
		/// UseOutline determine whether using outlines or not. 
		/// This property can be set only before BeginDoc() 
		/// method called.
		/// </summary>
		[DefaultValue(false)]
		...
		/// <summary>
		/// Abort terminates the current print job, dropping all 
		/// data.
		/// </summary>
		public void Abort()
		{
		...
		/// <summary>
		/// Print add the page that specified APage parameter 
		/// to the PDF document.
		/// </summary>
		/// <param name="APage">Printig page</param>
		...
		/// <summary>
		/// EndDoc ends the current print job and outputs PDF 
		...
		/// <summary>
		/// OpenAction determins the location of the display 
		/// window and zoom level when the first page appears. 
		/// If null, the top of the first page appears with 
		/// default zoom level.
		/// </summary>
	...
	#region EventArgs
	internal class SDPrintChildPanelEventArgs:EventArgs
	{
	...
	internal class SDPrintPanelEventArgs:EventArgs
	{
		public SDCanvas ACanvas;
		public Rectangle Rect;
	}

	internal class SDPrintPageEventArgs:EventArgs
	{
		public SDCanvas ACanvas;
	}
	#endregion
	...
	#region delegates
	internal delegate void SDPrintChildPanelEvent(object sender,SDPrintChildPanelEventArgs arg);
	internal delegate void SDPrintPanelEvent(object sender,SDPrintPanelEventArgs arg);
	internal delegate void SDPrintPageEvent(object sender,SDPrintPageEventArgs arg);
	#endregion	
	...
	internal class SDCanvas
	{
		...
		public void SetHorizontalScaling(ushort hScaling)
		{
		...
		{
			PdfCanvas.TextRect(Generic._PdfRect(ARect.Left,PdfCanvas.PageHeight-ARect.Top,
	...
	internal class SDPage:ScrollableControl
	{
		#region class events
		/// <summary>
		...
		/// </summary>
		internal event SDPrintPageEvent PrintPage;
		#endregion
		...
		public void Print(SDCanvas ACanvas)
		{
			...
			for(int i=0;i<Controls.Count;i++)
			{
				if(Controls[i] is SDPanel)
				{
					...
					FPanel.Print(ACanvas,new Rectangle(new System.Drawing.Point(0,0),Controls[i].Size));
				}
			}
		}
		#endregion
	...
	#region SDPanel
	[ToolboxItem(false)]
	internal class SDPanel:ScrollableControl
	{
		#region class methods
		protected override void OnPaint(PaintEventArgs e)
		{			
	...
	internal class SDLayoutPanel:SDPanel
	{
		#region class events
		/// <summary>
		...
		/// </summary>
		internal event SDPrintPanelEvent BeforePrint;
		/// <summary>
		/// AfterPrint is called after a page was printed.
		/// </summary>
		internal event SDPrintPanelEvent AfterPrint;
		#endregion
	...
	internal class SDLabel:SDCustomLabel
	{
		#region class variables
		...
		void SetCanvasProperties(PdfCanvas ACanvas)
		{
			...
			ACanvas.SetFont(this.Font,Text);
			ACanvas.SetRGBFillColor(this.ForeColor);
			ACanvas.SetWordSpace(WordSpace);
			if(AlignJustified)
			{
				ACanvas.SetCharSpace(0);
				TmpWidth=ACanvas.TextWidth(Text);
				CharCount=Generic._GetCharCount(Text);
				if(CharCount>1)
	...
	[ToolboxItem(false)]
	internal class SDCustomLabel:SDItem
	{
		#region class variables
	...
	/// </summary>
	[DefaultEvent("BeforePrint")]
	internal class SDGridPanel:SDPanel
	{
		#region class events
		/// <summary>
		/// BeforePrint is called before a page is about to be 
		...
		{
			Rectangle Rect;			
			Rect=Generic._GridPanelBounds(TableColCount,TableRowCount,Location.X,Location.Y,Width,Height);
	...
	internal class SDText:SDCustomLabel
	{
		#region class variables
		string[] FLines;
		float FLeading;
		...
		public override void Print(SDCanvas ACanvas,Rectangle ARect)
		{
			...
			ACanvas.PdfCanvas.MultilineTextRect(Generic._PdfRect(ARect.Left,
	...
	internal class SDRect:SDShape
	{
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			pen.DashStyle=Generic._PenStyleToDashStyle((int)LineStyle);
			pen.Width=LineWidth;
			if(DrawLine==true)
			{
	...
	/// </summary>
	[DefaultProperty("LineStyle")]
	internal class SDEllipse:SDShape
	{
		#region class methods
		protected override void OnPaint(PaintEventArgs e)
		{
	...
	/// </summary>
	[DefaultProperty("Picture")]
	internal class SDJPegImage:SDImage
	{
		#region class properties
		/// <summary>
		/// Specifies the image that appears on the control. 
	...
	internal class SDAnnotation:SDItem
	{
		#region class variables
		string[] FLines;
		bool FOpened;
		...
		public override void Print(SDCanvas ACanvas,Rectangle ARect)
		{
			...
			FAnnotation=ACanvas.PdfCanvas.Doc.CreateAnnotation(PdfAnnotationSubType.asTextNotes,
				Generic._PdfRect(tmpRect.Left,Page.Height-tmpRect.Bottom,tmpRect.Right,Page.Height-tmpRect.Top));
