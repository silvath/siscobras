...
namespace PdfTypes
{
	...
	public class PdfNumber:PdfObject
	{
		...
		protected override void InternalWriteStream(MemoryStream AStream)
		{
			Generic._WriteString(FValue.ToString(),AStream);
		}
		#endregion
	}
	#endregion
	...
	public class PdfBoolean:PdfObject
	{
		...
		{
			if(Value)
				Generic._WriteString("true",AStream);
			else
				Generic._WriteString("false",AStream);
		}
		#endregion
	...
	public class PdfNull:PdfObject
	{
		protected override void InternalWriteStream(MemoryStream AStream)
		{
			Generic._WriteString("null",AStream);
		}
	}
	#endregion
	#region PdfRect
