...
public class Generic
{
	...
	public static ushort PDF_MIN_HORIZONTALSCALING = 10;
	public static ushort PDF_MAX_HORIZONTALSCALING = 300;
	public static float PDF_MAX_LEADING = 300;

	const ushort PDF_PAGE_WIDTH_A4 = 596;
	const ushort PDF_PAGE_HEIGHT_A4 = 842;

	public static ushort PDF_DEFAULT_PAGE_WIDTH = PDF_PAGE_WIDTH_A4;
	public static ushort PDF_DEFAULT_PAGE_HEIGHT = PDF_PAGE_HEIGHT_A4;
	...
	public static string PdfCreator_VERSION_TEXT="Siscobras Exporta Fácil";
	#endregion
	...
	public static Rectangle _GridPanelBounds(int ColCount,int RowCount,int X,int Y,int Width,int Height)
	{
	...
	public static System.Drawing.Drawing2D.DashStyle _PenStyleToDashStyle(int ps)
	{
	...
	public static PdfFont.PDF_STR_TBL[] _String_Table()
	{
	...
	public static PdfFont.PDF_STR_TBL[] _String_TableTrueType()
	{
		PdfFont.PDF_STR_TBL s1;
		PdfFont.PDF_STR_TBL s2;
		PdfFont.PDF_STR_TBL s3;
	...
	public static PdfFont.PDF_INT_TBL[] _Int_Table()
	{
	...
	public static PdfFont.PDF_INT_TBL[] _Int_TableTrueType()
	{
		PdfFont.PDF_INT_TBL i1;
		PdfFont.PDF_INT_TBL i2;
	...
	public static PdfFont.PDF_STR_TBL[] _Script_String_Table()
	{
		PdfFont.PDF_STR_TBL s1;
		PdfFont.PDF_STR_TBL s2;
		PdfFont.PDF_STR_TBL s3;
	...
	public static PdfFont.PDF_INT_TBL[] _Script_Int_Table()
	{
		PdfFont.PDF_INT_TBL i1;
		PdfFont.PDF_INT_TBL i2;
	...
	public static int _GetCharCount(string Text)
	{
		int FReturn;
		FReturn=0;
	...
	public static string _StrToHex(string Value)
	{
		string freturn;
		freturn="";
	...
	public static string _EscapeText(string Value)
	{
	...
	public static string _FloatToStrR(double Value)
	{
	...
	public static void _WriteString(string Value,MemoryStream AStream)
	{
	...
	public static DateTime _PdfDateToDateTime(string AText)
	{
		if(AText.Length!=16)
	...
	public static string _DateTimeToPdfDate(DateTime ADate)
	{						
		return String.Format("D:{0:yyyyMMddHHmmss}",ADate);
	}

	public static string _GetTypeOf(PdfDictionary ADictionary)
	{
		PdfName Pdfname;
	...
	public static void _Pages_AddKids(PdfDictionary AParent,PdfDictionary AKid)
	{
		PdfArray FKids;
