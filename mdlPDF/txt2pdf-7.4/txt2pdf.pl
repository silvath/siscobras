...
# txt2pdf -- Text to PDF
#
# by SANFACE Software <sanface@sanface.com> 19th June 2004
#
# txt2pdf 7.x is shareware.
...
#
# You can upgrade txt2pdf 4.x, 5.x, 6.x to the new version with the discount of
# the amount you previously paid + a fix fee: 
# $5 for 6.x 
# $15 for 5.x 
# $25 for 4.x 
# If you've registered txt2pdf 6.x P.E, send us an email we'll send you a free
# upgrade. 
#
# Try it for 30 days.
# If you decide to continue using it, register NOW via a SECURE SERVER
# your PE (Personal Edition) at
# http://www.regsoft.net/purchase.php3?productid=49173
# your EE (Enterprise Edition) at
...
my $SECURESERVER="http://www.regsoft.net/purchase.php3?productid=6347";
my $pageNO;
my $lineNO;
...
my $Unregistered="Generated by unregistered $producer1 v.$version \251 $companyname 2004\nAvailable at $txt2pdfHome \n";
...
my @elem=("tmpdir","author","creator","keywords","subject","title","landscape",
	  ...
	  "inputmod","outputmod","pdfversion","annotationtext",
	  "japanese","tradchinese","simplchinese","korean","pagemark",
          "underline");
# future version
#	  "japanese","tradchinese","simplchinese","korean","pagemark","move");
my %option=(tmpdir             => './',
            author             => '',
            creator            => '',
            keywords           => '',
...
From \$110 for the Enterprise Edition.
...
# future version
#    if ($option{'move'}) {move($saveinput,$newinput)}
#    else {rename $saveinput,$newinput}
...
# future version
#    if ($option{'move'}) {move($output,$newoutput)}
#    else {rename $output,$newoutput}
...
sub WriteHeader {
  ...
  &pos("/Producer ($producer1 v$version \\251 $companyname 2004)\n");
  &pos("/Title ($title)\n");
...
# ISOLatin1Encoding
  ...
  if($option{'tradchinese'}) {
    ...
    &pos("/Subtype /Type0\n");
    &pos("/Name /F33\n");
    &pos("/BaseFont /PMingLiU,BoldItalic\n");
    &pos("/Encoding /ETen-B5-H\n");
    $buf=sprintf "/DescendantFonts [%d 0 R]\n",$obj+1;
    &pos($buf);
    &pos(">>\n");
    ...
    &pos("<<\n");
    &pos("/Type /FontDescriptor\n");
    &pos("/FontName /PMingLiU,BoldItalic\n");
    &pos("/FontBBox [ 0 -199 1000 801 ]\n");
    &pos("/Flags 6\n");
    &pos("/CapHeight 658\n");
    &pos("/Ascent 801\n");
...
TXT2PDF - Version 7.4 19th June 2004
