...
{
	/// <summary>
	/// Summary description for frmFRelatoriosPropriedadesObjetoLinha.
	/// </summary>
	public class frmFRelatoriosPropriedadesObjetoLinha : mdlComponentesGraficos.FormFlutuante
	{
		#region Atributos
		...
		public frmFRelatoriosPropriedadesObjetoLinha(ref mdlTratamentoErro.clsTratamentoErro cls_ter_tratadorErro,string strEnderecoExecutavel, bool bVisivelImpressao)
		{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmFRelatoriosPropriedadesObjetoLinha));
			...
			// 
			// frmFRelatoriosPropriedadesObjetoLinha
			// 
			...
			this.Name = "frmFRelatoriosPropriedadesObjetoLinha";
