...
{
	/// <summary>
	/// Summary description for frmFRelatoriosPropriedadesObjetoCirculo.
	/// </summary>
	public class frmFRelatoriosPropriedadesObjetoCirculo : mdlComponentesGraficos.FormFlutuante
	{
		#region Atributos
		...
		#region Constructor and Destructors
			public frmFRelatoriosPropriedadesObjetoCirculo(ref mdlTratamentoErro.clsTratamentoErro cls_ter_tratadorErro,string strEnderecoExecutavel, bool bVisivelImpressao)
			{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmFRelatoriosPropriedadesObjetoCirculo));
			...
			// 
			// frmFRelatoriosPropriedadesObjetoCirculo
			// 
			...
			this.Name = "frmFRelatoriosPropriedadesObjetoCirculo";
