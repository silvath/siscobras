...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		mdlControladoraMensagens.clsControladoraMensagens m_cls_cm_Mensagens = null;
		...
		private System.Windows.Forms.Button m_btControladoraMensagensBD;
		private System.Windows.Forms.Button m_btControladoraMensagens;
		private System.Windows.Forms.GroupBox m_gbControladora;
		...
		private System.Windows.Forms.GroupBox m_gbCommands;
		private System.Windows.Forms.Button m_btControladoraMensagensUpdate;
		...
		private void InitializeComponent()
		{
			...
			this.m_gbControladora = new System.Windows.Forms.GroupBox();
			...
			this.m_btControladoraMensagensBD = new System.Windows.Forms.Button();
			this.m_btControladoraMensagens = new System.Windows.Forms.Button();
			...
			this.m_gbCommands = new System.Windows.Forms.GroupBox();
			this.m_btControladoraMensagensUpdate = new System.Windows.Forms.Button();
			this.m_gbGeral.SuspendLayout();
			this.m_gbRetorno.SuspendLayout();
			this.m_gbMoeda.SuspendLayout();
			this.m_gbControladora.SuspendLayout();
			...
			this.m_gbCommands.SuspendLayout();
			this.SuspendLayout();
			// 
			// m_gbGeral
			// 
			...
			this.m_gbGeral.Size = new System.Drawing.Size(636, 538);
			...
			this.m_gbRetorno.Location = new System.Drawing.Point(8, 480);
			...
			// m_gbMoeda
			// 
			this.m_gbMoeda.Controls.Add(this.m_gbCommands);
			this.m_gbMoeda.Controls.Add(this.m_gbControladora);
			this.m_gbMoeda.Location = new System.Drawing.Point(8, 200);
			this.m_gbMoeda.Name = "m_gbMoeda";
			this.m_gbMoeda.Size = new System.Drawing.Size(624, 280);
			...
			// m_gbControladora
			// 
			this.m_gbControladora.Controls.Add(this.m_btControladoraMensagensContinue);
			this.m_gbControladora.Controls.Add(this.m_btControladoraMensagensPause);
			this.m_gbControladora.Controls.Add(this.m_btControladoraMensagensClose);
			this.m_gbControladora.Controls.Add(this.m_btControladoraMensagensStop);
			this.m_gbControladora.Controls.Add(this.m_btControladoraMensagensStart);
			this.m_gbControladora.Controls.Add(this.m_btControladoraMensagensBD);
			this.m_gbControladora.Controls.Add(this.m_btControladoraMensagens);
			this.m_gbControladora.Font = new System.Drawing.Font("Arial", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.m_gbControladora.Location = new System.Drawing.Point(7, 16);
			this.m_gbControladora.Name = "m_gbControladora";
			this.m_gbControladora.Size = new System.Drawing.Size(609, 64);
			this.m_gbControladora.TabIndex = 11;
			this.m_gbControladora.TabStop = false;
			this.m_gbControladora.Text = "Controladora";
			// 
			// m_btControladoraMensagensContinue
			// 
			this.m_btControladoraMensagensContinue.Enabled = false;
			this.m_btControladoraMensagensContinue.Location = new System.Drawing.Point(360, 16);
			...
			this.m_btControladoraMensagensContinue.TabIndex = 13;
			...
			// 
			this.m_btControladoraMensagensPause.Enabled = false;
			this.m_btControladoraMensagensPause.Location = new System.Drawing.Point(282, 16);
			this.m_btControladoraMensagensPause.Name = "m_btControladoraMensagensPause";
			this.m_btControladoraMensagensPause.Size = new System.Drawing.Size(74, 40);
			this.m_btControladoraMensagensPause.TabIndex = 12;
			...
			// 
			this.m_btControladoraMensagensClose.Enabled = false;
			this.m_btControladoraMensagensClose.Location = new System.Drawing.Point(525, 16);
			...
			this.m_btControladoraMensagensClose.TabIndex = 11;
			...
			// 
			this.m_btControladoraMensagensStop.Enabled = false;
			this.m_btControladoraMensagensStop.Location = new System.Drawing.Point(442, 16);
			...
			this.m_btControladoraMensagensStop.TabIndex = 10;
			...
			// 
			this.m_btControladoraMensagensStart.Enabled = false;
			this.m_btControladoraMensagensStart.Location = new System.Drawing.Point(197, 16);
			...
			this.m_btControladoraMensagensStart.TabIndex = 9;
			...
			// 
			// m_btControladoraMensagensBD
			// 
			this.m_btControladoraMensagensBD.Location = new System.Drawing.Point(5, 16);
			this.m_btControladoraMensagensBD.Name = "m_btControladoraMensagensBD";
			this.m_btControladoraMensagensBD.Size = new System.Drawing.Size(99, 40);
			this.m_btControladoraMensagensBD.TabIndex = 6;
			this.m_btControladoraMensagensBD.Text = "Controladora Mensagens BD";
			this.m_btControladoraMensagensBD.Click += new System.EventHandler(this.m_btControladoraMensagensBD_Click);
			// 
			// m_btControladoraMensagens
			// 
			this.m_btControladoraMensagens.Location = new System.Drawing.Point(104, 16);
			this.m_btControladoraMensagens.Name = "m_btControladoraMensagens";
			this.m_btControladoraMensagens.Size = new System.Drawing.Size(87, 40);
			this.m_btControladoraMensagens.TabIndex = 7;
			this.m_btControladoraMensagens.Text = "Controladora Mensagens";
			this.m_btControladoraMensagens.Click += new System.EventHandler(this.m_btControladoraMensagens_Click);
			// 
			// m_gbBD
			// 
			...
			// m_gbCommands
			// 
			this.m_gbCommands.Controls.Add(this.m_btControladoraMensagensUpdate);
			this.m_gbCommands.Font = new System.Drawing.Font("Arial", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.m_gbCommands.Location = new System.Drawing.Point(8, 80);
			this.m_gbCommands.Name = "m_gbCommands";
			this.m_gbCommands.Size = new System.Drawing.Size(608, 64);
			this.m_gbCommands.TabIndex = 12;
			this.m_gbCommands.TabStop = false;
			this.m_gbCommands.Text = "Commands";
			// 
			// m_btControladoraMensagensUpdate
			// 
			this.m_btControladoraMensagensUpdate.Location = new System.Drawing.Point(7, 17);
			this.m_btControladoraMensagensUpdate.Name = "m_btControladoraMensagensUpdate";
			this.m_btControladoraMensagensUpdate.Size = new System.Drawing.Size(80, 40);
			this.m_btControladoraMensagensUpdate.TabIndex = 10;
			this.m_btControladoraMensagensUpdate.Text = "Update";
			this.m_btControladoraMensagensUpdate.Click += new System.EventHandler(this.m_btControladoraMensagensUpdate_Click);
			// 
			// Form1
			// 
			...
			this.m_gbControladora.ResumeLayout(false);
			...
			this.m_gbCommands.ResumeLayout(false);
		...
		#region Eventos
			...
			#endregion
			#region Timer
				private void m_tiControladoraModulos_Tick(object sender, System.EventArgs e)
				{
					if (m_cls_cm_Mensagens != null)
					{
						m_btControladoraMensagensStart.Enabled = !m_cls_cm_Mensagens.Running;
						m_btControladoraMensagensStop.Enabled = m_cls_cm_Mensagens.Running;
						m_btControladoraMensagensClose.Enabled = true;
					}else{
						m_btControladoraMensagensStart.Enabled = false;
						m_btControladoraMensagensStop.Enabled = false;
						m_btControladoraMensagensClose.Enabled = false;
					}
				}
			#endregion
		#endregion
		...
		#region Negocio
			#region Controladora Mensagens
				private void m_btControladoraMensagensBD_Click(object sender, System.EventArgs e)
				{
					CreateDataBase();
					m_cls_cm_Mensagens = mdlControladoraMensagens.clsControladoraMensagens.New(ref m_cls_dba_ConnectionBD);
					if (m_cls_cm_Mensagens != null)
					{
						m_btControladoraMensagensBD.Enabled = false;
						m_btControladoraMensagens.Enabled = false;
						m_btControladoraMensagensStart.Enabled = true;
						m_btControladoraMensagensPause.Enabled = false;
						m_btControladoraMensagensContinue.Enabled = false;
						m_btControladoraMensagensStop.Enabled = false;
						m_btControladoraMensagensClose.Enabled = false;
					}
				}

				private void m_btControladoraMensagens_Click(object sender, System.EventArgs e)
				{
					m_cls_cm_Mensagens = mdlControladoraMensagens.clsControladoraMensagens.New();
					if (m_cls_cm_Mensagens != null)
					{
						m_btControladoraMensagensBD.Enabled = false;
						m_btControladoraMensagens.Enabled = false;
				...
				{
					m_cls_cm_Mensagens.bStart();
					m_btControladoraMensagensStart.Enabled = false;
					m_btControladoraMensagensPause.Enabled = true;
					m_btControladoraMensagensContinue.Enabled = false;
					m_btControladoraMensagensStop.Enabled = true;
					m_btControladoraMensagensClose.Enabled = true;
				}

				private void m_btControladoraMensagensPause_Click(object sender, System.EventArgs e)
				{
					m_cls_cm_Mensagens.bPause();			
					m_btControladoraMensagensStart.Enabled = false;
					m_btControladoraMensagensPause.Enabled = false;
					m_btControladoraMensagensContinue.Enabled = true;
					m_btControladoraMensagensStop.Enabled = true;
					m_btControladoraMensagensClose.Enabled = true;
				}
				...
				private void m_btControladoraMensagensUpdate_Click(object sender, System.EventArgs e)
				{
					if (m_cls_cm_Mensagens != null)
					{
						m_cls_cm_Mensagens.vUpdate();
					}
				}
			#endregion
		#endregion
