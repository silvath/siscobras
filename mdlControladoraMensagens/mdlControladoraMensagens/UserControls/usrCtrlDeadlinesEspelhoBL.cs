...
{
	/// <summary>
	/// Summary description for usrCtrlDeadlinesEspelhoBL.
	/// </summary>
	public class usrCtrlDeadlinesEspelhoBL : System.Windows.Forms.UserControl
	{
		#region Delegates
		...
		#region Events Methods
			protected virtual void OnCallLoadMessageBase()
			{
				...
				if (eCallLoadMessageBase != null)
					eCallLoadMessageBase(mdlConstantes.clsConstantes.ID_SCHEDULER_DEADLINE_SUBTYPE_ESPELHOBL,out strMessageBase);
			...
			protected virtual bool OnCallShowMessageBase()
			{
				...
				if (eCallShowMessageBase != null)
					bReturn = eCallShowMessageBase(mdlConstantes.clsConstantes.ID_SCHEDULER_DEADLINE_SUBTYPE_ESPELHOBL);
				this.Cursor = System.Windows.Forms.Cursors.Default;
				return(bReturn);
			}
			...
			protected virtual void OnCallLoadMinutesBeforeShow()
			{
				...
				if (eCallLoadMinutesBeforeShow != null)
					eCallLoadMinutesBeforeShow(mdlConstantes.clsConstantes.ID_SCHEDULER_DEADLINE_SUBTYPE_ESPELHOBL,out dMinutes);
			...
			protected virtual void OnCallSaveMinutesBeforeShow()
			{
				...
				if (eCallSaveMinutesBeforeShow != null)
					eCallSaveMinutesBeforeShow(mdlConstantes.clsConstantes.ID_SCHEDULER_DEADLINE_SUBTYPE_ESPELHOBL,dMinutes);
				this.Cursor = System.Windows.Forms.Cursors.Default;
			}
		#endregion
		...
		public usrCtrlDeadlinesEspelhoBL()
		{
			InitializeComponent();
		}
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(usrCtrlDeadlinesEspelhoBL));
			...
			this.m_lbDeadlines.Location = new System.Drawing.Point(7, 18);
			this.m_lbDeadlines.Name = "m_lbDeadlines";
			this.m_lbDeadlines.Size = new System.Drawing.Size(272, 22);
			this.m_lbDeadlines.TabIndex = 1;
			this.m_lbDeadlines.Text = "Deadline Abertura Espelho do BL";
			// 
			...
			this.Name = "usrCtrlDeadlinesEspelhoBL";
