...
{
	/// <summary>
	/// Summary description for usrCtrlDeadlinesListaCarga.
	/// </summary>
	public class usrCtrlDeadlinesListaCarga : System.Windows.Forms.UserControl
	{
		#region Delegates
		...
		#region Events Methods
			protected virtual void OnCallLoadMessageBase()
			{
				...
				if (eCallLoadMessageBase != null)
					eCallLoadMessageBase(mdlConstantes.clsConstantes.ID_SCHEDULER_DEADLINE_SUBTYPE_LISTACARGA,out strMessageBase);
			...
			protected virtual bool OnCallShowMessageBase()
			{
				...
				if (eCallShowMessageBase != null)
					bReturn = eCallShowMessageBase(mdlConstantes.clsConstantes.ID_SCHEDULER_DEADLINE_SUBTYPE_LISTACARGA);
				this.Cursor = System.Windows.Forms.Cursors.Default;
				return(bReturn);
			}
			...
			protected virtual void OnCallLoadMinutesBeforeShow()
			{
				...
				if (eCallLoadMinutesBeforeShow != null)
					eCallLoadMinutesBeforeShow(mdlConstantes.clsConstantes.ID_SCHEDULER_DEADLINE_SUBTYPE_LISTACARGA,out dMinutes);
			...
			protected virtual void OnCallSaveMinutesBeforeShow()
			{
				...
				if (eCallSaveMinutesBeforeShow != null)
					eCallSaveMinutesBeforeShow(mdlConstantes.clsConstantes.ID_SCHEDULER_DEADLINE_SUBTYPE_LISTACARGA,dMinutes);
				this.Cursor = System.Windows.Forms.Cursors.Default;
			}
		#endregion
		...
		#region Constructors and Destructors
			public usrCtrlDeadlinesListaCarga()
			{
				InitializeComponent();
			}
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(usrCtrlDeadlinesListaCarga));
			...
			this.m_lbDeadlines.Text = "Deadline Lista Carga";
			// 
			...
			this.Name = "usrCtrlDeadlinesListaCarga";
