...
{
	/// <summary>
	/// Summary description for usrCtrlDeadlinesLiberacaoRF.
	/// </summary>
	public class usrCtrlDeadlinesLiberacaoRF : System.Windows.Forms.UserControl
	{
		#region Delegates
		...
		#region Events Methods
			protected virtual void OnCallLoadMessageBase()
			{
				...
				if (eCallLoadMessageBase != null)
					eCallLoadMessageBase(mdlConstantes.clsConstantes.ID_SCHEDULER_DEADLINE_SUBTYPE_LIBERACAORECEITAFEDERAL,out strMessageBase);
			...
			protected virtual bool OnCallShowMessageBase()
			{
				...
				if (eCallShowMessageBase != null)
					bReturn = eCallShowMessageBase(mdlConstantes.clsConstantes.ID_SCHEDULER_DEADLINE_SUBTYPE_LIBERACAORECEITAFEDERAL);
				this.Cursor = System.Windows.Forms.Cursors.Default;
				return(bReturn);
			}
			...
			protected virtual void OnCallLoadMinutesBeforeShow()
			{
				...
				if (eCallLoadMinutesBeforeShow != null)
					eCallLoadMinutesBeforeShow(mdlConstantes.clsConstantes.ID_SCHEDULER_DEADLINE_SUBTYPE_LIBERACAORECEITAFEDERAL,out dMinutes);
			...
			protected virtual void OnCallSaveMinutesBeforeShow()
			{
				...
				if (eCallSaveMinutesBeforeShow != null)
					eCallSaveMinutesBeforeShow(mdlConstantes.clsConstantes.ID_SCHEDULER_DEADLINE_SUBTYPE_LIBERACAORECEITAFEDERAL,dMinutes);
				this.Cursor = System.Windows.Forms.Cursors.Default;
			}
		#endregion
		...
		#region Constructors and Destructors
			public usrCtrlDeadlinesLiberacaoRF()
			{
				InitializeComponent();
			}
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(usrCtrlDeadlinesLiberacaoRF));
			...
			this.m_lbDeadlines.Size = new System.Drawing.Size(216, 38);
			this.m_lbDeadlines.TabIndex = 1;
			this.m_lbDeadlines.Text = "Deadline Liberação na Receita Federal";
			// 
			...
			this.Name = "usrCtrlDeadlinesLiberacaoRF";
