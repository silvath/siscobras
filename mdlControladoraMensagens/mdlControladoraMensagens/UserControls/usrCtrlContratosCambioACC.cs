...
{
	/// <summary>
	/// Summary description for usrCtrlContratosCambioACC.
	/// </summary>
	public class usrCtrlContratosCambioACC : System.Windows.Forms.UserControl
	{
		#region Delegates
		...
		protected virtual void OnCallLoadMessageBase()
		{
			...
			if (eCallLoadMessageBase != null)
				eCallLoadMessageBase(mdlConstantes.clsConstantes.ID_SCHEDULER_CONTRATOCAMBIO_SUBTYPE_ACC,out strMessageBase);
		...
		protected virtual bool OnCallShowMessageBase()
		{
			...
			if (eCallShowMessageBase != null)
				bReturn = eCallShowMessageBase(mdlConstantes.clsConstantes.ID_SCHEDULER_CONTRATOCAMBIO_SUBTYPE_ACC);
			this.Cursor = System.Windows.Forms.Cursors.Default;
			return(bReturn);
		}
		...
		protected virtual void OnCallLoadMinutesBeforeShow()
		{
			...
			if (eCallLoadMinutesBeforeShow != null)
				eCallLoadMinutesBeforeShow(mdlConstantes.clsConstantes.ID_SCHEDULER_CONTRATOCAMBIO_SUBTYPE_ACC,out dMinutes);
		...
		protected virtual void OnCallSaveMinutesBeforeShow()
		{
			...
			if (eCallSaveMinutesBeforeShow != null)
				eCallSaveMinutesBeforeShow(mdlConstantes.clsConstantes.ID_SCHEDULER_CONTRATOCAMBIO_SUBTYPE_ACC,dMinutes);
			this.Cursor = System.Windows.Forms.Cursors.Default;
		}
		#endregion
		...
		#region Constructors and Destructors
			public usrCtrlContratosCambioACC()
			{
				InitializeComponent();
			}
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(usrCtrlContratosCambioACC));
			...
			this.m_lbMostrarMensagens.Location = new System.Drawing.Point(8, 82);
			...
			this.m_lbMensagemBase.Size = new System.Drawing.Size(200, 16);
			...
			this.Name = "usrCtrlContratosCambioACC";
