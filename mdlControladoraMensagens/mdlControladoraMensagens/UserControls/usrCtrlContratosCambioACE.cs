...
{
	/// <summary>
	/// Summary description for usrCtrlContratosCambioACE.
	/// </summary>
	public class usrCtrlContratosCambioACE : System.Windows.Forms.UserControl
	{
		#region Delegates
		...
		#region Events Methods
			protected virtual void OnCallLoadMessageBase()
			{
				...
				if (eCallLoadMessageBase != null)
					eCallLoadMessageBase(mdlConstantes.clsConstantes.ID_SCHEDULER_CONTRATOCAMBIO_SUBTYPE_ACE,out strMessageBase);
			...
			protected virtual bool OnCallShowMessageBase()
			{
				...
				if (eCallShowMessageBase != null)
					bReturn = eCallShowMessageBase(mdlConstantes.clsConstantes.ID_SCHEDULER_CONTRATOCAMBIO_SUBTYPE_ACE);
				this.Cursor = System.Windows.Forms.Cursors.Default;
				return(bReturn);
			}
			...
			protected virtual void OnCallLoadMinutesBeforeShow()
			{
				...
				if (eCallLoadMinutesBeforeShow != null)
					eCallLoadMinutesBeforeShow(mdlConstantes.clsConstantes.ID_SCHEDULER_CONTRATOCAMBIO_SUBTYPE_ACE,out dMinutes);
			...
			protected virtual void OnCallSaveMinutesBeforeShow()
			{
				...
				if (eCallSaveMinutesBeforeShow != null)
					eCallSaveMinutesBeforeShow(mdlConstantes.clsConstantes.ID_SCHEDULER_CONTRATOCAMBIO_SUBTYPE_ACE,dMinutes);
				this.Cursor = System.Windows.Forms.Cursors.Default;
			}
		#endregion
		...
		#region Constructors and Destructors
			public usrCtrlContratosCambioACE()
			{
				InitializeComponent();
			}
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(usrCtrlContratosCambioACE));
			...
			this.m_lbDeadlines.Text = "Contrato de câmbio ACE";
			// 
			...
			this.Name = "usrCtrlContratosCambioACE";
