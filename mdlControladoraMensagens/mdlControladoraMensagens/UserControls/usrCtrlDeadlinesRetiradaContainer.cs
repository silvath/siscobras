...
{
	/// <summary>
	/// Summary description for usrCtrlDeadlinesRetiradaContainer.
	/// </summary>
	public class usrCtrlDeadlinesRetiradaContainer : System.Windows.Forms.UserControl
	{
		#region Delegates
		...
		#region Events Methods
			protected virtual void OnCallLoadMessageBase()
			{
				...
				if (eCallLoadMessageBase != null)
					eCallLoadMessageBase(mdlConstantes.clsConstantes.ID_SCHEDULER_DEADLINE_SUBTYPE_RETIRADACONTAINERTERMINAL,out strMessageBase);
			...
			protected virtual bool OnCallShowMessageBase()
			{
				...
				if (eCallShowMessageBase != null)
					bReturn = eCallShowMessageBase(mdlConstantes.clsConstantes.ID_SCHEDULER_DEADLINE_SUBTYPE_RETIRADACONTAINERTERMINAL);
				this.Cursor = System.Windows.Forms.Cursors.Default;
				return(bReturn);
			}
			...
			protected virtual void OnCallLoadMinutesBeforeShow()
			{
				...
				if (eCallLoadMinutesBeforeShow != null)
					eCallLoadMinutesBeforeShow(mdlConstantes.clsConstantes.ID_SCHEDULER_DEADLINE_SUBTYPE_RETIRADACONTAINERTERMINAL,out dMinutes);
			...
			protected virtual void OnCallSaveMinutesBeforeShow()
			{
				...
				if (eCallSaveMinutesBeforeShow != null)
					eCallSaveMinutesBeforeShow(mdlConstantes.clsConstantes.ID_SCHEDULER_DEADLINE_SUBTYPE_RETIRADACONTAINERTERMINAL,dMinutes);
				this.Cursor = System.Windows.Forms.Cursors.Default;
			}
		#endregion
		...
		#region Constructors and Destructors
			public usrCtrlDeadlinesRetiradaContainer()
			{
				InitializeComponent();
			}
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(usrCtrlDeadlinesRetiradaContainer));
			...
			this.m_lbDeadlines.Location = new System.Drawing.Point(31, 18);
			this.m_lbDeadlines.Name = "m_lbDeadlines";
			this.m_lbDeadlines.Size = new System.Drawing.Size(232, 24);
			this.m_lbDeadlines.TabIndex = 1;
			this.m_lbDeadlines.Text = "Deadline Retirada Container";
			// 
			...
			// 
			// usrCtrlDeadlinesRetiradaContainer
			// 
			...
			this.Name = "usrCtrlDeadlinesRetiradaContainer";
