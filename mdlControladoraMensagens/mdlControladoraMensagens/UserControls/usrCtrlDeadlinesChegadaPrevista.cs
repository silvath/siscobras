...
{
	/// <summary>
	/// Summary description for usrCtrlDeadlinesChegadaPrevista.
	/// </summary>
	public class usrCtrlDeadlinesChegadaPrevista : System.Windows.Forms.UserControl
	{
		#region Delegates
		...
		#region Events Methods
			protected virtual void OnCallLoadMessageBase()
			{
				...
				if (eCallLoadMessageBase != null)
					eCallLoadMessageBase(mdlConstantes.clsConstantes.ID_SCHEDULER_DEADLINE_SUBTYPE_CHEGADATRANSPORTE,out strMessageBase);
			...
			protected virtual bool OnCallShowMessageBase()
			{
				...
				if (eCallShowMessageBase != null)
					bReturn = eCallShowMessageBase(mdlConstantes.clsConstantes.ID_SCHEDULER_DEADLINE_SUBTYPE_CHEGADATRANSPORTE);
				this.Cursor = System.Windows.Forms.Cursors.Default;
				return(bReturn);
			}
			...
			protected virtual void OnCallLoadMinutesBeforeShow()
			{
				...
				if (eCallLoadMinutesBeforeShow != null)
					eCallLoadMinutesBeforeShow(mdlConstantes.clsConstantes.ID_SCHEDULER_DEADLINE_SUBTYPE_CHEGADATRANSPORTE,out dMinutes);
			...
			protected virtual void OnCallSaveMinutesBeforeShow()
			{
				...
				if (eCallSaveMinutesBeforeShow != null)
					eCallSaveMinutesBeforeShow(mdlConstantes.clsConstantes.ID_SCHEDULER_DEADLINE_SUBTYPE_CHEGADATRANSPORTE,dMinutes);
				this.Cursor = System.Windows.Forms.Cursors.Default;
			}
		#endregion
		...
		#region Constructors and Destructors
			public usrCtrlDeadlinesChegadaPrevista()
			{
				InitializeComponent();
			}
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(usrCtrlDeadlinesChegadaPrevista));
			...
			this.m_lbDeadlines.Location = new System.Drawing.Point(64, 16);
			this.m_lbDeadlines.Name = "m_lbDeadlines";
			this.m_lbDeadlines.Size = new System.Drawing.Size(176, 48);
			this.m_lbDeadlines.TabIndex = 1;
			this.m_lbDeadlines.Text = "Deadline Chegada Prevista Transporte";
			// 
			...
			this.m_txtTempo.Leave += new System.EventHandler(this.m_txtChegadaTransporteTempo_Leave);
			// 
			...
			this.m_btMensagemBase.Click += new System.EventHandler(this.m_btChegadaTransporteMensagemBase_Click);
			// 
			// m_txtMessageBase
			// 
			...
			this.m_lbMensagemBase.Size = new System.Drawing.Size(136, 16);
			...
			// 
			// usrCtrlDeadlinesChegadaPrevista
			// 
			...
			this.Name = "usrCtrlDeadlinesChegadaPrevista";
		...
		#region Eventos
			...
			#endregion
			#region TextBoxes
				private void m_txtChegadaTransporteTempo_Leave(object sender, System.EventArgs e)
				{
					OnCallSaveMinutesBeforeShow();
				}
			#endregion
			#region Buttons
				private void m_btChegadaTransporteMensagemBase_Click(object sender, System.EventArgs e)
				{
