...
{
	/// <summary>
	/// Summary description for clsConsignatarioProforma.
	/// </summary>
	public class clsConsignatarioProforma
	{
		#region Atributes
		...
		#endregion
		#region Constructors
		public clsConsignatarioProforma(ref mdlTratamentoErro.clsTratamentoErro cls_ter_tratadorErro, ref mdlDataBaseAccess.clsDataBaseAccess cls_dba_ConnectionDB,string strEnderecoExecutavel, int nIdExportador, string strIdCodigo)
		{
		...
		private mdlDataBaseAccess.Tabelas.XsdTbFaturasProformas dtstReturnFaturasProformas()
		{
			...
			return(m_cls_dba_ConnectionDB.GetTbFaturasProformas(arlCondicaoCampo,arlCondicaoComparador,arlCondicaoValor,null,null));
		}
