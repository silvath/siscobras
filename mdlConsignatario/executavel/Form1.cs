...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Button m_btConsignatarioCotacao;
		private System.Windows.Forms.Button m_btConsignatarioProforma;
		...
		private void InitializeComponent()
		{
			...
			this.m_btConsignatarioProforma = new System.Windows.Forms.Button();
			this.m_btConsignatarioCotacao = new System.Windows.Forms.Button();
			...
			this.m_gbGeral.Size = new System.Drawing.Size(615, 447);
			...
			// m_txtRetorno
			// 
			this.m_txtRetorno.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left) 
				| System.Windows.Forms.AnchorStyles.Right)));
			...
			// m_lbRetorno
			// 
			this.m_lbRetorno.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left) 
				| System.Windows.Forms.AnchorStyles.Right)));
			...
			// m_gbMoeda
			// 
			this.m_gbMoeda.Controls.Add(this.m_btConsignatarioProforma);
			this.m_gbMoeda.Controls.Add(this.m_btConsignatarioCotacao);
			...
			this.m_gbMoeda.Text = "Consignatário";
			// 
			// m_btConsignatarioProforma
			// 
			this.m_btConsignatarioProforma.Location = new System.Drawing.Point(229, 19);
			this.m_btConsignatarioProforma.Name = "m_btConsignatarioProforma";
			this.m_btConsignatarioProforma.Size = new System.Drawing.Size(96, 32);
			this.m_btConsignatarioProforma.TabIndex = 4;
			this.m_btConsignatarioProforma.Text = "Proforma";
			this.m_btConsignatarioProforma.Click += new System.EventHandler(this.m_btConsignatarioProforma_Click);
			// 
			// m_btConsignatarioCotacao
			// 
			this.m_btConsignatarioCotacao.Location = new System.Drawing.Point(119, 19);
			this.m_btConsignatarioCotacao.Name = "m_btConsignatarioCotacao";
			this.m_btConsignatarioCotacao.Size = new System.Drawing.Size(96, 32);
			this.m_btConsignatarioCotacao.TabIndex = 3;
			this.m_btConsignatarioCotacao.Text = "Cotacao";
			this.m_btConsignatarioCotacao.Click += new System.EventHandler(this.m_btConsignatarioCotacao_Click);
			// 
			// m_btComercial
			// 
			this.m_btComercial.Location = new System.Drawing.Point(8, 20);
			this.m_btComercial.Name = "m_btComercial";
			this.m_btComercial.Size = new System.Drawing.Size(96, 32);
			this.m_btComercial.TabIndex = 2;
			this.m_btComercial.Text = "Consignatário";
			...
			this.m_rbJet40.Size = new System.Drawing.Size(72, 16);
			...
			// m_txtPortMySql
			// 
			this.m_txtPortMySql.Location = new System.Drawing.Point(129, 32);
			...
			// m_lbPortMysql
			// 
			this.m_lbPortMysql.Location = new System.Drawing.Point(97, 34);
			...
			this.m_rbSqlServer.TabIndex = 11;
			this.m_rbSqlServer.TabStop = true;
			this.m_rbSqlServer.Text = "SqlServer";
			// 
			// m_txtPortSqlServer
			// 
			this.m_txtPortSqlServer.Location = new System.Drawing.Point(129, 53);
			...
			// m_lbPortSqlServer
			// 
			this.m_lbPortSqlServer.Location = new System.Drawing.Point(97, 53);
		...
		private void CreateDataBase()
		{
			...
			if (m_rbSqlServer.Checked)
				m_cls_dba_ConnectionBD = new mdlDataBaseAccess.clsDataBaseAccessSqlServer(ref m_cls_tre_tratadorErro,m_txtHost.Text,m_txtPortMySql.Text,m_txtDataBaseName.Text,m_txtUser.Text,m_txtPassword.Text);
		...
		#region Eventos
			private void m_btConsignatarioCotacao_Click(object sender, System.EventArgs e)
			{
				CreateDataBase();
				mdlConsignatario.clsConsignatarioCotacao obj = new mdlConsignatario.clsConsignatarioCotacao(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text, Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text);
				obj.ShowDialog();
			}

			private void m_btConsignatarioProforma_Click(object sender, System.EventArgs e)
			{
				CreateDataBase();
			...
			{
				string strConsignatario, strEnderecoConsignatario, strCidade, strEstado, strPais;
				this.m_txtRetorno.Text = "";
				CreateDataBase();
				mdlConsignatario.clsConsignatario modConsignatario;
				modConsignatario = new mdlConsignatario.clsConsignatario(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text, Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text);
				modConsignatario.retornaValores(out strConsignatario, out strEnderecoConsignatario, out strCidade, out strEstado, out strPais);
				this.m_txtRetorno.Text = "Consignatário: " + strConsignatario;
                modConsignatario.ShowDialog();
				modConsignatario.retornaValores(out strConsignatario, out strEnderecoConsignatario, out strCidade, out strEstado, out strPais);
				this.m_txtRetorno.Text = "Consignatário: " + strConsignatario;
			}
		#endregion
