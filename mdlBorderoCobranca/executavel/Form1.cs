	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void m_btAgentes_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				mdlBorderoCobranca.clsBorderoCobranca obj = new mdlBorderoCobranca.clsBorderoCobranca(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text, Int32.Parse(m_txtIdExportador.Text), m_txtIdCodigo.Text);
				obj.ShowDialog();
			}
			catch
			{
