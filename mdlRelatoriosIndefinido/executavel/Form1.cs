...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private mdlRelatoriosIndefinido.frmFRelatoriosIndefinido formTeste;
		...
		private void Button1_Click(object sender, System.EventArgs e)
		{
			...
			if (formTeste == null)
			{
				formTeste = new mdlRelatoriosIndefinido.frmFRelatoriosIndefinido(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD, ref mdiParent,m_strEnderecoExecutavel,Int32.Parse(this.txtIdExportador.Text),txtIdCotacao.Text);
