...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Button m_btCertificadoOrigem;
		private System.Windows.Forms.TextBox m_txtTipoCertificadoOrigem;
		...
		private void InitializeComponent()
		{
			...
			this.m_btCertificadoOrigem = new System.Windows.Forms.Button();
			this.m_txtTipoCertificadoOrigem = new System.Windows.Forms.TextBox();
			...
			// m_gbParametros
			// 
			this.m_gbParametros.Controls.Add(this.m_txtTipoCertificadoOrigem);
			...
			// m_gbMoeda
			// 
			this.m_gbMoeda.Controls.Add(this.m_btCertificadoOrigem);
			...
			// m_btComercial
			// 
			this.m_btComercial.Location = new System.Drawing.Point(207, 20);
			...
			// m_btCotacao
			// 
			this.m_btCotacao.Location = new System.Drawing.Point(8, 20);
			...
			// m_txtPortMysql
			// 
			this.m_txtPortMysql.Location = new System.Drawing.Point(125, 24);
			this.m_txtPortMysql.Name = "m_txtPortMysql";
			this.m_txtPortMysql.Size = new System.Drawing.Size(41, 20);
			this.m_txtPortMysql.TabIndex = 12;
			this.m_txtPortMysql.Text = "3306";
			// 
			// m_lbPortMysql
			// 
			this.m_lbPortMysql.Location = new System.Drawing.Point(96, 29);
			...
			// m_txtPortSqlServer
			// 
			this.m_txtPortSqlServer.Location = new System.Drawing.Point(124, 44);
			...
			// m_lbPortSqlServer
			// 
			this.m_lbPortSqlServer.Location = new System.Drawing.Point(97, 48);
			...
			// 
			// m_btCertificadoOrigem
			// 
			this.m_btCertificadoOrigem.Location = new System.Drawing.Point(407, 21);
			this.m_btCertificadoOrigem.Name = "m_btCertificadoOrigem";
			this.m_btCertificadoOrigem.Size = new System.Drawing.Size(96, 32);
			this.m_btCertificadoOrigem.TabIndex = 5;
			this.m_btCertificadoOrigem.Text = "Certificado Origem";
			this.m_btCertificadoOrigem.Click += new System.EventHandler(this.m_btCertificadoOrigem_Click);
			// 
			// m_txtTipoCertificadoOrigem
			// 
			this.m_txtTipoCertificadoOrigem.Location = new System.Drawing.Point(328, 24);
			this.m_txtTipoCertificadoOrigem.Name = "m_txtTipoCertificadoOrigem";
			this.m_txtTipoCertificadoOrigem.Size = new System.Drawing.Size(91, 20);
			this.m_txtTipoCertificadoOrigem.TabIndex = 9;
			this.m_txtTipoCertificadoOrigem.Text = "1";
			this.m_txtTipoCertificadoOrigem.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// label2
			// 
			...
			this.label2.Text = "idTipoCertificado";
			// 
			// Form1
			// 
...
//					m_cls_dba_ConnectionBD = new mdlDataBaseAccess.clsDataBaseAccessMySql(ref m_cls_tre_tratadorErro,m_txtHost.Text,m_txtUser.Text,m_txtPassword.Text,m_txtDataBaseName.Text);
		...
		#region Eventos
        	private void m_btCotacao_Click(object sender, System.EventArgs e)
			{
				...
				string strUnidadeBruta, strUnidadeLiquida;
				this.m_txtRetorno.Text = "";
				CreateDataBase();
				mdlPesos.clsPesos modPesos = new mdlPesos.clsPesosFaturasCotacao(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text);
				modPesos.retornaValores(out dPesoLiquido,out dPesoBruto,out strUnidadeBruta, out strUnidadeLiquida);
				this.m_txtRetorno.Text = "Peso Líquido: " + dPesoLiquido.ToString() + " Peso Bruto: " + dPesoBruto.ToString() + " Unidade Bruta: " + strUnidadeBruta + " Unidade Líquida: " + strUnidadeLiquida; 
				modPesos.ShowDialog();
			...
			private void m_btComercial_Click(object sender, System.EventArgs e)
			{
				...
				this.m_txtRetorno.Text = "";
				CreateDataBase();
				mdlPesos.clsPesos modPesos = new mdlPesos.clsPesosFaturasComercias(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text);
				modPesos.retornaValores(out dPesoLiquido,out dPesoBruto,out strUnidadeBruta, out strUnidadeLiquida);
				this.m_txtRetorno.Text = "Peso Líquido: " + dPesoLiquido.ToString() + " Peso Bruto: " + dPesoBruto.ToString() + " Unidade Bruta: " + strUnidadeBruta + " Unidade Líquida: " + strUnidadeLiquida; 
				modPesos.ShowDialog();
				if (modPesos.m_bModificado)
			...
			private void m_btProforma_Click(object sender, System.EventArgs e)
			{
				...
				this.m_txtRetorno.Text = "";
				CreateDataBase();
				mdlPesos.clsPesos modPesos = new mdlPesos.clsPesosFaturasProforma(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text);
				modPesos.retornaValores(out dPesoLiquido,out dPesoBruto,out strUnidadeBruta, out strUnidadeLiquida);
				this.m_txtRetorno.Text = "Peso Líquido: " + dPesoLiquido.ToString() + " Peso Bruto: " + dPesoBruto.ToString() + " Unidade Bruta: " + strUnidadeBruta + " Unidade Líquida: " + strUnidadeLiquida; 
				modPesos.ShowDialog();
				if (modPesos.m_bModificado)
			...
			{
				CreateDataBase();
				mdlPesos.clsPesosRomaneio objPesos = new mdlPesos.clsPesosRomaneio(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text);
				objPesos.ShowDialog();
			}

			private void m_btCertificadoOrigem_Click(object sender, System.EventArgs e)
			{
				CreateDataBase();
				mdlPesos.clsPesos objPesos = new mdlPesos.clsPesosCertificadosOrigem(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text,Int32.Parse(m_txtTipoCertificadoOrigem.Text));
				objPesos.ShowDialog();
			}
		#endregion
	}
