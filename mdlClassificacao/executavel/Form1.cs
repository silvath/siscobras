...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_rbSqlServer.Size = new System.Drawing.Size(200, 16);
		...
		private void CreateDataBase()
		{
			...
			if (m_rbSqlServer.Checked)
				m_cls_dba_ConnectionBD = new mdlDataBaseAccess.clsDataBaseAccessSqlServer(ref m_cls_tre_tratadorErro,m_txtHost.Text,"1433",m_txtDataBaseName.Text,m_txtUser.Text,m_txtPassword.Text);
		}
		#endregion
		...
		private void m_btComercial_Click(object sender, System.EventArgs e)
		{
			string strRetorno;
			CreateDataBase();
			mdlClassificacao.clsClassificao teste = new mdlClassificacao.clsNaladi(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text, Int32.Parse(m_txtIdExportador.Text), Int32.Parse(m_tbIdIdioma.Text), ref m_ilBandeiras);
		...
		private void m_btProforma_Click(object sender, System.EventArgs e)
		{
			string strRetorno;
			CreateDataBase();
			mdlClassificacao.clsClassificao teste = new mdlClassificacao.clsNcm(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text, Int32.Parse(m_txtIdExportador.Text), Int32.Parse(m_tbIdIdioma.Text), ref m_ilBandeiras);
			teste.retornaValores(out strRetorno);
			m_txtRetorno.Text = "Retorno: " + strRetorno;
			teste.ShowDialog();
			teste.retornaValores(out strRetorno);
