...
{
	/// <summary>
	/// Summary description for frmFDataBaseConfigSqlServerAdmin.
	/// </summary>
	public class frmFDataBaseConfigSqlServerAdmin : System.Windows.Forms.Form
	{
		#region Delegates
			...
			public delegate bool delCallSqlServer(string strAdminUser,string strAdminPassword,out string strReturn);
		...
		#region Events
			...
			public event delCallSqlServer eCallSqlServer;
		...
		#region Events Methods
			...
			protected virtual bool OnCallSqlServer(out string strReturn)
			{
				bool bReturn = false;
				strReturn = "";
				if (eCallSqlServer != null)
					bReturn = eCallSqlServer(m_txtAdminUser.Text,m_txtAdminPassword.Text,out strReturn);
				return(bReturn);
			}
		...
		#region Constructors and Destructors
			public frmFDataBaseConfigSqlServerAdmin(string strHost,string strPort,string strDataBaseName,string strUser,string strPassword)
			{
				InitializeComponent();
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmFDataBaseConfigSqlServerAdmin));
			...
			this.m_ckSqlServer.Text = "Máquina rodando servidor SqlServer.";
			// 
			// m_ckServer
			// 
			...
			// 
			// frmFDataBaseConfigSqlServerAdmin
			// 
			...
			this.Name = "frmFDataBaseConfigSqlServerAdmin";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "SqlServer / MSDE";
			...
			private bool bInstall()
			{
				...
				if (eCallCarregaDados != null)
				{
					...
					{ 
						...
						if (!bSqlServer)
						{
							bInstall = OnCallSqlServer(out strReturn);
							if (!bInstall)
								break;
						}
