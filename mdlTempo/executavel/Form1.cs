...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			// m_gbGeral
			// 
			this.m_gbGeral.Anchor = (((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
			...
			// m_gbRetorno
			// 
			this.m_gbRetorno.Anchor = ((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left) 
				| System.Windows.Forms.AnchorStyles.Right);
			...
			// m_gbMoeda
			// 
			this.m_gbMoeda.Anchor = (((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
				| System.Windows.Forms.AnchorStyles.Left) 
				| System.Windows.Forms.AnchorStyles.Right);
			...
			this.groupBox1.Text = "Instrução de Embarque";
			// 
			// m_btComercial
			// 
			this.m_btComercial.Location = new System.Drawing.Point(244, 16);
			this.m_btComercial.Name = "m_btComercial";
			this.m_btComercial.Size = new System.Drawing.Size(96, 32);
			this.m_btComercial.TabIndex = 6;
			this.m_btComercial.Text = "Time Previsto";
...
//				this.m_txtRetorno.Text = "Data: " + strData;
			...
			private void m_btComercial_Click(object sender, System.EventArgs e)
			{
				...
				this.m_txtRetorno.Text = "";
				CreateDataBase();
				mdlTempo.clsTempo modTempo = new mdlTempo.clsTransitTimePrevisto(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text, Int32.Parse(m_txtIdExportador.Text), m_txtIdCodigo.Text);
				modTempo.retornaValores(out tempo);
				this.m_txtRetorno.Text = "Tempo: " + tempo.ToString();
				modTempo.ShowDialog();
				modTempo.retornaValores(out tempo);
				this.m_txtRetorno.Text = "Tempo: " + tempo.ToString();
			}
