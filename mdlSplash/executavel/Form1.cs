...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Button m_btSplash;
		...
		private void InitializeComponent()
		{
			...
			this.m_btSplash = new System.Windows.Forms.Button();
			...
			// m_gbMoeda
			// 
			this.m_gbMoeda.Controls.Add(this.m_btSplash);
			...
			// m_btSplash
			// 
			this.m_btSplash.Location = new System.Drawing.Point(9, 19);
			this.m_btSplash.Name = "m_btSplash";
			this.m_btSplash.Size = new System.Drawing.Size(96, 32);
			this.m_btSplash.TabIndex = 2;
			this.m_btSplash.Text = "Splash";
			this.m_btSplash.Click += new System.EventHandler(this.m_btSplash_Click);
			// 
			// m_gbBD
			// 
...
//				m_cls_dba_ConnectionBD = new mdlDataBaseAccess.clsDataBaseAccessMySql(ref m_cls_tre_tratadorErro,m_txtHost.Text,m_txtUser.Text,m_txtPassword.Text,m_txtDataBaseName.Text);
		...
		#region Negocio 
		private void m_btSplash_Click(object sender, System.EventArgs e)
		{
			CreateDataBase();
			mdlSplash.clsSplash obj = new mdlSplash.clsSplash(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text);
			obj.ShowDialog();
			m_txtRetorno.Text = obj.Habilitado.ToString();
			obj = null;
		}
		#endregion
	}
