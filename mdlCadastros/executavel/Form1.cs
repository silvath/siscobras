...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Button m_btNegocio;
		private System.Windows.Forms.CheckBox m_ckPrestadorServico;
		private System.Windows.Forms.TextBox m_txtIdPe;
		private System.Windows.Forms.Label m_lbIdPe;
		...
		private void InitializeComponent()
		{
			...
			this.m_ckPrestadorServico = new System.Windows.Forms.CheckBox();
			...
			this.m_btNegocio = new System.Windows.Forms.Button();
			...
			this.m_txtIdPe = new System.Windows.Forms.TextBox();
			this.m_lbIdPe = new System.Windows.Forms.Label();
			...
			this.m_gbParametros.Controls.Add(this.m_lbIdPe);
			this.m_gbParametros.Controls.Add(this.m_ckPrestadorServico);
			...
			// 
			// m_ckPrestadorServico
			// 
			this.m_ckPrestadorServico.Location = new System.Drawing.Point(8, 16);
			this.m_ckPrestadorServico.Name = "m_ckPrestadorServico";
			this.m_ckPrestadorServico.Size = new System.Drawing.Size(232, 16);
			this.m_ckPrestadorServico.TabIndex = 7;
			this.m_ckPrestadorServico.Text = "Prestador de Servico";
			// 
			// m_txtIdExportador
			// 
			this.m_txtIdExportador.Location = new System.Drawing.Point(99, 36);
			...
			// m_lbIdExportador
			// 
			this.m_lbIdExportador.Location = new System.Drawing.Point(14, 39);
			...
			// m_gbMoeda
			// 
			this.m_gbMoeda.Controls.Add(this.m_btNegocio);
			...
			// m_btNegocio
			// 
			this.m_btNegocio.Location = new System.Drawing.Point(6, 20);
			this.m_btNegocio.Name = "m_btNegocio";
			this.m_btNegocio.Size = new System.Drawing.Size(96, 32);
			this.m_btNegocio.TabIndex = 6;
			this.m_btNegocio.Text = "Negocio";
			this.m_btNegocio.Click += new System.EventHandler(this.m_btNegocio_Click);
			// 
			// m_gbBD
			// 
			...
			// m_txtIdPe
			// 
			this.m_txtIdPe.Location = new System.Drawing.Point(245, 34);
			this.m_txtIdPe.Name = "m_txtIdPe";
			this.m_txtIdPe.Size = new System.Drawing.Size(91, 20);
			this.m_txtIdPe.TabIndex = 9;
			this.m_txtIdPe.Text = "001";
			this.m_txtIdPe.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// m_lbIdPe
			// 
			this.m_lbIdPe.Location = new System.Drawing.Point(212, 37);
			this.m_lbIdPe.Name = "m_lbIdPe";
			this.m_lbIdPe.Size = new System.Drawing.Size(36, 16);
			this.m_lbIdPe.TabIndex = 8;
			this.m_lbIdPe.Text = "IdPe";
			// 
			// Form1
			// 
		...
		#region Negocio
			private void m_btNegocio_Click(object sender, System.EventArgs e)
			{
				CreateDataBase();
				formParent obj = new formParent(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,m_ckPrestadorServico.Checked,Int32.Parse(m_txtIdExportador.Text),m_txtIdPe.Text);
				obj.Show();
			}
		#endregion
	}
