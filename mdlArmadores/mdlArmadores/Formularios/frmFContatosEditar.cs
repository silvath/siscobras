...
{
	/// <summary>
	/// Summary description for frmFContatosEditar.
	/// </summary>
	public class frmFContatosEditar : System.Windows.Forms.Form
	{
		#region Delegates
			public delegate void delCallCarregaDados(int nIdTerminal,int nIdContato,out string strNome,out string strTelefone,out string strFax,out string strEmail);
			public delegate bool delCallSalvaDados(int nIdTerminal,int nIdContato,string strNome,string strTelefone,string strFax,string strEmail);
		#endregion
		#region Events
		...
		#region Events Methods
			protected virtual void OnCallCarregaDados()
			{
				...
				if (eCallCarregaDados != null)
				{
					...
					eCallCarregaDados(m_nIdTerminal,m_nIdContato,out strNome,out strTelefone,out strFax,out strEmail);
			...
			protected virtual bool OnCallSalvaDados()
			{
				...
				if (eCallSalvaDados != null)
					bRetorno = eCallSalvaDados(m_nIdTerminal,m_nIdContato,m_txtNome.Text,m_txtTelefone.Text,m_txtFax.Text,m_txtEmail.Text);
				this.Cursor = System.Windows.Forms.Cursors.Default;
				return(bRetorno);
			}
		#endregion
		...
		#region Constructors and Destructors
			public frmFContatosEditar(string strEnderecoExecutavel,int nIdTerminal)
			{
				// Cadastro
			...
			public frmFContatosEditar(string strEnderecoExecutavel,int nIdTerminal,int nIdContato)
			{
				// Edicao
				m_strEnderecoExecutavel = strEnderecoExecutavel;
				m_nIdTerminal = nIdTerminal;
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmFContatosEditar));
			...
			this.Name = "frmFContatosEditar";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "Contato";
			this.Load += new System.EventHandler(this.frmFContatosEditar_Load);
		...
		#region Eventos
			#region Formulario
				private void frmFContatosEditar_Load(object sender, System.EventArgs e)
				{
					vMostraCor();
					OnCallCarregaDados();
				}
