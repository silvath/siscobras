...
namespace mdlArmadores.Formularios
{
	...
	{
		#region Delegates
			public delegate void delCallContatosRefresh(int nIdTerminal,ref System.Windows.Forms.ListView lvContatos);
			...
			public delegate bool delCallContatoNovo(int nIdTerminal);
			public delegate bool delCallContatoEditar(int nIdTerminal,int nIdContato);
			public delegate bool delCallContatosExcluir(int nIdTerminal,ref System.Collections.ArrayList arlContatos,bool bSilent);
		#endregion
		#region Events
		...
		#region Events Methods
			protected virtual void OnCallContatosRefresh()
			{
				...
				if (eCallContatosRefresh != null)
					eCallContatosRefresh(m_nIdTerminal,ref m_lvContatos);
			...
			protected virtual bool OnCallContatoNovo()
			{
				...
				if (eCallContatoNovo != null)
					bRetorno = eCallContatoNovo(m_nIdTerminal);
				this.Cursor = System.Windows.Forms.Cursors.Default;
				return(bRetorno);
			}
			...
			protected virtual bool OnCallContatoEditar()
			{
				...
				if ((eCallContatoEditar != null) && (m_lvContatos.SelectedItems.Count > 0))
					bRetorno = eCallContatoEditar(m_nIdTerminal,Int32.Parse(m_lvContatos.SelectedItems[0].Tag.ToString()));
				this.Cursor = System.Windows.Forms.Cursors.Default;
				return(bRetorno);
			}
			...
			protected virtual bool OnCallContatosExcluir()
			{
				...
				if ((eCallContatosExcluir != null) && (m_lvContatos.SelectedItems.Count > 0))
				{
					...
					return(eCallContatosExcluir(m_nIdTerminal,ref arlContatos,false));
				}
				this.Cursor = System.Windows.Forms.Cursors.Default;
				return(bRetorno);
			}
		...
		#region Constructors and Destructors
			public frmFContatos(string strEnderecoExecutavel,int nIdTerminal)
			{
