...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Button m_btArmadores;
		private System.Windows.Forms.Button m_btTerminais;
		private System.Windows.Forms.Button m_btArmadoresPe;
		private System.Windows.Forms.Button m_btTerminaisPe;
		...
		private void InitializeComponent()
		{
			...
			this.m_btTerminaisPe = new System.Windows.Forms.Button();
			this.m_btArmadoresPe = new System.Windows.Forms.Button();
			this.m_btTerminais = new System.Windows.Forms.Button();
			this.m_btArmadores = new System.Windows.Forms.Button();
			...
			// m_gbMoeda
			// 
			this.m_gbMoeda.Controls.Add(this.m_btTerminaisPe);
			this.m_gbMoeda.Controls.Add(this.m_btArmadoresPe);
			this.m_gbMoeda.Controls.Add(this.m_btTerminais);
			this.m_gbMoeda.Controls.Add(this.m_btArmadores);
			...
			// m_btTerminaisPe
			// 
			this.m_btTerminaisPe.Location = new System.Drawing.Point(320, 20);
			this.m_btTerminaisPe.Name = "m_btTerminaisPe";
			this.m_btTerminaisPe.Size = new System.Drawing.Size(96, 32);
			this.m_btTerminaisPe.TabIndex = 9;
			this.m_btTerminaisPe.Text = "Terminais PE";
			this.m_btTerminaisPe.Click += new System.EventHandler(this.m_btTerminaisPe_Click);
			// 
			// m_btArmadoresPe
			// 
			this.m_btArmadoresPe.Location = new System.Drawing.Point(106, 20);
			this.m_btArmadoresPe.Name = "m_btArmadoresPe";
			this.m_btArmadoresPe.Size = new System.Drawing.Size(96, 32);
			this.m_btArmadoresPe.TabIndex = 8;
			this.m_btArmadoresPe.Text = "Armadores PE";
			this.m_btArmadoresPe.Click += new System.EventHandler(this.m_btArmadoresPe_Click);
			// 
			// m_btTerminais
			// 
			this.m_btTerminais.Location = new System.Drawing.Point(216, 20);
			this.m_btTerminais.Name = "m_btTerminais";
			this.m_btTerminais.Size = new System.Drawing.Size(96, 32);
			this.m_btTerminais.TabIndex = 7;
			this.m_btTerminais.Text = "Terminais";
			this.m_btTerminais.Click += new System.EventHandler(this.m_btTerminais_Click);
			// 
			// m_btArmadores
			// 
			this.m_btArmadores.Location = new System.Drawing.Point(6, 20);
			this.m_btArmadores.Name = "m_btArmadores";
			this.m_btArmadores.Size = new System.Drawing.Size(96, 32);
			this.m_btArmadores.TabIndex = 6;
			this.m_btArmadores.Text = "Armadores";
			this.m_btArmadores.Click += new System.EventHandler(this.m_btArmadores_Click);
			// 
			// m_gbBD
			// 
		...
		#region Negocio
			private void m_btArmadores_Click(object sender, System.EventArgs e)
			{
				CreateDataBase();
				mdlArmadores.clsArmador obj = new mdlArmadores.clsArmador(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text));
				obj.ShowDialog();
			}

			private void m_btArmadoresPe_Click(object sender, System.EventArgs e)
			{
				CreateDataBase();
				mdlArmadores.clsArmador obj = new mdlArmadores.clsArmador(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text);
				obj.ShowDialog();
				if (obj.m_bModificado)
				{
					string strArmador,strNavio;
					obj.vRetornaValores(out strArmador,out strNavio);
					m_txtRetorno.Text = "Armador: " + strArmador + " - Navio: " + strNavio;
				}
			}

			private void m_btTerminais_Click(object sender, System.EventArgs e)
			{
				CreateDataBase();
				mdlArmadores.clsTerminal obj = new mdlArmadores.clsTerminal(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text));
				obj.ShowDialog();
			}

			private void m_btTerminaisPe_Click(object sender, System.EventArgs e)
			{
				CreateDataBase();
				mdlArmadores.clsTerminal obj = new mdlArmadores.clsTerminal(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text);
				obj.ShowDialog();
				if (obj.m_bModificado)
				{
					string strTerminalNome,strTerminalEndereco,strTerminalCEP,strTerminalBairro,strTerminalCidade,strTerminalEstado,strTerminalTelefone,strTerminalFax,strTerminalEmail,strTerminalSite,strContatoNome,strContatoTelefone,strContatoFax,strContatoEmail;
					obj.vRetornaValores(out strTerminalNome,out strTerminalEndereco,out strTerminalCEP,out strTerminalBairro,out strTerminalCidade,out strTerminalEstado,out strTerminalTelefone,out strTerminalFax,out strTerminalEmail,out strTerminalSite,out strContatoNome,out strContatoTelefone,out strContatoFax,out strContatoEmail);
					m_txtRetorno.Text = "Terminal: " + strTerminalNome + strTerminalEndereco + strTerminalCEP + strTerminalBairro + strTerminalCidade + strTerminalEstado + strTerminalTelefone + strTerminalFax + strTerminalEmail + strTerminalSite + " Contato: " + strContatoNome + strContatoTelefone + strContatoFax + strContatoEmail;
				}
			}
		#endregion
