...
namespace mdlTransportadoras.Formularios
{
	...
	/// </summary>
	internal class frmFContatosEdicao : System.Windows.Forms.Form
	{
		#region Delegates
			public delegate void delCallCarregaDados(int nIdTransportadora,int nIdContato,out string strNome,out string strTelefone,out string strFax,out string strEmail);
			public delegate bool delCallSalvaDados(int nIdTransportadora,int nIdContato,string strNome,string strTelefone,string strFax,string strEmail);
		#endregion
		#region Events
		...
		#region Events Methods
			protected virtual void OnCallCarregaDados()
			{
				if (eCallCarregaDados != null)
				{
					...
					eCallCarregaDados(m_nIdTransportadora,m_nIdContato,out strNome,out strTelefone,out strFax,out strEmail);
			...
			protected virtual bool OnCallSalvaDados()
			{
				...
				if (eCallSalvaDados != null)
					bRetorno = eCallSalvaDados(m_nIdTransportadora,m_nIdContato,m_txtNome.Text,m_txtTelefone.Text,m_txtFax.Text,m_txtEmail.Text);
				return(bRetorno);
			}
		#endregion
