...
{
	/// <summary>
	/// Summary description for frmFTransportadorasEdicao.
	/// </summary>
	internal class frmFTransportadorasEdicao : System.Windows.Forms.Form
	{
		#region Delegates
			public delegate void delCallCarregaDadosEstadosBrasileiros(ref mdlComponentesGraficos.ComboBox cbEstadosBrasileiros);
			public delegate void delCallCarregaDados(int nIdTransportadora,out string strNome,out string strEndereco,out string strCEP,out string strBairro,out string strCidade,out int nIdEstado,out string strTelefone,out string strFax,out string strEmail,out string strSite);
			public delegate bool delCallSalvaDados(int nIdTransportadora,string strNome,string strEndereco,string strCEP,string strBairro,string strCidade,int nIdEstado,string strTelefone,string strFax,string strEmail,string strSite);
		#endregion
		#region Events
		...
		#region Events Methods
			...
			protected virtual void OnCallCarregaDados()
			{
				if (eCallCarregaDados != null)
				{
					...
					int nIdEstado;
					eCallCarregaDados(m_nIdTransportadora,out strNome,out strEndereco,out strCEP,out strBairro,out strCidade,out nIdEstado,out strTelefone,out strFax,out strEmail,out strSite);
			...
			protected virtual bool OnCallSalvaDados()
			{
				...
				if (eCallSalvaDados != null)
				{
					...
					bRetorno = eCallSalvaDados(m_nIdTransportadora,m_txtNome.Text,m_txtEndereco.Text,m_txtCep.Text,m_txtBairro.Text,m_txtCidade.Text,nIdEstado,m_txtTelefone.Text,m_txtFax.Text,m_txtEmail.Text,m_txtSite.Text);
				}
				return(bRetorno);
			}
		#endregion
		...
		#region Atributes
			...
			private System.Windows.Forms.GroupBox m_gbTransportadora;
			private System.Windows.Forms.ToolTip m_ttDicas;
			private System.ComponentModel.IContainer components;
		#endregion
		#region Constructors and Destructors
			public frmFTransportadorasEdicao(string strEnderecoExecutavel)
			{
				// Cadastro
				m_strEnderecoExecutavel = strEnderecoExecutavel;
				m_nIdTransportadora = -1;
				InitializeComponent();
				m_gbTransportadora.Text = "Cadastro";
			}

			public frmFTransportadorasEdicao(string strEnderecoExecutavel,int nIdTransportadora)
			{
				// Edicao
				m_strEnderecoExecutavel = strEnderecoExecutavel;
				m_nIdTransportadora = nIdTransportadora;
				InitializeComponent();
				m_gbTransportadora.Text = "Edição";
			}
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmFTransportadorasEdicao));
			this.m_gbGeral = new System.Windows.Forms.GroupBox();
			this.m_gbTransportadora = new System.Windows.Forms.GroupBox();
			...
			this.m_gbTransportadora.SuspendLayout();
			this.SuspendLayout();
			// 
			// m_gbGeral
			// 
			this.m_gbGeral.Controls.Add(this.m_gbTransportadora);
			...
			// m_gbTransportadora
			// 
			this.m_gbTransportadora.Controls.Add(this.m_cbEstado);
			this.m_gbTransportadora.Controls.Add(this.m_lbEstado);
			this.m_gbTransportadora.Controls.Add(this.m_txtSite);
			this.m_gbTransportadora.Controls.Add(this.m_txtEmail);
			this.m_gbTransportadora.Controls.Add(this.m_lbSite);
			this.m_gbTransportadora.Controls.Add(this.m_lbEmail);
			this.m_gbTransportadora.Controls.Add(this.m_txtBairro);
			this.m_gbTransportadora.Controls.Add(this.m_lbBairro);
			this.m_gbTransportadora.Controls.Add(this.m_txtCep);
			this.m_gbTransportadora.Controls.Add(this.m_lbCep);
			this.m_gbTransportadora.Controls.Add(this.m_txtFax);
			this.m_gbTransportadora.Controls.Add(this.m_txtTelefone);
			this.m_gbTransportadora.Controls.Add(this.m_lbFax);
			this.m_gbTransportadora.Controls.Add(this.m_lbTelefone);
			this.m_gbTransportadora.Controls.Add(this.m_txtCidade);
			this.m_gbTransportadora.Controls.Add(this.m_txtEndereco);
			this.m_gbTransportadora.Controls.Add(this.m_txtNome);
			this.m_gbTransportadora.Controls.Add(this.m_lbCidade);
			this.m_gbTransportadora.Controls.Add(this.m_lbEndereco);
			this.m_gbTransportadora.Controls.Add(this.m_lbNome);
			this.m_gbTransportadora.Font = new System.Drawing.Font("Arial", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.m_gbTransportadora.Location = new System.Drawing.Point(6, 6);
			this.m_gbTransportadora.Name = "m_gbTransportadora";
			this.m_gbTransportadora.Size = new System.Drawing.Size(334, 258);
			this.m_gbTransportadora.TabIndex = 7;
			this.m_gbTransportadora.TabStop = false;
			this.m_gbTransportadora.Text = "Cadastro / Edição";
			// 
			// m_cbEstado
			// 
			...
			this.Name = "frmFTransportadorasEdicao";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Transportadora";
			this.Load += new System.EventHandler(this.frmFTransportadorasEdicao_Load);
			this.m_gbGeral.ResumeLayout(false);
			this.m_gbTransportadora.ResumeLayout(false);
		...
		#region Eventos
			#region Formulario
				private void frmFTransportadorasEdicao_Load(object sender, System.EventArgs e)
				{
