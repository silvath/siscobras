...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Button m_btTransportadoras;
		private System.Windows.Forms.TextBox m_txtIdContainer;
		private System.Windows.Forms.Label m_lbContainer;
		...
		private void InitializeComponent()
		{
			...
			this.m_txtIdContainer = new System.Windows.Forms.TextBox();
			this.m_lbContainer = new System.Windows.Forms.Label();
			...
			this.m_btTransportadoras = new System.Windows.Forms.Button();
			...
			// m_gbParametros
			// 
			this.m_gbParametros.Controls.Add(this.m_txtIdContainer);
			this.m_gbParametros.Controls.Add(this.m_lbContainer);
			...
			// m_txtIdContainer
			// 
			this.m_txtIdContainer.Location = new System.Drawing.Point(456, 22);
			this.m_txtIdContainer.Name = "m_txtIdContainer";
			this.m_txtIdContainer.Size = new System.Drawing.Size(91, 20);
			this.m_txtIdContainer.TabIndex = 9;
			this.m_txtIdContainer.Text = "1";
			this.m_txtIdContainer.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// m_lbContainer
			// 
			this.m_lbContainer.Location = new System.Drawing.Point(376, 24);
			this.m_lbContainer.Name = "m_lbContainer";
			this.m_lbContainer.Size = new System.Drawing.Size(75, 16);
			this.m_lbContainer.TabIndex = 8;
			this.m_lbContainer.Text = "idContainer:";
			// 
			// m_txtIdCodigo
			// 
			...
			// m_gbMoeda
			// 
			this.m_gbMoeda.Controls.Add(this.m_btTransportadoras);
			...
			// m_btTransportadoras
			// 
			this.m_btTransportadoras.Location = new System.Drawing.Point(6, 20);
			this.m_btTransportadoras.Name = "m_btTransportadoras";
			this.m_btTransportadoras.Size = new System.Drawing.Size(96, 32);
			this.m_btTransportadoras.TabIndex = 6;
			this.m_btTransportadoras.Text = "Transportadoras";
			this.m_btTransportadoras.Click += new System.EventHandler(this.m_btTransportadoras_Click);
			// 
			// m_gbBD
			// 
		...
		#region Negocio
			private void m_btTransportadoras_Click(object sender, System.EventArgs e)
			{
				CreateDataBase();
				mdlTransportadoras.clsTransportadora obj = new mdlTransportadoras.clsTransportadora(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text,Int32.Parse(m_txtIdContainer.Text));
				obj.ShowDialog();
			}
		#endregion
	}
