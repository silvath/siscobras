...
namespace executavel
{
	...
	public class frmMain : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_btRomaneio.Text = "Formulario Parent";
			this.m_btRomaneio.Click += new System.EventHandler(this.m_btFormularioParent_Click);
			// 
			// m_gbBD
			// 
			...
			// m_txtPortSqlServer
			// 
			this.m_txtPortSqlServer.Location = new System.Drawing.Point(145, 44);
...
//			}
		...
		{
			CreateDataBase();
			Form1 obj = new Form1(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text);
			obj.ShowDialog();
			obj = null;
		}
		#endregion
