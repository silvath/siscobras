...
{
	/// <summary>
	/// Summary description for frmFDespachantesEdicao.
	/// </summary>
	public class frmFDespachantesEdicao : System.Windows.Forms.Form
	{
		#region Delegates
			public delegate void delCallCarregaDadosEstadosBrasileiros(ref mdlComponentesGraficos.ComboBox cbEstadosBrasileiros);
			public delegate void delCallCarregaDados(int nIdDespachante,out string strNome,out string strEndereco,out string strCEP,out string strBairro,out string strCidade,out int nIdEstado,out string strTelefone,out string strFax,out string strEmail,out string strSite);
			public delegate bool delCallSalvaDados(int nIdDespachante,string strNome,string strEndereco,string strCEP,string strBairro,string strCidade,int nIdEstado,string strTelefone,string strFax,string strEmail,string strSite);
		#endregion
		#region Events
		...
		#region Events Methods
			...
			protected virtual void OnCallCarregaDados()
			{
				if (eCallCarregaDados != null)
				{
					...
					int nIdEstado;
					eCallCarregaDados(m_nIdDespachante,out strNome,out strEndereco,out strCEP,out strBairro,out strCidade,out nIdEstado,out strTelefone,out strFax,out strEmail,out strSite);
			...
			protected virtual bool OnCallSalvaDados()
			{
				...
				if (eCallSalvaDados != null)
				{
					...
					bRetorno = eCallSalvaDados(m_nIdDespachante,m_txtNome.Text,m_txtEndereco.Text,m_txtCep.Text,m_txtBairro.Text,m_txtCidade.Text,nIdEstado,m_txtTelefone.Text,m_txtFax.Text,m_txtEmail.Text,m_txtSite.Text);
				}
				return(bRetorno);
			}
		#endregion
		...
		#region Atributes
			...
			private int m_nIdDespachante = -1;
			...
			private System.Windows.Forms.GroupBox m_gbDespachante;
		#endregion
		#region Constructors and Destructors
			public frmFDespachantesEdicao(string strEnderecoExecutavel)
			{
				// Cadastro
				m_strEnderecoExecutavel = strEnderecoExecutavel;
				m_nIdDespachante = -1;
				InitializeComponent();
				m_gbDespachante.Text = "Cadastro";
			}

			public frmFDespachantesEdicao(string strEnderecoExecutavel,int nIdDespachante)
			{
				// Edicao
				m_strEnderecoExecutavel = strEnderecoExecutavel;
				m_nIdDespachante = nIdDespachante;
				InitializeComponent();
				m_gbDespachante.Text = "Edição";
			}
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmFDespachantesEdicao));
			this.m_gbGeral = new System.Windows.Forms.GroupBox();
			this.m_gbDespachante = new System.Windows.Forms.GroupBox();
			...
			this.m_gbDespachante.SuspendLayout();
			this.SuspendLayout();
			// 
			// m_gbGeral
			// 
			this.m_gbGeral.Controls.Add(this.m_gbDespachante);
			...
			// m_gbDespachante
			// 
			this.m_gbDespachante.Controls.Add(this.m_cbEstado);
			this.m_gbDespachante.Controls.Add(this.m_lbEstado);
			this.m_gbDespachante.Controls.Add(this.m_txtSite);
			this.m_gbDespachante.Controls.Add(this.m_txtEmail);
			this.m_gbDespachante.Controls.Add(this.m_lbSite);
			this.m_gbDespachante.Controls.Add(this.m_lbEmail);
			this.m_gbDespachante.Controls.Add(this.m_txtBairro);
			this.m_gbDespachante.Controls.Add(this.m_lbBairro);
			this.m_gbDespachante.Controls.Add(this.m_txtCep);
			this.m_gbDespachante.Controls.Add(this.m_lbCep);
			this.m_gbDespachante.Controls.Add(this.m_txtFax);
			this.m_gbDespachante.Controls.Add(this.m_txtTelefone);
			this.m_gbDespachante.Controls.Add(this.m_lbFax);
			this.m_gbDespachante.Controls.Add(this.m_lbTelefone);
			this.m_gbDespachante.Controls.Add(this.m_txtCidade);
			this.m_gbDespachante.Controls.Add(this.m_txtEndereco);
			this.m_gbDespachante.Controls.Add(this.m_txtNome);
			this.m_gbDespachante.Controls.Add(this.m_lbCidade);
			this.m_gbDespachante.Controls.Add(this.m_lbEndereco);
			this.m_gbDespachante.Controls.Add(this.m_lbNome);
			this.m_gbDespachante.Font = new System.Drawing.Font("Arial", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.m_gbDespachante.Location = new System.Drawing.Point(6, 6);
			this.m_gbDespachante.Name = "m_gbDespachante";
			this.m_gbDespachante.Size = new System.Drawing.Size(334, 258);
			this.m_gbDespachante.TabIndex = 7;
			this.m_gbDespachante.TabStop = false;
			this.m_gbDespachante.Text = "Cadastro / Edição";
			// 
			// m_cbEstado
			// 
			this.m_cbEstado.Location = new System.Drawing.Point(88, 136);
			this.m_cbEstado.Name = "m_cbEstado";
			this.m_cbEstado.Size = new System.Drawing.Size(232, 22);
			...
			this.m_txtSite.Location = new System.Drawing.Point(88, 184);
			this.m_txtSite.Name = "m_txtSite";
			this.m_txtSite.Size = new System.Drawing.Size(232, 20);
			...
			this.m_txtEmail.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
				| System.Windows.Forms.AnchorStyles.Right)));
			this.m_txtEmail.Location = new System.Drawing.Point(88, 160);
			this.m_txtEmail.Name = "m_txtEmail";
			this.m_txtEmail.Size = new System.Drawing.Size(232, 20);
			...
			this.m_txtBairro.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
				| System.Windows.Forms.AnchorStyles.Right)));
			this.m_txtBairro.Location = new System.Drawing.Point(88, 87);
			this.m_txtBairro.Name = "m_txtBairro";
			this.m_txtBairro.Size = new System.Drawing.Size(232, 20);
			...
			this.m_txtCep.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
				| System.Windows.Forms.AnchorStyles.Right)));
			this.m_txtCep.Location = new System.Drawing.Point(88, 63);
			this.m_txtCep.Mask = true;
			this.m_txtCep.MaskText = "NNNNN-NNN";
			this.m_txtCep.Name = "m_txtCep";
			this.m_txtCep.Size = new System.Drawing.Size(232, 20);
			...
			this.m_txtFax.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
				| System.Windows.Forms.AnchorStyles.Right)));
			this.m_txtFax.Location = new System.Drawing.Point(88, 232);
			this.m_txtFax.Name = "m_txtFax";
			this.m_txtFax.Size = new System.Drawing.Size(232, 20);
			...
			this.m_txtTelefone.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
				| System.Windows.Forms.AnchorStyles.Right)));
			this.m_txtTelefone.Location = new System.Drawing.Point(88, 208);
			this.m_txtTelefone.Name = "m_txtTelefone";
			this.m_txtTelefone.Size = new System.Drawing.Size(232, 20);
			...
			this.m_txtCidade.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
				| System.Windows.Forms.AnchorStyles.Right)));
			this.m_txtCidade.Location = new System.Drawing.Point(88, 112);
			this.m_txtCidade.Name = "m_txtCidade";
			this.m_txtCidade.Size = new System.Drawing.Size(232, 20);
			...
			this.m_txtEndereco.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
				| System.Windows.Forms.AnchorStyles.Right)));
			this.m_txtEndereco.Location = new System.Drawing.Point(88, 41);
			this.m_txtEndereco.Name = "m_txtEndereco";
			this.m_txtEndereco.Size = new System.Drawing.Size(232, 20);
			...
			this.m_txtNome.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
				| System.Windows.Forms.AnchorStyles.Right)));
			this.m_txtNome.Location = new System.Drawing.Point(88, 17);
			this.m_txtNome.Name = "m_txtNome";
			this.m_txtNome.Size = new System.Drawing.Size(232, 20);
			...
			this.m_lbNome.Size = new System.Drawing.Size(79, 14);
			this.m_lbNome.TabIndex = 0;
			this.m_lbNome.Text = "Razão Social:";
			...
			this.Name = "frmFDespachantesEdicao";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "Comissária de Despacho";
			this.Load += new System.EventHandler(this.frmFDespachantesEdicao_Load);
			this.m_gbGeral.ResumeLayout(false);
			this.m_gbDespachante.ResumeLayout(false);
		...
		#region Eventos
			#region Formulario
				private void frmFDespachantesEdicao_Load(object sender, System.EventArgs e)
				{
