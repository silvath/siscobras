...
{
	/// <summary>
	/// Summary description for frmFContatosEdicao.
	/// </summary>
	public class frmFContatosEdicao : System.Windows.Forms.Form
	{
		#region Delegates
		public delegate void delCallCarregaDados(int nIdTransportadora,int nIdContato,out string strNome,out string strTelefone,out string strFax,out string strEmail,out string strRDA);
		public delegate bool delCallSalvaDados(int nIdTransportadora,int nIdContato,string strNome,string strTelefone,string strFax,string strEmail,string strRDA);
		#endregion
		#region Events
		...
		protected virtual void OnCallCarregaDados()
		{
			...
			{
				string strNome,strTelefone,strFax,strEmail,strRDA;
				eCallCarregaDados(m_nIdTransportadora,m_nIdContato,out strNome,out strTelefone,out strFax,out strEmail,out strRDA);
				m_txtNome.Text = strNome;
				m_txtTelefone.Text = strTelefone;
				m_txtFax.Text = strFax;
				m_txtEmail.Text = strEmail;
				m_txtRDA.Text = strRDA;
			}
		}
		...
		protected virtual bool OnCallSalvaDados()
		{
			...
			if (eCallSalvaDados != null)
				bRetorno = eCallSalvaDados(m_nIdTransportadora,m_nIdContato,m_txtNome.Text,m_txtTelefone.Text,m_txtFax.Text,m_txtEmail.Text,m_txtRDA.Text);
			return(bRetorno);
		}
		#endregion
		...
		private mdlComponentesGraficos.TextBox m_txtRDA;
		private System.Windows.Forms.Label m_lbRDA;
		private System.ComponentModel.IContainer components;
		#endregion
		#region Constructors and Destructors
		public frmFContatosEdicao(string strEnderecoExecutavel,int nIdTransportadora)
		{
			// Cadastro
		...
		public frmFContatosEdicao(string strEnderecoExecutavel,int nIdTransportadora,int nIdContato)
		{
			// Edicao
			m_strEnderecoExecutavel = strEnderecoExecutavel;
			m_nIdTransportadora = nIdTransportadora;
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmFContatosEdicao));
			this.m_gbGeral = new System.Windows.Forms.GroupBox();
			this.m_btOk = new System.Windows.Forms.Button();
			this.m_btCancelar = new System.Windows.Forms.Button();
			this.m_gbContato = new System.Windows.Forms.GroupBox();
			this.m_txtRDA = new mdlComponentesGraficos.TextBox();
			this.m_lbRDA = new System.Windows.Forms.Label();
			...
			this.m_gbGeral.Location = new System.Drawing.Point(2, -2);
			this.m_gbGeral.Name = "m_gbGeral";
			this.m_gbGeral.Size = new System.Drawing.Size(208, 174);
			...
			this.m_btOk.Location = new System.Drawing.Point(48, 144);
			...
			this.m_btCancelar.Location = new System.Drawing.Point(112, 144);
			...
			// m_gbContato
			// 
			this.m_gbContato.Controls.Add(this.m_txtRDA);
			this.m_gbContato.Controls.Add(this.m_lbRDA);
			...
			this.m_gbContato.Size = new System.Drawing.Size(193, 133);
			...
			// m_txtRDA
			// 
			this.m_txtRDA.Location = new System.Drawing.Point(65, 106);
			this.m_txtRDA.Name = "m_txtRDA";
			this.m_txtRDA.Size = new System.Drawing.Size(117, 20);
			this.m_txtRDA.TabIndex = 4;
			this.m_txtRDA.Text = "";
			// 
			// m_lbRDA
			// 
			this.m_lbRDA.ForeColor = System.Drawing.Color.Black;
			this.m_lbRDA.Location = new System.Drawing.Point(9, 108);
			this.m_lbRDA.Name = "m_lbRDA";
			this.m_lbRDA.Size = new System.Drawing.Size(62, 14);
			this.m_lbRDA.TabIndex = 14;
			this.m_lbRDA.Text = "RDA:";
			this.m_lbRDA.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			// 
			// m_txtEmail
			// 
			...
			this.Name = "frmFContatosEdicao";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "Contato / Despachante";
			this.Load += new System.EventHandler(this.frmFContatosEdicao_Load);
		...
		#region Eventos
		#region Formulario
		private void frmFContatosEdicao_Load(object sender, System.EventArgs e)
		{
			vMostraCor();
			OnCallCarregaDados();
		}
