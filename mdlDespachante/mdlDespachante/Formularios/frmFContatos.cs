...
{
	/// <summary>
	/// Summary description for frmFContatos.
	/// </summary>
	public class frmFContatos : System.Windows.Forms.Form
	{
		#region Delegates
		public delegate void delCallContatosRefresh(int nIdTransportadora,ref System.Windows.Forms.ListView lvContatos);
		...
		public delegate bool delCallContatoNovo(int nIdTransportadora);
		public delegate bool delCallContatoEditar(int nIdTransportadora,int nIdContato);
		public delegate bool delCallContatosExcluir(int nIdTransportadora,ref System.Collections.ArrayList arlContatos,bool bSilent);
		#endregion
		#region Events
		...
		protected virtual void OnCallContatosRefresh()
		{
			if (eCallContatosRefresh != null)
				eCallContatosRefresh(m_nIdTransportadora,ref m_lvContatos);
		}
		...
		protected virtual bool OnCallContatoNovo()
		{
			...
			if (eCallContatoNovo != null)
				bRetorno = eCallContatoNovo(m_nIdTransportadora);
			return(bRetorno);
		}
		...
		protected virtual bool OnCallContatoEditar()
		{
			...
			if ((eCallContatoEditar != null) && (m_lvContatos.SelectedItems.Count > 0))
				bRetorno = eCallContatoEditar(m_nIdTransportadora,Int32.Parse(m_lvContatos.SelectedItems[0].Tag.ToString()));
			return(bRetorno);
		}
		...
		protected virtual bool OnCallContatosExcluir()
		{
			if ((eCallContatosExcluir != null) && (m_lvContatos.SelectedItems.Count > 0))
			{
				...
				return(eCallContatosExcluir(m_nIdTransportadora,ref arlContatos,false));
			}
			else
				return(false);
		}
		...
		public frmFContatos(string strEnderecoExecutavel,int nIdTransportadora)
		{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmFContatos));
			...
			this.m_gbContatos.Text = "Contatos / Despachantes";
			// 
			// m_btExcluir
			// 
			...
			this.m_btExcluir.Location = new System.Drawing.Point(139, 13);
			...
			this.m_btEditar.Location = new System.Drawing.Point(107, 13);
			...
			this.m_btNovo.Location = new System.Drawing.Point(75, 13);
			...
			this.Name = "frmFContatos";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "Contatos / Despachantes";
			this.Load += new System.EventHandler(this.frmFContatos_Load);
		...
		#region Eventos
		#region Formulario
		private void frmFContatos_Load(object sender, System.EventArgs e)
		{
			vMostraCor();
