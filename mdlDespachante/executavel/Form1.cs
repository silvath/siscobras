...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Button m_btDespachantePe;
		private System.Windows.Forms.Button m_btDespachante;
		...
		private void InitializeComponent()
		{
			...
			this.m_btDespachantePe = new System.Windows.Forms.Button();
			this.m_btDespachante = new System.Windows.Forms.Button();
			...
			// m_gbMoeda
			// 
			this.m_gbMoeda.Controls.Add(this.m_btDespachantePe);
			this.m_gbMoeda.Controls.Add(this.m_btDespachante);
			...
			// m_btDespachantePe
			// 
			this.m_btDespachantePe.Location = new System.Drawing.Point(106, 16);
			this.m_btDespachantePe.Name = "m_btDespachantePe";
			this.m_btDespachantePe.Size = new System.Drawing.Size(103, 32);
			this.m_btDespachantePe.TabIndex = 2;
			this.m_btDespachantePe.Text = "Despachante(PE)";
			this.m_btDespachantePe.Click += new System.EventHandler(this.m_btDespachantePe_Click);
			// 
			// m_btDespachante
			// 
			this.m_btDespachante.Location = new System.Drawing.Point(8, 16);
			this.m_btDespachante.Name = "m_btDespachante";
			this.m_btDespachante.Size = new System.Drawing.Size(96, 32);
			this.m_btDespachante.TabIndex = 0;
			this.m_btDespachante.Text = "Despachante";
			this.m_btDespachante.Click += new System.EventHandler(this.m_btDespachante_Click);
			// 
			// m_gbBD
			// 
			...
			// m_txtPortSqlServer
			// 
			this.m_txtPortSqlServer.Location = new System.Drawing.Point(150, 44);
			...
			// m_lbPortSqlServer
			// 
			this.m_lbPortSqlServer.Location = new System.Drawing.Point(120, 48);
		...
		#region Negocio
			private void m_btDespachante_Click(object sender, System.EventArgs e)
			{
				vCreateDataBase();
				mdlDespachante.clsDespachante obj = new mdlDespachante.clsDespachante(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text));
				obj.ShowDialog();
