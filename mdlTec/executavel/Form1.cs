...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Button m_btShowDialogSemDB;
		...
		private void InitializeComponent()
		{
			...
			this.m_btShowDialogSemDB = new System.Windows.Forms.Button();
			...
			// m_gbMoeda
			// 
			this.m_gbMoeda.Controls.Add(this.m_btShowDialogSemDB);
			...
			this.m_gbMoeda.Text = "TEC";
			// 
			// m_btShowDialog
			// 
			this.m_btShowDialog.Location = new System.Drawing.Point(24, 20);
			this.m_btShowDialog.Name = "m_btShowDialog";
			this.m_btShowDialog.Size = new System.Drawing.Size(96, 32);
			this.m_btShowDialog.TabIndex = 2;
			this.m_btShowDialog.Text = "ShowDialog";
			...
			// m_btShowDialogSemDB
			// 
			this.m_btShowDialogSemDB.Location = new System.Drawing.Point(128, 20);
			this.m_btShowDialogSemDB.Name = "m_btShowDialogSemDB";
			this.m_btShowDialogSemDB.Size = new System.Drawing.Size(96, 32);
			this.m_btShowDialogSemDB.TabIndex = 3;
			this.m_btShowDialogSemDB.Text = "ShowDialog sem DB";
			this.m_btShowDialogSemDB.Click += new System.EventHandler(this.m_btShowDialogSemDB_Click);
			// 
			// Form1
			// 
...
//				m_cls_dba_ConnectionBD = new mdlDataBaseAccess.clsDataBaseAccessMySql(ref m_cls_tre_tratadorErro,m_txtHost.Text,m_txtUser.Text,m_txtPassword.Text,m_txtDataBaseName.Text);
		...
		{
			CreateDataBase();
			mdlTec.clsTec obj = new mdlTec.clsTec(m_cls_dba_ConnectionBD,m_txtPath.Text);
			obj.Exportador = Int32.Parse(m_txtIdExportador.Text); 
			obj.ShowDialog();
		}

		private void m_btShowDialogSemDB_Click(object sender, System.EventArgs e)
		{
			mdlTec.clsTec obj = new mdlTec.clsTec(null,m_txtPath.Text);
			obj.ShowDialog();
		}
		#endregion
