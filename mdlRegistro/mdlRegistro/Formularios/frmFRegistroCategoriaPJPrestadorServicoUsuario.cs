...
{
	/// <summary>
	/// Summary description for frmFRegistroCategoriaPJPrestadorServicoUsuario.
	/// </summary>
	internal class frmFRegistroCategoriaPJPrestadorServicoUsuario : System.Windows.Forms.Form
	{
		#region Delegates
		...
		#region Constructors and Destructors
			public frmFRegistroCategoriaPJPrestadorServicoUsuario(ref mdlTratamentoErro.clsTratamentoErro cls_ter_TratadorErro,string strEnderecoExecutavel)
			{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmFRegistroCategoriaPJPrestadorServicoUsuario));
			...
			this.m_gbGeral.Size = new System.Drawing.Size(429, 360);
			...
			this.m_lbInfoCamposObrigatorios.Location = new System.Drawing.Point(84, 312);
			...
			this.m_gbMeioComunicação.Location = new System.Drawing.Point(9, 246);
			...
			// m_txtFaxDDD
			// 
			this.m_txtFaxDDD.Location = new System.Drawing.Point(240, 40);
			...
			this.m_lbFaxParEsquerdo.Location = new System.Drawing.Point(232, 40);
			...
			this.m_lbFaxParDireito.Location = new System.Drawing.Point(264, 40);
			...
			// m_txtFax
			// 
			this.m_txtFax.Location = new System.Drawing.Point(280, 38);
			...
			this.m_lbRamal.Location = new System.Drawing.Point(13, 39);
			...
			this.m_lbEmail.Location = new System.Drawing.Point(195, 20);
			...
			this.m_gbIdentificacao.Controls.Add(this.label1);
			...
			this.m_btVoltar.Location = new System.Drawing.Point(121, 328);
			...
			this.m_btContinuar.Location = new System.Drawing.Point(249, 328);
			...
			this.m_btCancelar.Location = new System.Drawing.Point(185, 328);
			...
			// 
			// frmFRegistroCategoriaPJPrestadorServicoUsuario
			// 
			...
			this.Name = "frmFRegistroCategoriaPJPrestadorServicoUsuario";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Identificação Usuário";
			this.Load += new System.EventHandler(this.frmFRegistroCategoriaPJPrestadorServicoUsuario_Load);
		...
		#region Eventos
			#region Formulario
				private void frmFRegistroCategoriaPJPrestadorServicoUsuario_Load(object sender, System.EventArgs e)
				{
					MostraCor();
					OnCallCarregaDados();
					OnCallRefreshSexo();
