...
{
	/// <summary>
	/// Summary description for frmFRegistroCategoriaPFPrestadorServico.
	/// </summary>
	internal class frmFRegistroCategoriaPFPrestadorServico : System.Windows.Forms.Form
	{
		#region Delegates
			...
			public delegate void delCallRefreshServicos(ref mdlComponentesGraficos.ComboBox cbServicos);
			public delegate void delCallCarregaDados(out string strNome ,out string strCPF ,out bool bSexoMasculino ,out System.DateTime dtDataNascimento ,out string strLogradouro ,out string strComplemento ,out string strBairro ,out string strCidade ,out int nEstado ,out string strCEP ,out string strTelefone,out string strTelefoneDDD ,out string strFax,out string strFaxDDD ,out string strEmail ,out string strSite ,out string strServicos,out int nQuantidadeClientesExportadores,out bool bRealizaImportacao);
			public delegate void delCallSalvaDados(string strNome ,string strCPF ,bool bSexoMasculino ,System.DateTime dtDataNascimento ,string strLogradouro ,string strComplemento ,string strBairro ,string strCidade ,int nEstado ,string strCEP ,string strTelefone,string strTelefoneDDD ,string strFax,string strFaxDDD,string strEmail ,string strSite ,string strServicos,int nQuantidadeClientesExportadores,bool bRealizaImportacao);
		#endregion
		#region Events 
			public event delCallRefreshSexo eCallRefreshSexo;
			public event delCallRefreshEstado eCallRefreshEstado;
			public event delCallRefreshServicos eCallRefreshServicos;
		...
		#region Events Methods
			...
			protected virtual void OnCallRefreshServicos()
			{
				if (eCallRefreshServicos != null)
				{
					eCallRefreshServicos(ref m_cbServicos);
				}
			}
			...
			protected virtual void OnCallCarregaDados()
			{
				...
				{
					eCallCarregaDados(out m_strNome ,out m_strCPF ,out m_bSexoMasculino ,out m_dtDataNascimento ,out m_strLogradouro ,out m_strComplemento ,out m_strBairro ,out m_strCidade ,out m_nEstado ,out m_strCEP ,out m_strTelefone,out m_strTelefoneDDD ,out m_strFax,out m_strFaxDDD,out m_strEmail ,out m_strSite ,out m_strServicos ,out m_nQuantidadeClientesExportadores, out m_bRealizaImportacao);
				}
			}
			...
			protected virtual void OnCallSalvaDados()
			{
				...
				{
					eCallSalvaDados(m_strNome ,m_strCPF ,m_bSexoMasculino ,m_dtDataNascimento ,m_strLogradouro ,m_strComplemento ,m_strBairro ,m_strCidade ,m_nEstado ,m_strCEP ,m_strTelefone,m_strTelefoneDDD ,m_strFax,m_strFaxDDD,m_strEmail ,m_strSite ,m_strServicos ,m_nQuantidadeClientesExportadores,m_bRealizaImportacao);
				}
			}
		#endregion
		#region Atributes
			...
			private string m_strServicos = "";
			private int m_nQuantidadeClientesExportadores = 0;
			...
			public System.Windows.Forms.Label m_lbQuantidadeClientesExportadores;
			private mdlComponentesGraficos.TextBox m_txtQuantidadeClientesExportadores;
			...
			private mdlComponentesGraficos.ComboBox m_cbServicos;
			public System.Windows.Forms.Label m_lbServicos;
		...
		#region Constructors and Destructors 
			public frmFRegistroCategoriaPFPrestadorServico(ref mdlTratamentoErro.clsTratamentoErro cls_ter_TratadorErro,string strEnderecoExecutavel)
			{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmFRegistroCategoriaPFPrestadorServico));
			this.m_gbGeral = new System.Windows.Forms.GroupBox();
			this.m_gbEspecificos = new System.Windows.Forms.GroupBox();
			this.m_lbQuantidadeClientesExportadores = new System.Windows.Forms.Label();
			this.m_ckImportacao = new System.Windows.Forms.CheckBox();
			this.m_cbServicos = new mdlComponentesGraficos.ComboBox();
			this.m_txtQuantidadeClientesExportadores = new mdlComponentesGraficos.TextBox();
			this.m_lbServicos = new System.Windows.Forms.Label();
			...
			this.m_gbGeral.Location = new System.Drawing.Point(6, 4);
			this.m_gbGeral.Name = "m_gbGeral";
			this.m_gbGeral.Size = new System.Drawing.Size(430, 396);
			this.m_gbGeral.TabIndex = 0;
			this.m_gbGeral.TabStop = false;
			// 
			// m_gbEspecificos
			// 
			this.m_gbEspecificos.Controls.Add(this.m_lbQuantidadeClientesExportadores);
			this.m_gbEspecificos.Controls.Add(this.m_ckImportacao);
			this.m_gbEspecificos.Controls.Add(this.m_cbServicos);
			this.m_gbEspecificos.Controls.Add(this.m_txtQuantidadeClientesExportadores);
			this.m_gbEspecificos.Controls.Add(this.m_lbServicos);
			...
			this.m_gbEspecificos.Size = new System.Drawing.Size(409, 64);
			this.m_gbEspecificos.TabIndex = 3;
			this.m_gbEspecificos.TabStop = false;
			this.m_gbEspecificos.Text = "Negócio";
			// 
			// m_lbQuantidadeClientesExportadores
			// 
			this.m_lbQuantidadeClientesExportadores.BackColor = System.Drawing.SystemColors.Control;
			this.m_lbQuantidadeClientesExportadores.Cursor = System.Windows.Forms.Cursors.Default;
			this.m_lbQuantidadeClientesExportadores.Font = new System.Drawing.Font("Arial", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.m_lbQuantidadeClientesExportadores.ForeColor = System.Drawing.Color.Black;
			this.m_lbQuantidadeClientesExportadores.Location = new System.Drawing.Point(6, 38);
			this.m_lbQuantidadeClientesExportadores.Name = "m_lbQuantidadeClientesExportadores";
			this.m_lbQuantidadeClientesExportadores.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.m_lbQuantidadeClientesExportadores.Size = new System.Drawing.Size(157, 16);
			this.m_lbQuantidadeClientesExportadores.TabIndex = 50;
			this.m_lbQuantidadeClientesExportadores.Text = "Qtde clientes exportadores:";
			// 
			// m_ckImportacao
			// 
			this.m_ckImportacao.Location = new System.Drawing.Point(237, 40);
			this.m_ckImportacao.Name = "m_ckImportacao";
			this.m_ckImportacao.Size = new System.Drawing.Size(168, 16);
			this.m_ckImportacao.TabIndex = 22;
			this.m_ckImportacao.Text = "Realizamos importações.";
			// 
			// m_cbServicos
			// 
			this.m_cbServicos.Location = new System.Drawing.Point(96, 12);
			this.m_cbServicos.Name = "m_cbServicos";
			this.m_cbServicos.Size = new System.Drawing.Size(304, 22);
			this.m_cbServicos.TabIndex = 0;
			// 
			// m_txtQuantidadeClientesExportadores
			// 
			this.m_txtQuantidadeClientesExportadores.Location = new System.Drawing.Point(166, 36);
			this.m_txtQuantidadeClientesExportadores.Name = "m_txtQuantidadeClientesExportadores";
			this.m_txtQuantidadeClientesExportadores.Size = new System.Drawing.Size(31, 20);
			this.m_txtQuantidadeClientesExportadores.TabIndex = 21;
			this.m_txtQuantidadeClientesExportadores.Text = "";
			// 
			// m_lbServicos
			// 
			this.m_lbServicos.BackColor = System.Drawing.SystemColors.Control;
			this.m_lbServicos.Cursor = System.Windows.Forms.Cursors.Default;
			this.m_lbServicos.Font = new System.Drawing.Font("Arial", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.m_lbServicos.ForeColor = System.Drawing.Color.FromArgb(((System.Byte)(192)), ((System.Byte)(0)), ((System.Byte)(0)));
			this.m_lbServicos.Location = new System.Drawing.Point(6, 18);
			this.m_lbServicos.Name = "m_lbServicos";
			this.m_lbServicos.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.m_lbServicos.Size = new System.Drawing.Size(61, 16);
			this.m_lbServicos.TabIndex = 35;
			this.m_lbServicos.Text = "Serviços:";
			// 
			// m_gbMeioComunicação
			// 
			...
			this.m_gbMeioComunicação.Size = new System.Drawing.Size(409, 95);
			...
			// m_txtFaxDDD
			// 
			this.m_txtFaxDDD.Location = new System.Drawing.Point(277, 15);
			...
			this.m_lbFaxParEsquerdo.Location = new System.Drawing.Point(269, 15);
			...
			this.m_lbFaxParDireito.Location = new System.Drawing.Point(301, 15);
			...
			// m_txtSite
			// 
			this.m_txtSite.Location = new System.Drawing.Point(104, 64);
			...
			this.m_lbFax.Location = new System.Drawing.Point(219, 19);
			...
			// m_cbSexo
			// 
			this.m_cbSexo.Location = new System.Drawing.Point(192, 36);
			...
			this.m_lbSexo.Location = new System.Drawing.Point(154, 41);
			...
			// m_txtNome
			// 
			this.m_txtNome.Location = new System.Drawing.Point(65, 14);
			...
			// m_txtCPF
			// 
			this.m_txtCPF.Location = new System.Drawing.Point(64, 37);
			...
			this.m_lbDataNascimento.Location = new System.Drawing.Point(245, 41);
			...
			this.m_lbInfoCamposObrigatorios.Location = new System.Drawing.Point(90, 339);
			...
			this.m_btVoltar.Location = new System.Drawing.Point(128, 363);
			...
			this.m_btContinuar.Location = new System.Drawing.Point(256, 363);
			...
			this.m_btCancelar.Location = new System.Drawing.Point(192, 363);
			...
			// 
			// frmFRegistroCategoriaPFPrestadorServico
			// 
			...
			this.Name = "frmFRegistroCategoriaPFPrestadorServico";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Pessoa Física: Prestador Serviço";
			this.Load += new System.EventHandler(this.frmFRegistroCategoriaPFPrestadorServico_Load);
		...
		#region Carregamento dos Dados Interface
			private void vCarregaDadosInterface()
			{
				...
				m_cbServicos.Text = m_strServicos;
				m_txtQuantidadeClientesExportadores.Text = m_nQuantidadeClientesExportadores.ToString();
		...
		#region Salvamento dos Dados da Interface
			private bool bSalvaDadosInterface()
			{
				...
				// Servicos
				if (m_cbServicos.Text.Trim() == "")
				{
					mdlMensagens.clsMensagens.ShowInformation(mdlMensagens.clsRepositorioMensagens.GetMensagem(mdlMensagens.Mensagem.mdlRegistro_frmFRegistroCategoriaPFPrestadorServico_InformarServico));
					return(false);
				}
				m_strServicos = m_cbServicos.Text.Trim();
	
				// Quantidade Clientes Exportadores
				try
				{
					m_nQuantidadeClientesExportadores = Int32.Parse(m_txtQuantidadeClientesExportadores.Text);
				}
				catch
				{
					m_nQuantidadeClientesExportadores = 0;
				}
		...
		#region Eventos
			#region Formulario
				private void frmFRegistroCategoriaPFPrestadorServico_Load(object sender, System.EventArgs e)
				{
					MostraCor();
					OnCallCarregaDados();
					OnCallRefreshSexo();
