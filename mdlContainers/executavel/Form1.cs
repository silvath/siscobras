...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			// m_btNegocio
			// 
			this.m_btNegocio.Location = new System.Drawing.Point(9, 19);
			this.m_btNegocio.Name = "m_btNegocio";
			this.m_btNegocio.Size = new System.Drawing.Size(96, 32);
			this.m_btNegocio.TabIndex = 2;
			this.m_btNegocio.Text = "Containers";
		...
		{
			CreateDataBase();
			mdlContainers.clsContainers obj = new mdlContainers.clsContainers(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text);
			obj.ShowDialog();
		}
		#endregion
	}
