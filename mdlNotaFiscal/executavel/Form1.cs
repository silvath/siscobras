...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Button m_btAgentes;
		...
		private void InitializeComponent()
		{
			...
			// m_btAgentes
			// 
			this.m_btAgentes.Cursor = System.Windows.Forms.Cursors.Hand;
			this.m_btAgentes.Location = new System.Drawing.Point(252, 20);
			this.m_btAgentes.Name = "m_btAgentes";
			this.m_btAgentes.Size = new System.Drawing.Size(96, 32);
			this.m_btAgentes.TabIndex = 2;
			this.m_btAgentes.Text = "Notas Fiscais";
		...
		#region Eventos
		private void m_btAgentes_Click(object sender, System.EventArgs e)
		{
			try
			{
				string strNumero, strEmissao, strValor;
				CreateDataBase();

				mdlNotaFiscal.clsNotaFiscal obj = new mdlNotaFiscal.clsNotaFiscal(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text, Int32.Parse(m_txtIdExportador.Text), m_txtIdCodigo.Text);
				obj.retornaValores(out strNumero, out strEmissao, out strValor);
				this.m_txtRetorno.Text = "Números: " + strNumero + " - Emissões: " + strEmissao + " - Total: " + strValor;
				obj.ShowDialog();
				obj.retornaValores(out strNumero, out strEmissao, out strValor);
				this.m_txtRetorno.Text = "Números: " + strNumero + " - Emissões: " + strEmissao + " - Total: " + strValor;
			}
