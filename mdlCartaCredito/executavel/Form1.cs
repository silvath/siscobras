...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Button m_btPES;
		...
		private void InitializeComponent()
		{
			...
			this.m_btPES = new System.Windows.Forms.Button();
			...
			// m_gbMoeda
			// 
			this.m_gbMoeda.Controls.Add(this.m_btGeral);
			this.m_gbMoeda.Controls.Add(this.m_btPES);
			...
			this.m_gbMoeda.Text = "PE";
			// 
			// m_btGeral
			// 
			this.m_btGeral.Location = new System.Drawing.Point(306, 18);
			this.m_btGeral.Name = "m_btGeral";
			this.m_btGeral.Size = new System.Drawing.Size(96, 32);
			this.m_btGeral.TabIndex = 4;
			this.m_btGeral.Text = "Geral";
			this.m_btGeral.Click += new System.EventHandler(this.m_btGeral_Click);
			// 
			// m_btPES
			// 
			this.m_btPES.Location = new System.Drawing.Point(198, 18);
			this.m_btPES.Name = "m_btPES";
			this.m_btPES.Size = new System.Drawing.Size(96, 32);
			this.m_btPES.TabIndex = 3;
			this.m_btPES.Text = "Carta de Crédito";
			this.m_btPES.Click += new System.EventHandler(this.button1_Click);
			// 
			// m_gbBD
			// 
			...
			this.m_rbSqlServer.Location = new System.Drawing.Point(23, 49);
			this.m_rbSqlServer.Name = "m_rbSqlServer";
			this.m_rbSqlServer.Size = new System.Drawing.Size(81, 16);
			...
			this.m_txtPortSqlServer.Size = new System.Drawing.Size(63, 20);
			this.m_txtPortSqlServer.TabIndex = 10;
			this.m_txtPortSqlServer.Text = "1433";
			// 
			// m_lbPortSqlServer
			// 
			this.m_lbPortSqlServer.Location = new System.Drawing.Point(101, 50);
		...
		private void button1_Click(object sender, System.EventArgs e)
		{
			try
			{
				bool bEmendas, bDiscrepancias;
				int nIdMoeda;
				string strNumero;
				double dValor;
				System.DateTime dtEmissao;
				CreateDataBase();
				mdlCartaCredito.clsCartaCredito obj = new mdlCartaCredito.PE.clsCartaCreditoPE(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, this.m_txtPath.Text, Int32.Parse(this.m_txtIdExportador.Text), Int32.Parse(this.m_txtIdImportador.Text),this.m_txtIdCodigo.Text);
				obj.retornaValores(out strNumero, out dtEmissao, out dValor, out bEmendas, out bDiscrepancias);
				nIdMoeda = obj.MOEDA;
				System.Windows.Forms.MessageBox.Show(nIdMoeda.ToString(), "testnado IDMOEDA", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Information);
				obj.ShowDialog();
				obj.retornaValores(out strNumero, out dtEmissao, out dValor, out bEmendas, out bDiscrepancias);
				nIdMoeda = obj.MOEDA;
				System.Windows.Forms.MessageBox.Show(nIdMoeda.ToString(), "testnado IDMOEDA", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Information);
		...
		private void m_btGeral_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				CreateDataBase();
				mdlCartaCredito.clsCartaCredito obj = new mdlCartaCredito.clsCartaCreditoGeral(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, this.m_txtPath.Text, Int32.Parse(this.m_txtIdExportador.Text), Int32.Parse(this.m_txtIdImportador.Text));
