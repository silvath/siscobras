...
{
	/// <summary>
	/// Summary description for clsGuiaEntradaSenha.
	/// </summary>
	public class clsGuiaEntradaSenha : clsObservacoes
	{
		#region Atributes
		...
		#region Constructors and Destructors
			public clsGuiaEntradaSenha(ref mdlTratamentoErro.clsTratamentoErro tratadorErro, ref mdlDataBaseAccess.clsDataBaseAccess ConnectionDB,string EnderecoExecutavel,int nIdExportador, string strIdPE): base(ref tratadorErro, ref ConnectionDB,EnderecoExecutavel,nIdExportador)
			{
			...
			protected override void carregaDadosBDEspecifico()
			{
				try
				{
					if (m_typDatSetGuiasEntradas.tbGuiasEntrada.Rows.Count > 0)
					{
						...
						if (!dtrwGuiasEntrada.IsmstrSenhaNull())
							m_strObservacoes = dtrwGuiasEntrada.mstrSenha;
					}
				} 
				catch (Exception err)
				{
		...
		protected override void salvaDadosBDEspecifico()
		{
			if (m_typDatSetGuiasEntradas.tbGuiasEntrada.Rows.Count > 0)
			{
				...
				dtrwGuiaEntrada.mstrSenha = m_strObservacoes;  
