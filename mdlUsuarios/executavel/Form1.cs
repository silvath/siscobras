...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Button m_btLogin;
		private System.Windows.Forms.Button m_btCadastro;
		...
		private void InitializeComponent()
		{
			...
			this.m_btLogin = new System.Windows.Forms.Button();
			...
			this.m_btCadastro = new System.Windows.Forms.Button();
			...
			this.m_gbMoeda.Text = "Login";
			// 
			// groupBox1
			// 
			this.groupBox1.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
				| System.Windows.Forms.AnchorStyles.Right)));
			this.groupBox1.Controls.Add(this.m_btCadastro);
			this.groupBox1.Controls.Add(this.m_btLogin);
			...
			// m_btLogin
			// 
			this.m_btLogin.Location = new System.Drawing.Point(192, 16);
			this.m_btLogin.Name = "m_btLogin";
			this.m_btLogin.Size = new System.Drawing.Size(96, 32);
			this.m_btLogin.TabIndex = 6;
			this.m_btLogin.Text = "Siscobras";
			this.m_btLogin.Click += new System.EventHandler(this.m_btLogin_Click);
			// 
			// m_gbBD
			// 
			...
			// m_btCadastro
			// 
			this.m_btCadastro.Location = new System.Drawing.Point(296, 16);
			this.m_btCadastro.Name = "m_btCadastro";
			this.m_btCadastro.Size = new System.Drawing.Size(96, 32);
			this.m_btCadastro.TabIndex = 7;
			this.m_btCadastro.Text = "Cadastro";
			this.m_btCadastro.Click += new System.EventHandler(this.m_btCadastro_Click);
			// 
			// Form1
			// 
...
//				m_cls_dba_ConnectionBD = new mdlDataBaseAccess.clsDataBaseAccessMySql(ref m_cls_tre_tratadorErro,m_txtHost.Text,m_txtUser.Text,m_txtPassword.Text,m_txtDataBaseName.Text);
		...
		#region Eventos
		private void m_btLogin_Click(object sender, System.EventArgs e)
		{
			int nIdUsuario;
			string strNomeUsuario;
			CreateDataBase();
			mdlUsuarios.clsUsuario clsUsuario = mdlUsuarios.clsUsuario.New(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text);
			clsUsuario.ShowDialogLogin();
			if (clsUsuario.m_bModificadoLogin)
			{
				clsUsuario.retornaValoresLogin(out nIdUsuario, out strNomeUsuario);
				m_txtRetorno.Text = "idUsuario == " + nIdUsuario.ToString() + " strNomeUsuário == " + strNomeUsuario;
				mdlUsuarios.clsUsuarioConcessoesPermissoes obj = mdlUsuarios.clsUsuarioConcessoesPermissoes.Instance;
				obj.ShowDialogPermissoes();
				if (obj.bPesquisaConcessoes(mdlUsuarios.PERMISSOES.MODIFICAR, mdlUsuarios.CONCESSOES.BIBLIOTECA, 5, "069"))
                    MessageBox.Show("Usuario: " + strNomeUsuario + "\nPossui permissão de modificar o PE 069 do exportador " + "5.", this.Text);
			}
		}
		private void m_btCadastro_Click(object sender, System.EventArgs e)
		{
			CreateDataBase();
			mdlUsuarios.clsUsuario clsUsuario = mdlUsuarios.clsUsuario.New(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text);
			clsUsuario.ShowDialogCadastro();
		}
		#endregion
	}
}
