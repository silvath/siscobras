...
namespace mdlUsuarios.Frames
{
	...
	internal class frmFCadastroUsuario : mdlComponentesGraficos.FormFlutuante
	{
			...
			try
			{
				...
				if (m_tbSenha.Text == m_tbRedigitacaoSenha.Text)
				{
					...
					else
					{
						...
						//MessageBox.Show("Usuário com o nome: " + m_tbUsuario.Text + " já existe.",this.Text,System.Windows.Forms.MessageBoxButtons.OK,System.Windows.Forms.MessageBoxIcon.Error);
					}
				}
				else
				{
		...
		#endregion
		#region Redigitação Senha Leave
		...
		#endregion
		#region KeyPress TextBox Redigitação Senha
