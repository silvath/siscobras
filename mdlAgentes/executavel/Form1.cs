...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Button m_btAgentesCarga;
		private System.Windows.Forms.Button m_btAgentesCargaPE;
		private System.Windows.Forms.Button m_btComissao;
		...
		private void InitializeComponent()
		{
			...
			this.m_btAgentesCargaPE = new System.Windows.Forms.Button();
			this.m_btAgentesCarga = new System.Windows.Forms.Button();
			...
			this.m_btComissao = new System.Windows.Forms.Button();
			...
			// m_gbMoeda
			// 
			this.m_gbMoeda.Controls.Add(this.m_btComissao);
			this.m_gbMoeda.Controls.Add(this.m_btAgentesCargaPE);
			this.m_gbMoeda.Controls.Add(this.m_btAgentesCarga);
			this.m_gbMoeda.Controls.Add(this.m_btBancos);
			...
			// m_btAgentesCargaPE
			// 
			this.m_btAgentesCargaPE.Location = new System.Drawing.Point(103, 20);
			this.m_btAgentesCargaPE.Name = "m_btAgentesCargaPE";
			this.m_btAgentesCargaPE.Size = new System.Drawing.Size(96, 32);
			this.m_btAgentesCargaPE.TabIndex = 7;
			this.m_btAgentesCargaPE.Text = "AgentesCarga(PE)";
			this.m_btAgentesCargaPE.Click += new System.EventHandler(this.m_btAgentesCargaPE_Click);
			// 
			// m_btAgentesCarga
			// 
			this.m_btAgentesCarga.Location = new System.Drawing.Point(6, 20);
			this.m_btAgentesCarga.Name = "m_btAgentesCarga";
			this.m_btAgentesCarga.Size = new System.Drawing.Size(96, 32);
			this.m_btAgentesCarga.TabIndex = 6;
			this.m_btAgentesCarga.Text = "AgentesCarga";
			this.m_btAgentesCarga.Click += new System.EventHandler(this.m_btAgentesCarga_Click);
			// 
			// m_btBancos
			// 
			this.m_btBancos.Location = new System.Drawing.Point(396, 20);
			this.m_btBancos.Name = "m_btBancos";
			this.m_btBancos.Size = new System.Drawing.Size(96, 32);
			this.m_btBancos.TabIndex = 5;
			this.m_btBancos.Text = "Bancos";
			this.m_btBancos.Click += new System.EventHandler(this.m_btBancos_Click);
			// 
			// button2
			// 
			this.button2.Location = new System.Drawing.Point(199, 20);
			...
			// m_btComissao
			// 
			this.m_btComissao.Location = new System.Drawing.Point(496, 20);
			this.m_btComissao.Name = "m_btComissao";
			this.m_btComissao.Size = new System.Drawing.Size(96, 32);
			this.m_btComissao.TabIndex = 8;
			this.m_btComissao.Text = "Comissao";
			this.m_btComissao.Click += new System.EventHandler(this.m_btComissao_Click);
			// 
			// Form1
			// 
...
//				m_cls_dba_ConnectionBD = new mdlDataBaseAccess.clsDataBaseAccessMySql(ref m_cls_tre_tratadorErro,m_txtHost.Text,m_txtUser.Text,m_txtPassword.Text,m_txtDataBaseName.Text);
		...
		#region Eventos
			...
			{
				//int nIdAgente, nIdContato;
				string strNomeAgente, strEnderecoContato, strCidadeContato, strPaisContato, strEmailContato, strSiteContato;
				CreateDataBase();
				mdlAgentes.clsAgentesVenda obj = new mdlAgentes.clsAgentesVenda(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, this.m_txtPath.Text, Int32.Parse(this.m_txtIdExportador.Text),this.m_txtIdCodigo.Text);
				obj.retornaValoresBancoAgenteVenda(out strNomeAgente, out strEnderecoContato, out strCidadeContato, out strPaisContato, out strEmailContato/*, out strSiteContato*/);
				obj.ShowDialog();
				obj.retornaValoresAgente(out strNomeAgente, out strEnderecoContato, out strCidadeContato, out strPaisContato, out strEmailContato, out strSiteContato);
			}
			private void button2_Click(object sender, System.EventArgs e)
			{
				double dValorComissao;
				string strFormaPagamento, strSimboloMoeda;
				CreateDataBase();
				mdlAgentes.clsAgentesVenda obj = new mdlAgentes.clsAgentesVenda(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, this.m_txtPath.Text, Int32.Parse(this.m_txtIdExportador.Text),this.m_txtIdCodigo.Text);
				obj.retornaValoresComissao(out dValorComissao, out strSimboloMoeda, out strFormaPagamento);
				obj.ShowDialogComissao();
				obj.retornaValoresComissao(out dValorComissao, out strSimboloMoeda, out strFormaPagamento);
			}
			private void m_btBancos_Click(object sender, System.EventArgs e)
			{
				string strNome, strEndereco, strCidade, strPais, strInstrucoes;
				CreateDataBase();
				mdlAgentes.clsAgentesVenda obj = new mdlAgentes.clsAgentesVenda(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, this.m_txtPath.Text, Int32.Parse(this.m_txtIdExportador.Text),this.m_txtIdCodigo.Text);
				obj.retornaValoresBancoAgenteVenda(out strNome, out strEndereco, out strCidade, out strPais, out strInstrucoes);
				obj.ShowDialogListagemBancos();
				obj.retornaValoresBancoAgenteVenda(out strNome, out strEndereco, out strCidade, out strPais, out strInstrucoes);
			}

			private void m_btComissao_Click(object sender, System.EventArgs e)
			{
				CreateDataBase();
				mdlAgentes.clsAgenteVendaComissao obj =new mdlAgentes.clsAgenteVendaComissao(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,this.m_txtPath.Text);
				m_txtRetorno.Text = obj.GetComissaoContaGrafica(Int32.Parse(this.m_txtIdExportador.Text),this.m_txtIdCodigo.Text).ToString();
			}
		#endregion
