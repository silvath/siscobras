...
{
	/// <summary>
	/// Summary description for frmFCadastroContatos.
	/// </summary>
	internal class frmFCadastroContatos : mdlComponentesGraficos.FormFlutuante
	{
		#region Atributos
		...
		private System.Windows.Forms.ToolTip m_ttCadastroContatos;
		private System.ComponentModel.IContainer components;
		#endregion

		#region Construtores & Destrutores
		public frmFCadastroContatos(ref mdlTratamentoErro.clsTratamentoErro tratadorErro, string EnderecoExecutavel, bool bCadastroNovo)
		{
			InitializeComponent();
		...
		#region Delegate
		public delegate void delCallCarregaDadosInterface(ref mdlComponentesGraficos.TextBox tbContato, ref mdlComponentesGraficos.TextBox tbEmail, ref mdlComponentesGraficos.TextBox tbTelefone, ref mdlComponentesGraficos.TextBox tbFax);
		public delegate void delCallSalvaDadosInterface(ref mdlComponentesGraficos.TextBox tbContato, ref mdlComponentesGraficos.TextBox tbEmail, ref mdlComponentesGraficos.TextBox tbTelefone, ref mdlComponentesGraficos.TextBox tbFax);
		...
		protected virtual void OnCallCarregaDadosInterface()
		{
			if (eCallCarregaDadosInterface != null)
				eCallCarregaDadosInterface(ref m_tbContato, ref m_tbEmail, ref m_tbTelefone, ref m_tbFax);
		}
		protected virtual void OnCallSalvaDadosInterface()
		{
			if (eCallSalvaDadosInterface != null)
				eCallSalvaDadosInterface(ref m_tbContato, ref m_tbEmail, ref m_tbTelefone, ref m_tbFax);
		}
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmFCadastroContatos));
			...
			this.m_ttCadastroContatos = new System.Windows.Forms.ToolTip(this.components);
			...
			this.m_gbFrame.Size = new System.Drawing.Size(198, 163);
			...
			this.m_btOk.Location = new System.Drawing.Point(39, 132);
			this.m_btOk.Name = "m_btOk";
			this.m_btOk.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.m_btOk.Size = new System.Drawing.Size(57, 25);
			this.m_btOk.TabIndex = 3;
			this.m_ttCadastroContatos.SetToolTip(this.m_btOk, "Confirmar");
			...
			this.m_btCancelar.Location = new System.Drawing.Point(103, 132);
			this.m_btCancelar.Name = "m_btCancelar";
			this.m_btCancelar.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.m_btCancelar.Size = new System.Drawing.Size(57, 25);
			this.m_btCancelar.TabIndex = 4;
			this.m_ttCadastroContatos.SetToolTip(this.m_btCancelar, "Cancelar");
			...
			this.m_gbFields.Size = new System.Drawing.Size(182, 119);
			...
			this.m_lFax.Location = new System.Drawing.Point(8, 93);
			...
			this.m_tbFax.Location = new System.Drawing.Point(55, 91);
			...
			this.m_tbTelefone.Location = new System.Drawing.Point(55, 67);
			...
			this.m_lEmail.Location = new System.Drawing.Point(8, 45);
			...
			this.m_tbEmail.Location = new System.Drawing.Point(55, 43);
			...
			this.m_lContato.Location = new System.Drawing.Point(8, 21);
			...
			this.m_tbContato.Location = new System.Drawing.Point(55, 19);
			...
			this.m_lTelefone.Location = new System.Drawing.Point(8, 69);
			...
			// 
			// m_ttCadastroContatos
			// 
			this.m_ttCadastroContatos.AutomaticDelay = 100;
			this.m_ttCadastroContatos.AutoPopDelay = 5000;
			this.m_ttCadastroContatos.InitialDelay = 100;
			this.m_ttCadastroContatos.ReshowDelay = 20;
			// 
			// frmFCadastroContatos
			// 
			...
			this.Name = "frmFCadastroContatos";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "Agente / Contatos";
			this.Load += new System.EventHandler(this.frmFCadastroContatos_Load);
		...
		#region Eventos
		#region Load
		private void frmFCadastroContatos_Load(object sender, System.EventArgs e)
		{
			mostraCor();
			if (m_bCadastroNovo == false)
			{
				OnCallCarregaDadosInterface();
				this.Text = "Edição Contato";
			}
			else
			{
