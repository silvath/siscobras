...
{
	/// <summary>
	/// Summary description for frmFAgentesCargaEdicao.
	/// </summary>
	public class frmFAgentesCargaEdicao : System.Windows.Forms.Form
	{
		#region Delegates
			public delegate void delCallCarregaDadosEstadosBrasileiros(ref mdlComponentesGraficos.ComboBox cbEstadosBrasileiros);
			public delegate void delCallCarregaDados(int nIdAgenteCarga,out string strNome,out string strEndereco,out string strCEP,out string strBairro,out string strCidade,out int nIdEstado,out string strTelefone,out string strFax,out string strEmail,out string strSite);
			public delegate bool delCallSalvaDados(int nIdAgenteCarga,string strNome,string strEndereco,string strCEP,string strBairro,string strCidade,int nIdEstado,string strTelefone,string strFax,string strEmail,string strSite);
		#endregion
		#region Events
		...
		#region Events Methods
			...
			protected virtual void OnCallCarregaDados()
			{
				if (eCallCarregaDados != null)
				{
					...
					int nIdEstado;
				    eCallCarregaDados(m_nIdAgenteCarga,out strNome,out strEndereco,out strCEP,out strBairro,out strCidade,out nIdEstado,out strTelefone,out strFax,out strEmail,out strSite);
			...
			protected virtual bool OnCallSalvaDados()
			{
				...
				if (eCallSalvaDados != null)
				{
					...
					bRetorno = eCallSalvaDados(m_nIdAgenteCarga,m_txtNome.Text,m_txtEndereco.Text,m_txtCep.Text,m_txtBairro.Text,m_txtCidade.Text,nIdEstado,m_txtTelefone.Text,m_txtFax.Text,m_txtEmail.Text,m_txtSite.Text);
				}
				return(bRetorno);
			}
		#endregion
		...
		#region Atributes
			...
			private System.Windows.Forms.GroupBox m_gbAgenteCarga;
		...
		#region Constructors and Destructors
			public frmFAgentesCargaEdicao(string strEnderecoExecutavel)
			{
				m_strEnderecoExecutavel = strEnderecoExecutavel;
				InitializeComponent();
				m_gbAgenteCarga.Text = "Cadastro";
			}

			public frmFAgentesCargaEdicao(string strEnderecoExecutavel,int nIdAgenteCarga)
			{
				m_strEnderecoExecutavel = strEnderecoExecutavel;
				m_nIdAgenteCarga = nIdAgenteCarga;
				InitializeComponent();
				m_gbAgenteCarga.Text = "Edição";
			}
		...
		#region Eventos
			#region Formulario
				private void frmFAgentesCargaEdicao_Load(object sender, System.EventArgs e)
				{
