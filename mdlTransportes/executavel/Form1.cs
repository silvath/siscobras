...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Button m_btFormA;
		...
		private void InitializeComponent()
		{
			...
			this.m_btFormA = new System.Windows.Forms.Button();
			...
			// m_gbMoeda
			// 
			this.m_gbMoeda.Controls.Add(this.m_btFormA);
			...
			this.m_gbMoeda.Text = "Transportes Faturas";
			// 
			// m_btFormA
			// 
			this.m_btFormA.Location = new System.Drawing.Point(496, 20);
			this.m_btFormA.Name = "m_btFormA";
			this.m_btFormA.Size = new System.Drawing.Size(96, 32);
			this.m_btFormA.TabIndex = 4;
			this.m_btFormA.Text = "FormA";
			this.m_btFormA.Click += new System.EventHandler(this.m_btFormA_Click);
			// 
			// m_btProforma
			// 
			this.m_btProforma.Location = new System.Drawing.Point(216, 20);
			...
			// m_btComercial
			// 
			this.m_btComercial.Location = new System.Drawing.Point(117, 20);
			...
			// m_btCotacao
			// 
			this.m_btCotacao.Location = new System.Drawing.Point(15, 20);
			...
			// m_txtPortSqlServer
			// 
			this.m_txtPortSqlServer.Location = new System.Drawing.Point(136, 52);
		...
		#region Eventos
        	private void m_btCotacao_Click(object sender, System.EventArgs e)
			{
				string strNavio;
				CreateDataBase();
				mdlTransportes.clsTransporte modTransporte = new mdlTransportes.Faturas.clsTransporteFaturaCotacao(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text, Int32.Parse(m_txtIdExportador.Text), m_txtIdCodigo.Text);
				modTransporte.retornaValores(out strNavio);
				this.m_txtRetorno.Text = "Navio: " + strNavio;
				modTransporte.ShowDialog();
				modTransporte.retornaValores(out strNavio);
				this.m_txtRetorno.Text = "Navio: " + strNavio;
			}
			...
			private void m_btComercial_Click(object sender, System.EventArgs e)
			{
				string strNavio;
				CreateDataBase();
				mdlTransportes.clsTransporte modTransporte = new mdlTransportes.Faturas.clsTransporteFaturaComercial(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text, Int32.Parse(m_txtIdExportador.Text), m_txtIdCodigo.Text);
				modTransporte.retornaValores(out strNavio);
				this.m_txtRetorno.Text = "Navio: " + strNavio;
				modTransporte.ShowDialog();
				modTransporte.retornaValores(out strNavio);
			...
			private void m_btProforma_Click(object sender, System.EventArgs e)
			{
				string strNavio;
				CreateDataBase();
				mdlTransportes.clsTransporte modTransporte = new mdlTransportes.Faturas.clsTransporteFaturaProforma(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text, Int32.Parse(m_txtIdExportador.Text), m_txtIdCodigo.Text);
				modTransporte.retornaValores(out strNavio);
				this.m_txtRetorno.Text = "Navio: " + strNavio;
				modTransporte.ShowDialog();
				modTransporte.retornaValores(out strNavio);
			...
			private void m_btFormA_Click(object sender, System.EventArgs e)
			{
				CreateDataBase();
				mdlTransportes.clsFormAMeioTransporte obj = new mdlTransportes.clsFormAMeioTransporte(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text, Int32.Parse(m_txtIdExportador.Text), m_txtIdCodigo.Text);
				obj.ShowDialog();
			}
		#endregion
