...
{
	/// <summary>
	/// Summary description for frmFFormAMeioTransporte.
	/// </summary>
	public class frmFFormAMeioTransporte : System.Windows.Forms.Form
	{
		#region Atributes
		...
		#endregion 
		#region Constructors
			public frmFFormAMeioTransporte(string strEnderecoExecutavel)
			{
				InitializeComponent();
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmFFormAMeioTransporte));
			...
			this.Name = "frmFFormAMeioTransporte";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Meio de Transporte";
