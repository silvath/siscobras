...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Label m_lbIdTipoRelatorio;
		private System.Windows.Forms.TextBox m_txtnTipoRelatorio;
		...
		private void InitializeComponent()
		{
			...
			this.m_txtnTipoRelatorio = new System.Windows.Forms.TextBox();
			this.m_lbIdTipoRelatorio = new System.Windows.Forms.Label();
			...
			// m_gbParametros
			// 
			this.m_gbParametros.Controls.Add(this.m_txtnTipoRelatorio);
			this.m_gbParametros.Controls.Add(this.m_lbIdTipoRelatorio);
			...
			// m_txtnTipoRelatorio
			// 
			this.m_txtnTipoRelatorio.Location = new System.Drawing.Point(336, 24);
			this.m_txtnTipoRelatorio.Name = "m_txtnTipoRelatorio";
			this.m_txtnTipoRelatorio.Size = new System.Drawing.Size(91, 20);
			this.m_txtnTipoRelatorio.TabIndex = 9;
			this.m_txtnTipoRelatorio.Text = "3";
			this.m_txtnTipoRelatorio.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// m_lbIdTipoRelatorio
			// 
			this.m_lbIdTipoRelatorio.Location = new System.Drawing.Point(242, 27);
			this.m_lbIdTipoRelatorio.Name = "m_lbIdTipoRelatorio";
			this.m_lbIdTipoRelatorio.Size = new System.Drawing.Size(88, 16);
			this.m_lbIdTipoRelatorio.TabIndex = 8;
			this.m_lbIdTipoRelatorio.Text = "TipoRelatorio";
			// 
			// m_txtIdCodigo
			// 
			...
			this.m_btRomaneio.Text = "Manipulador Grafico";
			...
			// m_txtPortSqlServer
			// 
			this.m_txtPortSqlServer.Location = new System.Drawing.Point(130, 46);
			this.m_txtPortSqlServer.Name = "m_txtPortSqlServer";
			this.m_txtPortSqlServer.Size = new System.Drawing.Size(122, 20);
			this.m_txtPortSqlServer.TabIndex = 10;
			this.m_txtPortSqlServer.Text = "1433";
			// 
			// m_lbPortSqlServer
			// 
			this.m_lbPortSqlServer.Location = new System.Drawing.Point(100, 49);
