...
{
	/// <summary>
	/// Summary description for clsDataEmbarqueCotacao.
	/// </summary>
	public class clsDataEmbarqueCotacao : clsData
	{
		#region Atributos
		...
		#region Construtors and Destrutors
			public clsDataEmbarqueCotacao(ref mdlTratamentoErro.clsTratamentoErro tratadorErro, ref mdlDataBaseAccess.clsDataBaseAccess ConnectionDB,string EnderecoExecutavel,int nIdExportador, string idCotacao): base(ref tratadorErro, ref ConnectionDB, EnderecoExecutavel, nIdExportador)
			{
			...
			protected override void carregaDadosBDEspecificos()
			{
				try
				{
					...
					if (m_typDatSetTbFaturasCotacoes.tbFaturasCotacoes.Rows.Count > 0)
					{
						...
						if (!dtrwRowTbFaturasCotacoes.IsdataEmbarqueNull())
							m_dtData = dtrwRowTbFaturasCotacoes.dataEmbarque;
			...
			protected override void salvaDadosBDEspecifico()
			{
				try
				{
					...
					if (m_typDatSetTbFaturasCotacoes.tbFaturasCotacoes.Rows.Count > 0)
					{
						...
						dtrwRowTbFaturasCotacoes.dataEmbarque = m_dtData;
					}
