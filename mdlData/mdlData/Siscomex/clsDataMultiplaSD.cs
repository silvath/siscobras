...
{
	/// <summary>
	/// Summary description for clsDataMultiplaSD.
	/// </summary>
	public class clsDataMultiplaSD : clsDataMultipla
	{
		#region Atributos
		...
		#endregion
		#region Construtores
			public clsDataMultiplaSD(ref mdlTratamentoErro.clsTratamentoErro cls_ter_tratadorErro, ref mdlDataBaseAccess.clsDataBaseAccess cls_dba_ConnectionDB,string strEnderecoExecutavel,int nIdExportador, string strIdPE): base(ref cls_ter_tratadorErro, ref cls_dba_ConnectionDB,strEnderecoExecutavel)
			{
		...
		#region Carregamento dos Dados
			...
			private mdlDataBaseAccess.Tabelas.XsdTbSDs GetTbSDs()
			{
				...
				m_cls_dba_ConnectionBD.FonteDosDados = mdlDataBaseAccess.FonteDados.DataBase;
				return(m_cls_dba_ConnectionBD.GetTbSDs(arlCondicaoCampo,arlCondicaoComparador,arlCondicaoValor,null,null));
			}
			...
			protected override string CarregaDataMultipla()
			{
				...
				if ((dtrwPE == null) || (dtrwPE.IsmstrDataEmissaoSDNull()))
					return(CarregaDataMultiplaDefault());
				return(dtrwPE.mstrDataEmissaoSD);
			}
		...
		#region Salvamento dos Dados
			protected override bool SalvaDataMultipla(string strDataMultipla)
			{
				...
				dtrwPE.mstrDataEmissaoSD = strDataMultipla;
