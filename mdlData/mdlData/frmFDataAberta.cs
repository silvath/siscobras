...
{
	/// <summary>
	/// Summary description for frmFDataAberta.
	/// </summary>
	public class frmFDataAberta : System.Windows.Forms.Form
	{
		#region Atributes
			...
			private System.Windows.Forms.TextBox m_txtData;
		...
		#region Propriedades
			...
			public string Data
			{
				set
				{
					m_txtData.Text = value;
				}
				get
				{
					return(m_txtData.Text);
				}
			}
		#endregion
		#region Constructores e Destrutores
			public frmFDataAberta(System.Drawing.Color clrFundo)
			{
				InitializeComponent();
				vMostraCor(clrFundo);
			}
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmFDataAberta));
			...
			this.m_txtData = new System.Windows.Forms.TextBox();
			...
			// m_gbAtual
			// 
			this.m_gbAtual.Controls.Add(this.m_txtData);
			...
			this.m_gbAtual.TabIndex = 8;
			this.m_gbAtual.TabStop = false;
			this.m_gbAtual.Text = "Personalizável";
			// 
			// m_txtData
			// 
			this.m_txtData.Location = new System.Drawing.Point(6, 16);
			this.m_txtData.Multiline = true;
			this.m_txtData.Name = "m_txtData";
			this.m_txtData.ScrollBars = System.Windows.Forms.ScrollBars.Vertical;
			this.m_txtData.Size = new System.Drawing.Size(259, 72);
			this.m_txtData.TabIndex = 7;
			this.m_txtData.Text = "";
			// 
			// m_btOk
			// 
			...
			this.m_btOk.Location = new System.Drawing.Point(81, 200);
			...
			this.m_btCancelar.Location = new System.Drawing.Point(145, 200);
			...
			this.Name = "frmFDataAberta";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "Data de Vencimento";
