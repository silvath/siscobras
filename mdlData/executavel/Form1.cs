...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.button14.Text = "Data de Emissão";
			...
			this.button1.Text = "Data de Emissão";
			...
			this.button11.Text = "Data de Emissão";
			...
			this.m_btProforma.Text = "Proforma Emissão";
			...
			this.m_btComercial.Text = "Comercial Emissão";
			...
			this.m_btCotacao.Text = "Cotacao Emissão";
