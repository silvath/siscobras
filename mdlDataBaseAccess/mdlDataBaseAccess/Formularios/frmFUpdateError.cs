...
{
	/// <summary>
	/// Summary description for frmFUpdateError.
	/// </summary>
	internal class frmFUpdateError : System.Windows.Forms.Form
	{
		#region Atributes
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmFUpdateError));
			...
			this.m_gbGeral.Size = new System.Drawing.Size(220, 90);
			...
			this.m_btFechar.Location = new System.Drawing.Point(81, 60);
			...
			this.m_lbInfo.Size = new System.Drawing.Size(205, 64);
			this.m_lbInfo.TabIndex = 10;
			this.m_lbInfo.Text = "Houve falhas no salvamento de dados. É possível que o banco de dados esteja inace" +
				"ssível.";
			// 
			// frmFUpdateError
			// 
