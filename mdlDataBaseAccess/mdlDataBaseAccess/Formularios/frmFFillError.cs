...
{
	/// <summary>
	/// Summary description for frmFFillError.
	/// </summary>
	public class frmFFillError : System.Windows.Forms.Form
	{
		#region Atributes
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmFFillError));
			...
			this.m_gbGeral.Size = new System.Drawing.Size(222, 89);
			...
			this.m_btFechar.Location = new System.Drawing.Point(81, 58);
			...
			this.m_lbInfo.Location = new System.Drawing.Point(11, 12);
			this.m_lbInfo.Name = "m_lbInfo";
			this.m_lbInfo.Size = new System.Drawing.Size(208, 42);
			this.m_lbInfo.TabIndex = 10;
			this.m_lbInfo.Text = "Houve falhas no carregamento de dados. É possível que o banco de dados esteja ina" +
				"cessível.";
			// 
			// frmFFillError
			// 
