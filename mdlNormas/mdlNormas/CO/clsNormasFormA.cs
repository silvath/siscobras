...
{
	/// <summary>
	/// Summary description for clsNormasFormA.
	/// </summary>
	public class clsNormasFormA : clsNormas
	{
		#region Atributos
		private const int m_nIdTipoCOFormA = 8;

		private mdlDataBaseAccess.Tabelas.XsdTbProdutosCertificadoOrigem m_typDatSetTbProdutosCertificadoOrigem = null;
		#endregion
		#region Constructors and Destructors
		public clsNormasFormA(ref mdlTratamentoErro.clsTratamentoErro tratadorErro, ref mdlDataBaseAccess.clsDataBaseAccess conexaoBD,string EnderecoExecutavel, int nIdExportador, string strIdPE): base (ref tratadorErro, ref conexaoBD,EnderecoExecutavel, m_nIdTipoCOFormA)
		{
		...
		protected void carregaTypDatSet()
		{
			try
			{
				...
				arlCondicaoComparador.Add(mdlDataBaseAccess.Comparador.Igual);
				arlCondicaoValor.Add(m_nIdTipoCOFormA);
