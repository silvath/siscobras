...
{
	/// <summary>
	/// Summary description for clsNormasMercosul.
	/// </summary>
	public class clsNormasMercosul : clsNormas
	{
		#region Atributos
		private const int m_nIdTipoCOMercosul = 1;
		...
		#region Construtors and Destrutors
			public clsNormasMercosul(ref mdlTratamentoErro.clsTratamentoErro tratadorErro, ref mdlDataBaseAccess.clsDataBaseAccess conexaoBD,string EnderecoExecutavel, int nIdExportador, string strIdPE): base (ref tratadorErro, ref conexaoBD,EnderecoExecutavel, m_nIdTipoCOMercosul)
			{
		...
		protected void carregaTypDatSet()
		{
			try
			{
				...
				arlCondicaoComparador.Add(mdlDataBaseAccess.Comparador.Igual);
				arlCondicaoValor.Add(m_nIdTipoCOMercosul);
