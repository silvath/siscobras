...
{
	/// <summary>
	/// Summary description for clsNormasMercosulBolivia.
	/// </summary>
	public class clsNormasMercosulBolivia : clsNormas
	{
		#region Atributos
		private const int m_nIdTipoCOMercosulBolivia = 2;
		private mdlDataBaseAccess.Tabelas.XsdTbProdutosCertificadoOrigem m_typDatSetTbProdutosCertificadoOrigem = null;
		#endregion
		#region Constructors and Destructors
		public clsNormasMercosulBolivia(ref mdlTratamentoErro.clsTratamentoErro tratadorErro, ref mdlDataBaseAccess.clsDataBaseAccess conexaoBD,string EnderecoExecutavel, int nIdExportador, string strIdPE): base (ref tratadorErro, ref conexaoBD,EnderecoExecutavel, m_nIdTipoCOMercosulBolivia)
		{
		...
		protected void carregaTypDatSet()
		{
			try
			{
				...
				arlCondicaoComparador.Add(mdlDataBaseAccess.Comparador.Igual);
				arlCondicaoValor.Add(m_nIdTipoCOMercosulBolivia);
		...
		protected override void carregaDadosInterfaceEspecificos(ref System.Windows.Forms.Form formNorma)
		{
			try
			{
				formNorma.Text = "Mercosul Bolívia";
			}
			catch (Exception err)
			{
				Object erro = err;
