...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private mdlRelatoriosSaque.frmRelatoriosSaque formTeste;
		internal mdlComponentesGraficos.TextBox txtIdCotacao;
		...
		private void InitializeComponent()
		{
			...
			this.txtIdCotacao = new mdlComponentesGraficos.TextBox();
