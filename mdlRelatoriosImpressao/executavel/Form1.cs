...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.ComboBox m_cbRelatorios;
		private System.Windows.Forms.Label m_lbRelatorio;
		private System.Windows.Forms.Button m_btImprime;
		private System.Windows.Forms.CheckBox m_ckShowDialog;
		private System.Windows.Forms.Button m_btManipuladorGrafico;
		...
		private void InitializeComponent()
		{
			...
			this.m_ckShowDialog = new System.Windows.Forms.CheckBox();
			...
			this.m_cbRelatorios = new System.Windows.Forms.ComboBox();
			...
			this.m_btImprime = new System.Windows.Forms.Button();
			...
			this.m_btManipuladorGrafico = new System.Windows.Forms.Button();
			...
			this.m_gbGeral.Size = new System.Drawing.Size(615, 441);
			this.m_gbGeral.TabIndex = 2;
			this.m_gbGeral.TabStop = false;
			// 
			// m_gbParametros
			// 
			this.m_gbParametros.Controls.Add(this.m_ckShowDialog);
			...
			this.m_gbParametros.Controls.Add(this.m_cbRelatorios);
			...
			// m_ckShowDialog
			// 
			this.m_ckShowDialog.Checked = true;
			this.m_ckShowDialog.CheckState = System.Windows.Forms.CheckState.Checked;
			this.m_ckShowDialog.Location = new System.Drawing.Point(221, 48);
			this.m_ckShowDialog.Name = "m_ckShowDialog";
			this.m_ckShowDialog.Size = new System.Drawing.Size(144, 16);
			this.m_ckShowDialog.TabIndex = 8;
			this.m_ckShowDialog.Text = "ShowDialog";
			// 
			// m_txtIdCodigo
			// 
			...
			// m_lbRelatorio
			// 
			this.m_lbRelatorio.Location = new System.Drawing.Point(216, 24);
			this.m_lbRelatorio.Name = "m_lbRelatorio";
			this.m_lbRelatorio.Size = new System.Drawing.Size(56, 16);
			this.m_lbRelatorio.TabIndex = 4;
			this.m_lbRelatorio.Text = "Relatório:";
			// 
			// m_cbRelatorios
			// 
			this.m_cbRelatorios.Location = new System.Drawing.Point(272, 21);
			this.m_cbRelatorios.Name = "m_cbRelatorios";
			this.m_cbRelatorios.Size = new System.Drawing.Size(168, 21);
			this.m_cbRelatorios.TabIndex = 3;
			// 
			// m_gbRetorno
			// 
			this.m_gbRetorno.Controls.Add(this.m_txtRetorno);
			this.m_gbRetorno.Controls.Add(this.m_lbRetorno);
			this.m_gbRetorno.Location = new System.Drawing.Point(7, 383);
			...
			// m_gbMoeda
			// 
			this.m_gbMoeda.Controls.Add(this.m_btManipuladorGrafico);
			this.m_gbMoeda.Controls.Add(this.m_btImprime);
			this.m_gbMoeda.Location = new System.Drawing.Point(8, 328);
			this.m_gbMoeda.Name = "m_gbMoeda";
			this.m_gbMoeda.Size = new System.Drawing.Size(600, 56);
			this.m_gbMoeda.TabIndex = 1;
			this.m_gbMoeda.TabStop = false;
			this.m_gbMoeda.Text = "Relatorios";
			// 
			// m_btImprime
			// 
			this.m_btImprime.Location = new System.Drawing.Point(8, 19);
			this.m_btImprime.Name = "m_btImprime";
			this.m_btImprime.Size = new System.Drawing.Size(80, 24);
			this.m_btImprime.TabIndex = 2;
			this.m_btImprime.Text = "Imprime";
			this.m_btImprime.Click += new System.EventHandler(this.m_btImprime_Click);
			// 
			// m_gbBD
			// 
			...
			// m_txtPortSqlServer
			// 
			this.m_txtPortSqlServer.Location = new System.Drawing.Point(142, 46);
			...
			// m_lbPortSqlServer
			// 
			this.m_lbPortSqlServer.Location = new System.Drawing.Point(112, 49);
			...
			this.m_rbSqlServer.Size = new System.Drawing.Size(88, 16);
			...
			// 
			// m_btManipuladorGrafico
			// 
			this.m_btManipuladorGrafico.Location = new System.Drawing.Point(96, 15);
			this.m_btManipuladorGrafico.Name = "m_btManipuladorGrafico";
			this.m_btManipuladorGrafico.Size = new System.Drawing.Size(80, 32);
			this.m_btManipuladorGrafico.TabIndex = 3;
			this.m_btManipuladorGrafico.Text = "Manipulador Grafico";
			this.m_btManipuladorGrafico.Click += new System.EventHandler(this.m_btManipuladorGrafico_Click);
			// 
			// Form1
			// 
		...
		#region Refresh
			...
			{
				m_cbRelatorios.Items.Clear();
				foreach(string strRelatorio in (System.Enum.GetNames(mdlConstantes.Relatorio.FaturaComercial.GetType())))
					m_cbRelatorios.Items.Add(strRelatorio);
				m_cbRelatorios.Text = mdlConstantes.Relatorio.FaturaComercial.ToString();
			}
		#endregion


		#region Negocio 
			private void m_btImprime_Click(object sender, System.EventArgs e)
			{		
				CreateDataBase();
				this.Cursor = System.Windows.Forms.Cursors.WaitCursor;
				mdlConstantes.Relatorio enumRelatorio = (mdlConstantes.Relatorio)Enum.Parse(mdlConstantes.Relatorio.FaturaComercial.GetType() ,m_cbRelatorios.Text);
				mdlRelatoriosImpressao.clsRelatoriosImpressao obj = new mdlRelatoriosImpressao.clsRelatoriosImpressao(ref m_cls_dba_ConnectionBD,ref m_cls_tre_tratadorErro,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text,enumRelatorio);
				m_txtRetorno.Text = obj.bImprime(m_ckShowDialog.Checked).ToString();
				this.Cursor = System.Windows.Forms.Cursors.Default;
				obj = null;
			}

			private void m_btManipuladorGrafico_Click(object sender, System.EventArgs e)
			{
				CreateDataBase();
				this.Cursor = System.Windows.Forms.Cursors.WaitCursor;
				mdlConstantes.Relatorio enumRelatorio = (mdlConstantes.Relatorio)Enum.Parse(mdlConstantes.Relatorio.FaturaComercial.GetType() ,m_cbRelatorios.Text);
				mdlRelatoriosImpressao.clsRelatoriosImpressao obj = new mdlRelatoriosImpressao.clsRelatoriosImpressao(ref m_cls_dba_ConnectionBD,ref m_cls_tre_tratadorErro,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text,enumRelatorio);
				m_txtRetorno.Text = obj.ManipuladorGrafico().Top.ToString();
				this.Cursor = System.Windows.Forms.Cursors.Default;
				obj = null;
			}
		#endregion
