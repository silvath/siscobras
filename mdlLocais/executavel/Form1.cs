...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Button m_btLocalOva;
		private System.Windows.Forms.Button m_btLocalTransbordo;
		private System.Windows.Forms.Button m_btLocalFormA;
		...
		private void InitializeComponent()
		{
			...
			this.m_btLocalTransbordo = new System.Windows.Forms.Button();
			this.m_btLocalOva = new System.Windows.Forms.Button();
			...
			this.m_btLocalFormA = new System.Windows.Forms.Button();
			...
			// m_gbMoeda
			// 
			this.m_gbMoeda.Controls.Add(this.m_btLocalFormA);
			this.m_gbMoeda.Controls.Add(this.m_btLocalTransbordo);
			this.m_gbMoeda.Controls.Add(this.m_btLocalOva);
			...
			this.m_gbMoeda.Text = "Locais";
			// 
			// m_btLocalTransbordo
			// 
			this.m_btLocalTransbordo.Font = new System.Drawing.Font("Arial", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.m_btLocalTransbordo.Location = new System.Drawing.Point(392, 19);
			this.m_btLocalTransbordo.Name = "m_btLocalTransbordo";
			this.m_btLocalTransbordo.Size = new System.Drawing.Size(96, 32);
			this.m_btLocalTransbordo.TabIndex = 6;
			this.m_btLocalTransbordo.Text = "Local Transbordo";
			this.m_btLocalTransbordo.Click += new System.EventHandler(this.m_btLocalTransbordo_Click);
			// 
			// m_btLocalOva
			// 
			this.m_btLocalOva.Location = new System.Drawing.Point(296, 19);
			this.m_btLocalOva.Name = "m_btLocalOva";
			this.m_btLocalOva.Size = new System.Drawing.Size(96, 32);
			this.m_btLocalOva.TabIndex = 5;
			this.m_btLocalOva.Text = "Local Ova";
			this.m_btLocalOva.Click += new System.EventHandler(this.m_btLocalOva_Click);
			// 
			// m_btComercial
			// 
			this.m_btComercial.Location = new System.Drawing.Point(200, 19);
			this.m_btComercial.Name = "m_btComercial";
			this.m_btComercial.Size = new System.Drawing.Size(96, 32);
			this.m_btComercial.TabIndex = 4;
			this.m_btComercial.Text = "Comercial";
			this.m_btComercial.Click += new System.EventHandler(this.m_btComercial_Click);
			// 
			// m_btProforma
			// 
			this.m_btProforma.Location = new System.Drawing.Point(104, 19);
			...
			// m_lbPortSqlServer
			// 
			this.m_lbPortSqlServer.Location = new System.Drawing.Point(97, 51);
			...
			// m_btLocalFormA
			// 
			this.m_btLocalFormA.Font = new System.Drawing.Font("Arial", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.m_btLocalFormA.Location = new System.Drawing.Point(488, 19);
			this.m_btLocalFormA.Name = "m_btLocalFormA";
			this.m_btLocalFormA.Size = new System.Drawing.Size(96, 32);
			this.m_btLocalFormA.TabIndex = 7;
			this.m_btLocalFormA.Text = "Local FormA";
			this.m_btLocalFormA.Click += new System.EventHandler(this.m_btLocalFormA_Click);
			// 
			// Form1
			// 
...
//				m_cls_dba_ConnectionBD = new mdlDataBaseAccess.clsDataBaseAccessMySql(ref m_cls_tre_tratadorErro,m_txtHost.Text,m_txtUser.Text,m_txtPassword.Text,m_txtDataBaseName.Text);
		...
		private void m_btCotacao_Click(object sender, System.EventArgs e)
		{
			...
			mdlLocais.clsLocais locais = new mdlLocais.clsLocaisFaturaCotacao(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text);
			locais.ShowDialog();
			if (locais.m_bModificado)
			{
		...
		private void m_btProforma_Click(object sender, System.EventArgs e)
		{
			...
			mdlLocais.clsLocais locais = new mdlLocais.clsLocaisFaturaProforma(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text);
			locais.ShowDialog();
			if (locais.m_bModificado)
			{
		...
		{
			CreateDataBase();
			mdlLocais.clsLocais locais = new mdlLocais.clsLocaisFaturaComercial(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text);
			locais.Incoterm = false;
			locais.ShowDialog();
			if (locais.m_bModificado)
			{
			}
		...
		private void m_btLocalOva_Click(object sender, System.EventArgs e)
		{
			CreateDataBase();
			mdlLocais.clsLocal obj = new mdlLocais.clsLocalOva(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text);
			obj.ShowDialog();
		}

		private void m_btLocalTransbordo_Click(object sender, System.EventArgs e)
		{
			CreateDataBase();
			mdlLocais.clsLocal obj = new mdlLocais.clsLocalTransbordo(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text);
			obj.ShowDialog();
		}

		private void m_btLocalFormA_Click(object sender, System.EventArgs e)
		{
			CreateDataBase();
			mdlLocais.clsLocalFormA obj = new mdlLocais.clsLocalFormA(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text);
			obj.ShowDialog();
			m_txtRetorno.Text = obj.GetFormALocalData();
		}
		#endregion
	}
}
