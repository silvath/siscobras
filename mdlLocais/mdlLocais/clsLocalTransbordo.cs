...
{
	/// <summary>
	/// Summary description for clsLocalTransbordo.
	/// </summary>
	public class clsLocalTransbordo : clsLocal
	{
		#region Atributes
		...
		#region Constructors and Destructors
			public clsLocalTransbordo(ref mdlTratamentoErro.clsTratamentoErro cls_ter_tratadorErro,ref mdlDataBaseAccess.clsDataBaseAccess m_cls_dba_ConnectionDB, string strEnderecoExecutavel, int nIdExportador,string strIdPe) : base(ref cls_ter_tratadorErro,ref m_cls_dba_ConnectionDB, strEnderecoExecutavel) 
			{
		...
		#region Carregamento dos Dados
			...
			{
				strFormText = "Local de Tranbordo";
				strGroupboxText = "";
			}
