...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Button m_btDSEVincular;
		private System.Windows.Forms.Button m_btDSEs;
		...
		private void InitializeComponent()
		{
			...
			this.m_btDSEVincular = new System.Windows.Forms.Button();
			this.m_btDSEs = new System.Windows.Forms.Button();
			...
			// m_gbMoeda
			// 
			this.m_gbMoeda.Controls.Add(this.m_btDSEVincular);
			this.m_gbMoeda.Controls.Add(this.m_btDSEs);
			...
			// m_btDSEVincular
			// 
			this.m_btDSEVincular.Location = new System.Drawing.Point(107, 20);
			this.m_btDSEVincular.Name = "m_btDSEVincular";
			this.m_btDSEVincular.Size = new System.Drawing.Size(96, 32);
			this.m_btDSEVincular.TabIndex = 7;
			this.m_btDSEVincular.Text = "DSEs Vincular";
			this.m_btDSEVincular.Click += new System.EventHandler(this.m_btResVincular_Click);
			// 
			// m_btDSEs
			// 
			this.m_btDSEs.Location = new System.Drawing.Point(6, 20);
			this.m_btDSEs.Name = "m_btDSEs";
			this.m_btDSEs.Size = new System.Drawing.Size(96, 32);
			this.m_btDSEs.TabIndex = 6;
			this.m_btDSEs.Text = "DSEs";
			this.m_btDSEs.Click += new System.EventHandler(this.m_btREs_Click);
			// 
			// m_gbBD
			// 
		...
		{
			CreateDataBase();
			mdlDSE.clsDSE obj = new mdlDSE.clsDSE(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text);
			obj.ShowDialog();
		}
