...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Button m_btErros;
		...
		private void InitializeComponent()
		{
			...
			this.m_btErros = new System.Windows.Forms.Button();
			...
			// m_gbMoeda
			// 
			this.m_gbMoeda.Controls.Add(this.m_btErros);
			...
			// m_btErros
			// 
			this.m_btErros.Location = new System.Drawing.Point(9, 20);
			this.m_btErros.Name = "m_btErros";
			this.m_btErros.Size = new System.Drawing.Size(96, 32);
			this.m_btErros.TabIndex = 0;
			this.m_btErros.Text = "Erros";
			this.m_btErros.Click += new System.EventHandler(this.m_btErros_Click);
			// 
			// m_gbBD
			// 
			...
			this.Text = "WebService Envia Dados";
		...
		#region Negocio 
		private void m_btErros_Click(object sender, System.EventArgs e)
		{
			CreateDataBase();
			mdlWebServiceEnviaDados.clsWebServiceEnviaDadosErros obj = new mdlWebServiceEnviaDados.clsWebServiceEnviaDadosErros(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text);
			this.Cursor = System.Windows.Forms.Cursors.WaitCursor;
			m_txtRetorno.Text = obj.bEnviaDados().ToString();
