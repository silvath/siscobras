...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Button m_btSDs;
		private System.Windows.Forms.Button m_btSDVincularRE;
		...
		private void InitializeComponent()
		{
			...
			this.m_btSDs = new System.Windows.Forms.Button();
			...
			this.m_btSDVincularRE = new System.Windows.Forms.Button();
			...
			// m_gbMoeda
			// 
			this.m_gbMoeda.Controls.Add(this.m_btSDVincularRE);
			this.m_gbMoeda.Controls.Add(this.m_btSDs);
			...
			// m_btSDs
			// 
			this.m_btSDs.Location = new System.Drawing.Point(6, 20);
			this.m_btSDs.Name = "m_btSDs";
			this.m_btSDs.Size = new System.Drawing.Size(96, 32);
			this.m_btSDs.TabIndex = 6;
			this.m_btSDs.Text = "SDs";
			this.m_btSDs.Click += new System.EventHandler(this.m_btREs_Click);
			// 
			// m_gbBD
			// 
			...
			// m_btSDVincularRE
			// 
			this.m_btSDVincularRE.Location = new System.Drawing.Point(108, 20);
			this.m_btSDVincularRE.Name = "m_btSDVincularRE";
			this.m_btSDVincularRE.Size = new System.Drawing.Size(96, 32);
			this.m_btSDVincularRE.TabIndex = 7;
			this.m_btSDVincularRE.Text = "SDVincularPE";
			this.m_btSDVincularRE.Click += new System.EventHandler(this.m_btSDVincularRE_Click);
			// 
			// Form1
			// 
		...
		#region Negocio
			...
			{
				CreateDataBase();
				mdlSD.clsSD obj = new mdlSD.clsSD(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text);
				obj.ShowDialog();
				m_txtRetorno.Text =  obj.Personalizavel;
			}

			private void m_btSDVincularRE_Click(object sender, System.EventArgs e)
			{
				CreateDataBase();
				mdlSD.clsSD obj = new mdlSD.clsSD(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text);
				obj.ShowDialogVincularPE();
				m_txtRetorno.Text = obj.Personalizavel;
			}
		#endregion
