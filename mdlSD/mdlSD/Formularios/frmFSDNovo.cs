...
{
	/// <summary>
	/// Summary description for frmFSDNovo.
	/// </summary>
	public class frmFSDNovo : System.Windows.Forms.Form
	{
		#region Delegates
			public delegate bool delCallSalvaDados(string strNumero,System.DateTime dtEmissao);
			public delegate bool delCallSalvaDadosEditar(int nIdSD,string strNumero,System.DateTime dtEmissao);
		#endregion
		#region Events
		...
		#region Events Methods
			...
			protected virtual bool OnCallSalvaDadosEditar()
			{
				...
				if (eCallSalvaDadosEditar != null)
					bRetorno = eCallSalvaDadosEditar(m_nIdSD,m_txtNumero.Text,m_dtpEmissao.Value);
				this.Cursor = System.Windows.Forms.Cursors.Default;
				return(bRetorno);
			}
		#endregion
		...
		#endregion
		#region Construtores
			public frmFSDNovo(string strEnderecoExecutavel)
			{
				InitializeComponent();
				vMostraCor(strEnderecoExecutavel);
			}

			public frmFSDNovo(string strEnderecoExecutavel,int nIdSD)
			{
				m_nIdSD = nIdSD;
				InitializeComponent();
				vMostraCor(strEnderecoExecutavel);
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmFSDNovo));
			this.m_gbMain = new System.Windows.Forms.GroupBox();
			this.m_gbSD = new System.Windows.Forms.GroupBox();
			this.m_dtpEmissao = new System.Windows.Forms.DateTimePicker();
			this.m_lbEmisao = new System.Windows.Forms.Label();
			...
			this.m_gbMain.Controls.Add(this.m_gbSD);
			...
			this.m_gbMain.Size = new System.Drawing.Size(186, 109);
			this.m_gbMain.TabIndex = 1;
			this.m_gbMain.TabStop = false;
			// 
			// m_gbSD
			// 
			this.m_gbSD.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
				| System.Windows.Forms.AnchorStyles.Right)));
			this.m_gbSD.Controls.Add(this.m_dtpEmissao);
			this.m_gbSD.Controls.Add(this.m_lbEmisao);
			this.m_gbSD.Controls.Add(this.m_txtNumero);
			this.m_gbSD.Controls.Add(this.m_lbNumero);
			this.m_gbSD.Location = new System.Drawing.Point(6, 6);
			this.m_gbSD.Name = "m_gbSD";
			this.m_gbSD.Size = new System.Drawing.Size(175, 66);
			this.m_gbSD.TabIndex = 1;
			this.m_gbSD.TabStop = false;
			// 
			// m_dtpEmissao
			// 
			...
			// m_lbEmisao
			// 
			this.m_lbEmisao.Location = new System.Drawing.Point(8, 37);
			this.m_lbEmisao.Name = "m_lbEmisao";
			this.m_lbEmisao.Size = new System.Drawing.Size(56, 16);
			this.m_lbEmisao.TabIndex = 2;
			this.m_lbEmisao.Text = "Emissao:";
			// 
			// m_txtNumero
			// 
			...
			this.m_btOk.Location = new System.Drawing.Point(36, 80);
			...
			this.m_btCancelar.Location = new System.Drawing.Point(100, 80);
			...
			this.Name = "frmFSDNovo";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "DDE";
			this.m_gbMain.ResumeLayout(false);
			this.m_gbSD.ResumeLayout(false);
