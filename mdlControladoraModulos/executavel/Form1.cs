...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Button m_btMdiSiscobras;
		...
		private void InitializeComponent()
		{
			...
			this.m_btMdiSiscobras = new System.Windows.Forms.Button();
			...
			// m_gbMoeda
			// 
			this.m_gbMoeda.Controls.Add(this.m_btMdiSiscobras);
			...
			// m_btMdiSiscobras
			// 
			this.m_btMdiSiscobras.Location = new System.Drawing.Point(9, 19);
			this.m_btMdiSiscobras.Name = "m_btMdiSiscobras";
			this.m_btMdiSiscobras.Size = new System.Drawing.Size(96, 32);
			this.m_btMdiSiscobras.TabIndex = 2;
			this.m_btMdiSiscobras.Text = "MdiSiscobras";
			this.m_btMdiSiscobras.Click += new System.EventHandler(this.m_btFormularioParent_Click);
			// 
			// m_gbBD
			// 
			...
			// m_txtPortSqlServer
			// 
			this.m_txtPortSqlServer.Location = new System.Drawing.Point(144, 45);
			...
			this.Text = "Controladora Modulos";
		...
		#region Negocio 
		private void m_btFormularioParent_Click(object sender, System.EventArgs e)
		{
			CreateDataBase();
			mdlControladoraModulos.clsControladoraModulos obj = new mdlControladoraModulos.clsControladoraModulos(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text);
			obj.ShowDialog();
			obj = null;
		}
		#endregion
