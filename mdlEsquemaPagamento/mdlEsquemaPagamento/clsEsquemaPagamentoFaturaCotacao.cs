...
{
	/// <summary>
	/// Summary description for clsEsquemaPagamentoFaturaCotacao.
	/// </summary>
	public class clsEsquemaPagamentoFaturaCotacao : clsEsquemaPagamento
	{
		#region Atributes
			// ***************************************************************************************************
			// Atributos
		...
		#endregion
		#region Constructor
			public clsEsquemaPagamentoFaturaCotacao(ref mdlTratamentoErro.clsTratamentoErro tratadorErro , ref mdlDataBaseAccess.clsDataBaseAccess ConnectionDB , string strEnderecoExecutavel, ref System.Windows.Forms.ImageList Bandeiras,int idExportador,string idCotacao): base(ref tratadorErro,ref ConnectionDB,strEnderecoExecutavel,ref Bandeiras,idExportador) 
			{
