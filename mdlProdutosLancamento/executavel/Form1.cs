...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			// m_btComercial
			// 
			this.m_btComercial.Location = new System.Drawing.Point(110, 20);
			...
			// m_lbPortSqlServer
			// 
			this.m_lbPortSqlServer.Location = new System.Drawing.Point(133, 49);
			this.m_lbPortSqlServer.Name = "m_lbPortSqlServer";
			this.m_lbPortSqlServer.Size = new System.Drawing.Size(32, 16);
			this.m_lbPortSqlServer.TabIndex = 10;
			this.m_lbPortSqlServer.Text = "Port:";
			// 
			// m_txtPortSqlServer
			// 
			this.m_txtPortSqlServer.Location = new System.Drawing.Point(165, 45);
			this.m_txtPortSqlServer.Name = "m_txtPortSqlServer";
			this.m_txtPortSqlServer.Size = new System.Drawing.Size(54, 20);
			this.m_txtPortSqlServer.TabIndex = 9;
			...
			this.m_rbSqlServer.Size = new System.Drawing.Size(104, 16);
		...
		#region Cultura
			private void ArrumaCultura()
			{
//				System.Globalization.CultureInfo cultInfCultura = new System.Globalization.CultureInfo("pt-BR");
//				System.Globalization.CompareInfo compInfo ;//= new System.Globalization.CompareInfo();
//				cultInfCultura.CompareInfo = compInfo;
//				System.Threading.Thread.CurrentThread.CurrentCulture.CompareInfo = compInfo;
			}
		#endregion
		#region Eventos 
			...
			{
				CreateDataBase();
				mdlProdutosLancamento.clsLancamentoProdutos modLancamentoProdutos = new mdlProdutosLancamento.clsLancamentoProdutosFaturaCotacao(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,ref m_ilBandeiras,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text);
				modLancamentoProdutos.ShowDialog();
				if (modLancamentoProdutos.m_bModificado)
				{
				}
			}
			...
			{
				CreateDataBase();
//				m_cls_tre_tratadorErro.EnderecoExecutavel = m_txtPath.Text;
//				m_cls_tre_tratadorErro.ConnectionDB = m_cls_dba_ConnectionBD;
				mdlProdutosLancamento.clsLancamentoProdutos modLancamentoProdutos = new mdlProdutosLancamento.clsLancamentoProdutosFaturaComercial(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,ref m_ilBandeiras,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text);
				modLancamentoProdutos.ShowDialog();
				if (modLancamentoProdutos.m_bModificado)
				{
				}
