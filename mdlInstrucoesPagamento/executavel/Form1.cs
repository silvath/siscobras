...
//				m_cls_dba_ConnectionBD = new mdlDataBaseAccess.clsDataBaseAccessMySql(ref m_cls_tre_tratadorErro,m_txtHost.Text,m_txtUser.Text,m_txtPassword.Text,m_txtDataBaseName.Text);
		...
		#region Eventos
        	private void m_btCotacao_Click(object sender, System.EventArgs e)
			{
				string strNavio;
				CreateDataBase();
				mdlInstrucoesPagamento.clsInstrucoesPagamento modInstrucoesPagamento = new mdlInstrucoesPagamento.Faturas.clsInstrucoesPagamentoCotacao(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text, Int32.Parse(m_txtIdExportador.Text), m_txtIdCodigo.Text);
				modInstrucoesPagamento.retornaValores(out strNavio);
				this.m_txtRetorno.Text = "Instruções: " + strNavio;
				modInstrucoesPagamento.ShowDialog();
				modInstrucoesPagamento.retornaValores(out strNavio);
				this.m_txtRetorno.Text = "Instruções: " + strNavio;
			}
			...
			private void m_btComercial_Click(object sender, System.EventArgs e)
			{
				string strNavio;
				CreateDataBase();
				mdlInstrucoesPagamento.clsInstrucoesPagamento modInstrucoesPagamento = new mdlInstrucoesPagamento.Faturas.clsInstrucoesPagamentoComercial(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text, Int32.Parse(m_txtIdExportador.Text), m_txtIdCodigo.Text);
				modInstrucoesPagamento.retornaValores(out strNavio);
				this.m_txtRetorno.Text = "Instruções: " + strNavio;
				modInstrucoesPagamento.ShowDialog();
				modInstrucoesPagamento.retornaValores(out strNavio);
			...
			private void m_btProforma_Click(object sender, System.EventArgs e)
			{
				string strNavio;
				CreateDataBase();
				mdlInstrucoesPagamento.clsInstrucoesPagamento modInstrucoesPagamento = new mdlInstrucoesPagamento.Faturas.clsInstrucoesPagamentoProforma(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text, Int32.Parse(m_txtIdExportador.Text), m_txtIdCodigo.Text);
				modInstrucoesPagamento.retornaValores(out strNavio);
				this.m_txtRetorno.Text = "Instruções: " + strNavio;
				modInstrucoesPagamento.ShowDialog();
				modInstrucoesPagamento.retornaValores(out strNavio);
