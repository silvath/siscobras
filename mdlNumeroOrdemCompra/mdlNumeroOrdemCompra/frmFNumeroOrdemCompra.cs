...
{
	/// <summary>
	/// Summary description for frmFNumeroOrdemCompra.
	/// </summary>
	internal class frmFNumeroOrdemCompra : mdlComponentesGraficos.FormFlutuante
	{
		#region Atributos
		...
		private mdlComponentesGraficos.TextBox m_ctbNumeroOrdemCompra;
		private System.Windows.Forms.Button m_btOk;
		private System.Windows.Forms.Button m_btCancelar;
		private System.Windows.Forms.Button m_btTrocarCor;
		private System.Windows.Forms.ToolTip m_ttNumeroOrdemCompra;
		private System.ComponentModel.IContainer components;
		#endregion

		#region Construtores & Destrutores
		public frmFNumeroOrdemCompra(ref mdlTratamentoErro.clsTratamentoErro tratadorErro, string EnderecoExecutavel)
		{
			//
		...
		public delegate void delCallCarregaDadosInterface(ref mdlComponentesGraficos.TextBox ctbNumeroOrdemCompra);
		public delegate void delCallChecaIntegridadeDados();
		public delegate void delCallSalvaDadosInterface(ref mdlComponentesGraficos.TextBox ctbAssinatura);
		...
		protected virtual void OnCallCarregaDadosInterface()
		{
			if (eCallCarregaDadosInterface != null)
				eCallCarregaDadosInterface(ref this.m_ctbNumeroOrdemCompra);
		}
		...
		protected virtual void OnCallSalvaDadosInterface()
		{
			if (eCallSalvaDadosInterface != null)
				eCallSalvaDadosInterface(ref this.m_ctbNumeroOrdemCompra);
		} 
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmFNumeroOrdemCompra));
			this.m_gbFrame = new System.Windows.Forms.GroupBox();
			this.m_btOk = new System.Windows.Forms.Button();
			this.m_btCancelar = new System.Windows.Forms.Button();
			this.m_btTrocarCor = new System.Windows.Forms.Button();
			this.m_gbFields = new System.Windows.Forms.GroupBox();
			this.m_ctbNumeroOrdemCompra = new mdlComponentesGraficos.TextBox();
			this.m_ttNumeroOrdemCompra = new System.Windows.Forms.ToolTip(this.components);
			...
			this.m_gbFrame.Size = new System.Drawing.Size(246, 93);
			...
			this.m_btOk.Location = new System.Drawing.Point(63, 61);
			this.m_btOk.Name = "m_btOk";
			this.m_btOk.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.m_btOk.Size = new System.Drawing.Size(57, 27);
			this.m_btOk.TabIndex = 2;
			this.m_ttNumeroOrdemCompra.SetToolTip(this.m_btOk, "Confirmar");
			...
			this.m_btCancelar.Location = new System.Drawing.Point(127, 61);
			this.m_btCancelar.Name = "m_btCancelar";
			this.m_btCancelar.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.m_btCancelar.Size = new System.Drawing.Size(57, 27);
			this.m_btCancelar.TabIndex = 3;
			this.m_ttNumeroOrdemCompra.SetToolTip(this.m_btCancelar, "Cancelar");
			...
			this.m_ttNumeroOrdemCompra.SetToolTip(this.m_btTrocarCor, "Cor");
			...
			this.m_gbFields.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
				| System.Windows.Forms.AnchorStyles.Left) 
				| System.Windows.Forms.AnchorStyles.Right)));
			this.m_gbFields.Controls.Add(this.m_ctbNumeroOrdemCompra);
			...
			this.m_gbFields.Size = new System.Drawing.Size(230, 48);
			this.m_gbFields.TabIndex = 0;
			this.m_gbFields.TabStop = false;
			// 
			// m_ctbNumeroOrdemCompra
			// 
			this.m_ctbNumeroOrdemCompra.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left) 
				| System.Windows.Forms.AnchorStyles.Right)));
			this.m_ctbNumeroOrdemCompra.Font = new System.Drawing.Font("Arial", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.m_ctbNumeroOrdemCompra.Location = new System.Drawing.Point(8, 17);
			this.m_ctbNumeroOrdemCompra.Name = "m_ctbNumeroOrdemCompra";
			this.m_ctbNumeroOrdemCompra.Size = new System.Drawing.Size(213, 20);
			this.m_ctbNumeroOrdemCompra.TabIndex = 1;
			this.m_ctbNumeroOrdemCompra.Text = "";
			// 
			// m_ttNumeroOrdemCompra
			// 
			this.m_ttNumeroOrdemCompra.AutomaticDelay = 100;
			this.m_ttNumeroOrdemCompra.AutoPopDelay = 5000;
			this.m_ttNumeroOrdemCompra.InitialDelay = 100;
			this.m_ttNumeroOrdemCompra.ReshowDelay = 20;
			// 
			// frmFNumeroOrdemCompra
			// 
			...
			this.Name = "frmFNumeroOrdemCompra";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "Ordem de Compra";
			this.Load += new System.EventHandler(this.frmFNumeroOrdemCompra_Load);
		...
		#endregion
		#region Load
		private void frmFNumeroOrdemCompra_Load(object sender, System.EventArgs e)
		{
			try
			{
				this.mostraCor();
