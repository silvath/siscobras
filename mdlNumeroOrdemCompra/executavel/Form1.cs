...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_gbMoeda.Text = "Assinaturas";
			// 
			// button1
			// 
			...
			// m_btProforma
			// 
			this.m_btProforma.Location = new System.Drawing.Point(320, 20);
			...
			// m_btComercial
			// 
			this.m_btComercial.Location = new System.Drawing.Point(176, 20);
			...
			// m_btCotacao
			// 
			this.m_btCotacao.Location = new System.Drawing.Point(40, 20);
			...
			// m_ilBandeiras
			// 
			this.m_ilBandeiras.ColorDepth = System.Windows.Forms.ColorDepth.Depth8Bit;
		...
		#region Eventos
        	private void m_btCotacao_Click(object sender, System.EventArgs e)
			{
				...
				this.m_txtRetorno.Text = "";
				CreateDataBase();
				mdlNumeroOrdemCompra.clsNumeroOrdemCompra modNumeroOrdemCompra = new mdlNumeroOrdemCompra.clsNumeroOrdemCompraCotacao(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text);
				modNumeroOrdemCompra.retornaValores(out strNumero);
				this.m_txtRetorno.Text = "Assinatura: " + strNumero;
				modNumeroOrdemCompra.ShowDialog();
				modNumeroOrdemCompra.retornaValores(out strNumero);
				this.m_txtRetorno.Text = "Assinatura: " + strNumero;
			}
			...
			private void m_btComercial_Click(object sender, System.EventArgs e)
			{
				...
				this.m_txtRetorno.Text = "";
				CreateDataBase();
				mdlNumeroOrdemCompra.clsNumeroOrdemCompra modNumeroOrdemCompra = new mdlNumeroOrdemCompra.clsNumeroOrdemCompraComercial(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text);
				modNumeroOrdemCompra.retornaValores(out strNumero);
				this.m_txtRetorno.Text = "Assinatura: " + strNumero;
				modNumeroOrdemCompra.ShowDialog();
				modNumeroOrdemCompra.retornaValores(out strNumero);
			...
			private void m_btProforma_Click(object sender, System.EventArgs e)
			{
				...
				this.m_txtRetorno.Text = "";
				CreateDataBase();
				mdlNumeroOrdemCompra.clsNumeroOrdemCompra modNumeroOrdemCompra = new mdlNumeroOrdemCompra.clsNumeroOrdemCompraProforma(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text);
				modNumeroOrdemCompra.retornaValores(out strNumero);
				this.m_txtRetorno.Text = "Assinatura: " + strNumero;
				modNumeroOrdemCompra.ShowDialog();
				modNumeroOrdemCompra.retornaValores(out strNumero);
