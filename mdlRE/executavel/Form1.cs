...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Button m_btREsEspelhos;
		private System.Windows.Forms.Button m_btREsEspelhosRepo;
		...
		private void InitializeComponent()
		{
			...
			this.m_btREsEspelhos = new System.Windows.Forms.Button();
			...
			this.m_btREsEspelhosRepo = new System.Windows.Forms.Button();
			...
			// m_gbMoeda
			// 
			this.m_gbMoeda.Controls.Add(this.m_btREsEspelhosRepo);
			this.m_gbMoeda.Controls.Add(this.m_btREsEspelhos);
			...
			// m_btREsEspelhos
			// 
			this.m_btREsEspelhos.Location = new System.Drawing.Point(360, 21);
			this.m_btREsEspelhos.Name = "m_btREsEspelhos";
			this.m_btREsEspelhos.Size = new System.Drawing.Size(96, 32);
			this.m_btREsEspelhos.TabIndex = 8;
			this.m_btREsEspelhos.Text = "REs Espelhos BD";
			this.m_btREsEspelhos.Click += new System.EventHandler(this.m_btREsEspelhos_Click);
			// 
			// m_btResVincular
			// 
			...
			// m_btREsEspelhosRepo
			// 
			this.m_btREsEspelhosRepo.Location = new System.Drawing.Point(461, 21);
			this.m_btREsEspelhosRepo.Name = "m_btREsEspelhosRepo";
			this.m_btREsEspelhosRepo.Size = new System.Drawing.Size(96, 32);
			this.m_btREsEspelhosRepo.TabIndex = 9;
			this.m_btREsEspelhosRepo.Text = "REs Espelhos";
			this.m_btREsEspelhosRepo.Click += new System.EventHandler(this.m_btREsEspelhosRepo_Click);
			// 
			// Form1
			// 
