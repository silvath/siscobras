...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void m_btAgentes_Click(object sender, System.EventArgs e)
		{
			bool bRetorno;
			CreateDataBase();
			mdlTrocaBooleano.clsTrocaBooleano obj = new mdlTrocaBooleano.InstrucoesEmbarque.clsTrocaPermitirEmbarquesParciais(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text, Int32.Parse(m_txtIdExportador.Text), m_txtIdCodigo.Text);
			obj.retornaValores(out bRetorno);
			m_txtRetorno.Text = "1º Retorno = " + bRetorno.ToString();
			obj.trocaValor();
			obj.retornaValores(out bRetorno);
			m_txtRetorno.Text += "2º Retorno = " + bRetorno.ToString();
		}		
