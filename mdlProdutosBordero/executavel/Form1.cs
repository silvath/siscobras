...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_txtIdCodigo.Text = "019/05";
			...
			this.m_btRomaneio.Text = "Bordero";
			...
			// m_txtPortMysql
			// 
			this.m_txtPortMysql.Location = new System.Drawing.Point(142, 24);
		...
		{
			CreateDataBase();
			mdlProdutosBordero.clsProdutosBordero prod = new mdlProdutosBordero.clsProdutosBordero(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text);
			prod.ShowDialog();
