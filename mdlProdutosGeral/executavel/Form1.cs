...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			// m_txtPortSqlServer
			// 
			this.m_txtPortSqlServer.Location = new System.Drawing.Point(137, 47);
			...
			// m_lbPortSqlServer
			// 
			this.m_lbPortSqlServer.Location = new System.Drawing.Point(112, 50);
		...
		{
			CreateDataBase();
			mdlProdutosGeral.clsProdutos obj = new mdlProdutosGeral.clsProdutos(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),Int32.Parse(m_txtIdCodigo.Text), ref m_ilBandeiras);
			obj.Codigo = m_txtIdCodigo.Text;
			obj.DataSourceCodigo = mdlProdutosGeral.DataSource.FaturaCotacao;
			obj.ShowDialogProdutos();
			obj = null;
		}
		#endregion
