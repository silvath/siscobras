...
namespace mdlProdutosGeral
{
	...
	/// </summary>
	public class frmFVolumeTipo : System.Windows.Forms.Form
	{
		#region Delegates
		...
		public frmFVolumeTipo(ref mdlTratamentoErro.clsTratamentoErro TratadorErro, string strEnderecoExecutavel)
		{
