...
//				m_cls_dba_ConnectionBD = new mdlDataBaseAccess.clsDataBaseAccessMySql(ref m_cls_tre_tratadorErro,m_txtHost.Text,m_txtUser.Text,m_txtPassword.Text,m_txtDataBaseName.Text);
		...
		#region Eventos
        	private void m_btCotacao_Click(object sender, System.EventArgs e)
			{
				...
				modEnderecoEntrega = new mdlEnderecoEntrega.clsEnderecoEntregaImportadorCotacao(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text);
				modEnderecoEntrega.retornaValores(out strEndereco);
				this.m_txtRetorno.Text = "Endereço: " + strEndereco;
				modEnderecoEntrega.ShowDialog();
				modEnderecoEntrega.retornaValores(out strEndereco);
				this.m_txtRetorno.Text = "Endereço: " + strEndereco;
			}
			...
			private void m_btComercial_Click(object sender, System.EventArgs e)
			{
				...
				CreateDataBase();
				mdlEnderecoEntrega.clsEnderecoEntregaImportador modEnderecoEntrega;
				modEnderecoEntrega = new mdlEnderecoEntrega.clsEnderecoEntregaImportadorComercial(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text);
				modEnderecoEntrega.retornaValores(out strEndereco);
				this.m_txtRetorno.Text = "Endereço: " + strEndereco;
				modEnderecoEntrega.ShowDialog();
				modEnderecoEntrega.retornaValores(out strEndereco);
