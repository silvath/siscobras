...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Text = "Instruções de Embarque";
...
//				m_cls_dba_ConnectionBD = new mdlDataBaseAccess.clsDataBaseAccessMySql(ref m_cls_tre_tratadorErro,m_txtHost.Text,m_txtUser.Text,m_txtPassword.Text,m_txtDataBaseName.Text);
		...
		#region Eventos
        	private void m_btCotacao_Click(object sender, System.EventArgs e)
			{
				...
				this.m_txtRetorno.Text = "";
				CreateDataBase();
				mdlAssinatura.clsAssinatura modAssinatura = new mdlAssinatura.clsAssinaturaCotacao(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text, Int32.Parse(m_txtIdExportador.Text), m_txtIdCodigo.Text);
				modAssinatura.retornaValores(out strAssinatura);
				this.m_txtRetorno.Text = "Assinatura: " + strAssinatura;
				modAssinatura.ShowDialog();
				modAssinatura.retornaValores(out strAssinatura);
				this.m_txtRetorno.Text = "Assinatura: " + strAssinatura;
			}
			...
			private void m_btComercial_Click(object sender, System.EventArgs e)
			{
				...
				this.m_txtRetorno.Text = "";
				CreateDataBase();
				mdlAssinatura.clsAssinatura modAssinatura = new mdlAssinatura.clsAssinaturaComercial(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text, Int32.Parse(m_txtIdExportador.Text), m_txtIdCodigo.Text);
				modAssinatura.retornaValores(out strAssinatura);
				this.m_txtRetorno.Text = "Assinatura: " + strAssinatura;
				modAssinatura.ShowDialog();
				modAssinatura.retornaValores(out strAssinatura);
			...
			private void m_btProforma_Click(object sender, System.EventArgs e)
			{
				...
				this.m_txtRetorno.Text = "";
				CreateDataBase();
				mdlAssinatura.clsAssinatura modAssinatura = new mdlAssinatura.clsAssinaturaProforma(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text, Int32.Parse(m_txtIdExportador.Text), m_txtIdCodigo.Text);
				modAssinatura.retornaValores(out strAssinatura);
				this.m_txtRetorno.Text = "Assinatura: " + strAssinatura;
				modAssinatura.ShowDialog();
				modAssinatura.retornaValores(out strAssinatura);
