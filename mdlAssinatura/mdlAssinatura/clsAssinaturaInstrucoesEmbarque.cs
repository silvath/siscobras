...
{
	/// <summary>
	/// Summary description for clsAssinaturaInstrucoesEmbarque.
	/// </summary>
	public class clsAssinaturaInstrucoesEmbarque : clsAssinatura
	{
		#region Atributos
		private string m_strIdPE = "";

		protected mdlDataBaseAccess.Tabelas.XsdTbInstrucoesEmbarque m_typDatSetTbInstrucoesEmbarque;
		#endregion

		#region Construtores & Destrutores
		public clsAssinaturaInstrucoesEmbarque(ref mdlTratamentoErro.clsTratamentoErro tratadorErro, ref mdlDataBaseAccess.clsDataBaseAccess ConnectionDB,string EnderecoExecutavel,int nIdExportador, string idPE) : base(ref tratadorErro, ref ConnectionDB,EnderecoExecutavel,nIdExportador)
		{
			m_strIdPE = idPE;
		...
		protected override void carregaDadosBDEspecifico()
		{
			try
			{
				...
				if (m_typDatSetTbInstrucoesEmbarque.tbInstrucoesEmbarque.Rows.Count > 0)
				{
					...
					if (!dtrwRowTbInstrucoesEmbarque.IsnIdAssinaturaNull())
						m_nIdAssinatura = dtrwRowTbInstrucoesEmbarque.nIdAssinatura;
				}
			...
			try
			{
				...
				if (m_typDatSetTbInstrucoesEmbarque.tbInstrucoesEmbarque.Rows.Count > 0)
				{
					...
					if (dtrwRowTbInstrucoesEmbarque != null)
						dtrwRowTbInstrucoesEmbarque.nIdAssinatura = m_nIdAssinatura;
				}
