...
namespace mdlAssinatura.Bordero
{
	/// <summary>
	/// Summary description for clsAssinaturaBordero.
	/// </summary>
	public class clsAssinaturaBordero : clsAssinatura
	{
		#region Atributos
		private string m_strIdPE = "";

		protected mdlDataBaseAccess.Tabelas.XsdTbBorderos m_typDatSetTbBorderos;
		#endregion

		#region Construtores & Destrutores
		public clsAssinaturaBordero(ref mdlTratamentoErro.clsTratamentoErro tratadorErro, ref mdlDataBaseAccess.clsDataBaseAccess ConnectionDB,string EnderecoExecutavel,int nIdExportador, string idPE) : base(ref tratadorErro, ref ConnectionDB,EnderecoExecutavel,nIdExportador)
		{
			m_strIdPE = idPE;
...
//					if (!dtrwRowTbBorderos.IsnIdAssinaturaNull())
//						m_nIdAssinatura = dtrwRowTbBorderos.nIdAssinatura;
				}
...
//						dtrwRowTbBorderos.nIdAssinatura = m_nIdAssinatura;
				}
