...
{
	/// <summary>
	/// Summary description for clsAssinaturaComercial.
	/// </summary>
	public class clsAssinaturaComercial : clsAssinatura
	{
		#region Atributos
		...
		public clsAssinaturaComercial(ref mdlTratamentoErro.clsTratamentoErro tratadorErro, ref mdlDataBaseAccess.clsDataBaseAccess ConnectionDB,string EnderecoExecutavel,int nIdExportador, string idPE) : base(ref tratadorErro, ref ConnectionDB,EnderecoExecutavel,nIdExportador)
		{
			m_strIdPE = idPE;
		...
		protected override void carregaDadosBDEspecifico()
		{
			try
			{
				...
				if (m_typDatSetTbFaturasComerciais.tbFaturasComerciais.Rows.Count > 0)
				{
					...
					if (!dtrwRowTbFaturasComerciais.IsidAssinaturaNull())
						m_nIdAssinatura = dtrwRowTbFaturasComerciais.idAssinatura;
				}
			...
			try
			{
				...
				if (m_typDatSetTbFaturasComerciais.tbFaturasComerciais.Rows.Count > 0)
				{
					...
					if (dtrwRowTbFaturasComerciais != null)
						dtrwRowTbFaturasComerciais.idAssinatura = m_nIdAssinatura;
				}
