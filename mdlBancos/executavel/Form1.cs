...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Button m_ExportadorProforma;
		private System.Windows.Forms.Button m_bExportadorComercial;
		private System.Windows.Forms.Button m_bExportadorCotacao;
		...
		private void InitializeComponent()
		{
			...
			this.m_ExportadorProforma = new System.Windows.Forms.Button();
			this.m_bExportadorComercial = new System.Windows.Forms.Button();
			this.m_bExportadorCotacao = new System.Windows.Forms.Button();
			...
			this.m_gbGeral.Size = new System.Drawing.Size(615, 532);
			this.m_gbGeral.TabIndex = 1;
			this.m_gbGeral.TabStop = false;
			// 
			// groupBox1
			// 
			this.groupBox1.Controls.Add(this.m_btBordero);
			this.groupBox1.Controls.Add(this.button2);
			this.groupBox1.Controls.Add(this.m_ExportadorProforma);
			this.groupBox1.Controls.Add(this.m_bExportadorComercial);
			this.groupBox1.Controls.Add(this.m_bExportadorCotacao);
			this.groupBox1.Location = new System.Drawing.Point(8, 400);
			this.groupBox1.Name = "groupBox1";
			this.groupBox1.Size = new System.Drawing.Size(600, 62);
			this.groupBox1.TabIndex = 4;
			this.groupBox1.TabStop = false;
			this.groupBox1.Text = "Banco Exportador";
			// 
			// m_btBordero
			// 
			this.m_btBordero.Location = new System.Drawing.Point(392, 20);
			...
			// 
			// m_ExportadorProforma
			// 
			this.m_ExportadorProforma.Location = new System.Drawing.Point(280, 20);
			this.m_ExportadorProforma.Name = "m_ExportadorProforma";
			this.m_ExportadorProforma.Size = new System.Drawing.Size(96, 32);
			this.m_ExportadorProforma.TabIndex = 3;
			this.m_ExportadorProforma.Text = "Proforma";
			this.m_ExportadorProforma.Click += new System.EventHandler(this.m_ExportadorProforma_Click);
			// 
			// m_bExportadorComercial
			// 
			this.m_bExportadorComercial.Location = new System.Drawing.Point(152, 20);
			this.m_bExportadorComercial.Name = "m_bExportadorComercial";
			this.m_bExportadorComercial.Size = new System.Drawing.Size(96, 32);
			this.m_bExportadorComercial.TabIndex = 2;
			this.m_bExportadorComercial.Text = "Comercial";
			this.m_bExportadorComercial.Click += new System.EventHandler(this.button4_Click);
			// 
			// m_bExportadorCotacao
			// 
			this.m_bExportadorCotacao.Location = new System.Drawing.Point(16, 20);
			this.m_bExportadorCotacao.Name = "m_bExportadorCotacao";
			this.m_bExportadorCotacao.Size = new System.Drawing.Size(96, 32);
			this.m_bExportadorCotacao.TabIndex = 0;
			this.m_bExportadorCotacao.Text = "Cotacao";
			this.m_bExportadorCotacao.Click += new System.EventHandler(this.m_bExportadorCotacao_Click);
			// 
			// m_gbParametros
			// 
			...
			this.m_gbRetorno.Location = new System.Drawing.Point(8, 476);
			...
			this.m_gbMoeda.Text = "Banco Importador";
			// 
			// button1
			// 
			...
			this.m_txtPortSqlServer.Size = new System.Drawing.Size(36, 20);
			this.m_txtPortSqlServer.TabIndex = 10;
			this.m_txtPortSqlServer.Text = "1433";
			// 
			// m_lbPortSqlServer
			// 
			this.m_lbPortSqlServer.Location = new System.Drawing.Point(98, 50);
			...
			this.Text = "Banco do Importador/Exportador";
...
//				m_cls_dba_ConnectionBD = new mdlDataBaseAccess.clsDataBaseAccessMySql(ref m_cls_tre_tratadorErro,m_txtHost.Text,m_txtUser.Text,m_txtPassword.Text,m_txtDataBaseName.Text);
		...
		#region Eventos
        	private void m_btCotacao_Click(object sender, System.EventArgs e)
			{
				...
				this.m_txtRetorno.Text = "";
				CreateDataBase();
				mdlBancos.clsBancoImportador modBancos;
				modBancos = new mdlBancos.BancoImportador.clsBancoImportadorCotacao(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text);
				modBancos.retornaValores(out strBanco);
				this.m_txtRetorno.Text = "Banco: " + strBanco;
				modBancos.ShowDialog();
				modBancos.retornaValores(out strBanco);
				this.m_txtRetorno.Text = "Banco: " + strBanco;
			}
			...
			{
				string strBanco, strEndereco, mstrCidade, strEstado, strPais, strSwift;
				this.m_txtRetorno.Text = "";
				CreateDataBase();
				mdlBancos.clsBancoImportador modBancos;
				modBancos = new mdlBancos.BancoImportador.clsBancoImportadorComercial(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text);
                modBancos.retornaValores(out strBanco, out strEndereco, out mstrCidade, out strEstado, out strPais, out strSwift);
				this.m_txtRetorno.Text = "Banco: " + strBanco;
				modBancos.ShowDialog();
				modBancos.retornaValores(out strBanco, out strEndereco, out mstrCidade, out strEstado, out strPais, out strSwift);
				this.m_txtRetorno.Text = "Banco: " + strBanco;
			...
			private void m_btProforma_Click(object sender, System.EventArgs e)
			{
				...
				CreateDataBase();
				mdlBancos.clsBancoImportador modBancos;
				modBancos = new mdlBancos.BancoImportador.clsBancoImportadorProforma(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text);
				modBancos.retornaValores(out strBanco);
				this.m_txtRetorno.Text = "Banco: " + strBanco;
				modBancos.ShowDialog();
				modBancos.retornaValores(out strBanco);
			...
			private void button1_Click(object sender, System.EventArgs e)
			{
				...
				this.m_txtRetorno.Text = "";
				CreateDataBase();
				mdlBancos.clsBancoImportador modBancoImportador = new mdlBancos.BancoImportador.clsBancoImportadorGeral(ref this.m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text, Int32.Parse(m_txtIdExportador.Text), Int32.Parse(m_txtIdImportador.Text));
				modBancoImportador.retornaValores(out strBanco);
				this.m_txtRetorno.Text = "Banco: " + strBanco;
				modBancoImportador.ShowDialog();
				modBancoImportador.retornaValores(out strBanco);
				this.m_txtRetorno.Text = "Banco: " + strBanco;
			}
			...
			private void m_ExportadorProforma_Click(object sender, System.EventArgs e)
			{
				string strBanco, strIdAgencia, strIdConta;
				this.m_txtRetorno.Text = "";
				CreateDataBase();
				mdlBancos.clsBancoExportador  modBancoExportador;
				modBancoExportador = new mdlBancos.BancoExportador.clsBancoExportadorProforma(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text, Int32.Parse(m_txtIdExportador.Text), m_txtIdCodigo.Text);
				modBancoExportador.retornaValores(out strBanco, out strIdAgencia, out strIdConta);
				this.m_txtRetorno.Text = "Banco: " + strBanco + " ;Agência: " + strIdAgencia + " ;Conta: " + strIdConta;
				modBancoExportador.ShowDialog();
				modBancoExportador.retornaValores(out strBanco, out strIdAgencia, out strIdConta);
				this.m_txtRetorno.Text = "Banco: " + strBanco + " ;Agência: " + strIdAgencia + " ;Conta: " + strIdConta;
			...
			private void m_bExportadorCotacao_Click(object sender, System.EventArgs e)
			{
				string strBanco, strIdAgencia, strIdConta;
				this.m_txtRetorno.Text = "";
				CreateDataBase();
				mdlBancos.clsBancoExportador  modBancoExportador;
				modBancoExportador = new mdlBancos.BancoExportador.clsBancoExportadorCotacao(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text, Int32.Parse(m_txtIdExportador.Text), m_txtIdCodigo.Text);
				modBancoExportador.retornaValores(out strBanco, out strIdAgencia, out strIdConta);
				this.m_txtRetorno.Text = "Banco: " + strBanco + " ;Agência: " + strIdAgencia + " ;Conta: " + strIdConta;
				modBancoExportador.ShowDialog();
				modBancoExportador.retornaValores(out strBanco, out strIdAgencia, out strIdConta);
			...
			private void m_btBordero_Click(object sender, System.EventArgs e)
			{
				...
				CreateDataBase();
				mdlBancos.clsBancoExportador  modBancoExportador;
				modBancoExportador = new mdlBancos.BancoExportador.clsBancoExportadorBordero(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text, Int32.Parse(m_txtIdExportador.Text), m_txtIdCodigo.Text);
				modBancoExportador.retornaValores(out strBanco, out strIdAgencia, out strIdConta);
				this.m_txtRetorno.Text = "Banco: " + strBanco + " ;Agência: " + strIdAgencia + " ;Conta: " + strIdConta + " IDBANCO: " + modBancoExportador.IDBANCO;
				modBancoExportador.ShowDialog();
				modBancoExportador.retornaValores(out strBanco, out strIdAgencia, out strIdConta);
				this.m_txtRetorno.Text = "Banco: " + strBanco + " ;Agência: " + strIdAgencia + " ;Conta: " + strIdConta + " IDBANCO: " + modBancoExportador.IDBANCO;			
			}
			...
			private void button2_Click(object sender, System.EventArgs e)
			{
				...
				CreateDataBase();
				mdlBancos.clsBancoExportador  modBancoExportador;
				modBancoExportador = new mdlBancos.BancoExportador.clsBancoExportadorGeral(ref m_cls_tre_tratadorErro, ref m_cls_dba_ConnectionBD, m_txtPath.Text, Int32.Parse(m_txtIdExportador.Text));
				modBancoExportador.retornaValores(out strBanco, out strIdAgencia, out strIdConta);
				this.m_txtRetorno.Text = "Banco: " + strBanco + " ;Agência: " + strIdAgencia + " ;Conta: " + strIdConta;
				modBancoExportador.ShowDialog();
				modBancoExportador.retornaValores(out strBanco, out strIdAgencia, out strIdConta);
