...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_btRomaneio.Text = "Contrato Cambio";
		...
		{
			CreateDataBase();
			mdlContratoCambio.clsContratoCambio cc = new mdlContratoCambio.clsContratoCambio(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text));
			cc.ShowDialog();
			if (cc.m_bModificado)
			{
				string strRetorno = "";
