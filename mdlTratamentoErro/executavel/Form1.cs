...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Button m_btUsuario;
		private System.Windows.Forms.Button m_btProgramador;
		...
		private void InitializeComponent()
		{
			...
			this.m_btUsuario = new System.Windows.Forms.Button();
			this.m_btProgramador = new System.Windows.Forms.Button();
			...
			// m_gbMoeda
			// 
			this.m_gbMoeda.Controls.Add(this.m_btUsuario);
			this.m_gbMoeda.Controls.Add(this.m_btProgramador);
			...
			// m_btUsuario
			// 
			this.m_btUsuario.Location = new System.Drawing.Point(121, 20);
			this.m_btUsuario.Name = "m_btUsuario";
			this.m_btUsuario.Size = new System.Drawing.Size(96, 32);
			this.m_btUsuario.TabIndex = 2;
			this.m_btUsuario.Text = "Usuario";
			this.m_btUsuario.Click += new System.EventHandler(this.m_btUsuario_Click);
			// 
			// m_btProgramador
			// 
			this.m_btProgramador.Location = new System.Drawing.Point(20, 20);
			this.m_btProgramador.Name = "m_btProgramador";
			this.m_btProgramador.Size = new System.Drawing.Size(96, 32);
			this.m_btProgramador.TabIndex = 0;
			this.m_btProgramador.Text = "Programador";
			this.m_btProgramador.Click += new System.EventHandler(this.m_btProgramador_Click);
			// 
			// m_gbBD
			// 
		...
		#region Eventos 
		private void m_btProgramador_Click(object sender, System.EventArgs e)
		{
			mdlTratamentoErro.clsTratamentoErro cls_ter_TratadorErro = new mdlTratamentoErro.clsTratamentoErro();
			try
			{
				int i = Int32.Parse("Thiago Henrique da Silva");
			}catch(System.Exception exp){
				object obj = (object)exp;
				cls_ter_TratadorErro.trataErro(ref obj);
			}
		}

		private void m_btUsuario_Click(object sender, System.EventArgs e)
		{
			CreateDataBase();
			mdlTratamentoErro.clsTratamentoErro cls_ter_TratadorErro = new mdlTratamentoErro.clsTratamentoErro();
			cls_ter_TratadorErro.ConnectionDB = m_cls_dba_ConnectionBD;
			cls_ter_TratadorErro.EnderecoExecutavel = m_txtPath.Text;
			try
			{
				int i = Int32.Parse("Thiago Henrique da Silva");
			}
