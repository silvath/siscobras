...
namespace executavel
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.TextBox m_tbIdImportador;
		...
		private System.Windows.Forms.GroupBox m_gbStatic;
		private System.Windows.Forms.Button m_btIdioma;
		...
		private void InitializeComponent()
		{
			...
			this.m_tbIdImportador = new System.Windows.Forms.TextBox();
			...
			this.m_gbStatic = new System.Windows.Forms.GroupBox();
			...
			// m_gbGeral
			// 
			this.m_gbGeral.Controls.Add(this.m_gbStatic);
			...
			this.m_gbGeral.Size = new System.Drawing.Size(615, 514);
			...
			this.groupBox1.Text = "Pais/Idioma";
			// 
			// button2
			// 
			...
			this.button2.Text = "Endereço Entrega";
			...
			this.button1.Text = "Consignatario";
			this.button1.Click += new System.EventHandler(this.button1_Click);
			// 
			// button3
			// 
			this.button3.Location = new System.Drawing.Point(80, 20);
			this.button3.Name = "button3";
			this.button3.Size = new System.Drawing.Size(96, 32);
			this.button3.TabIndex = 0;
			this.button3.Text = "Importador";
			this.button3.Click += new System.EventHandler(this.button3_Click);
			// 
			// m_gbParametros
			// 
			this.m_gbParametros.Controls.Add(this.m_tbIdImportador);
			...
			this.m_gbParametros.Location = new System.Drawing.Point(8, 200);
			...
			// m_tbIdImportador
			// 
			this.m_tbIdImportador.Location = new System.Drawing.Point(464, 45);
			this.m_tbIdImportador.Name = "m_tbIdImportador";
			this.m_tbIdImportador.Size = new System.Drawing.Size(91, 20);
			this.m_tbIdImportador.TabIndex = 11;
			this.m_tbIdImportador.Text = "1";
			this.m_tbIdImportador.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			// 
			// m_tbIdIdioma
			// 
			this.m_tbIdIdioma.Location = new System.Drawing.Point(464, 21);
			this.m_tbIdIdioma.Name = "m_tbIdIdioma";
			this.m_tbIdIdioma.Size = new System.Drawing.Size(91, 20);
			this.m_tbIdIdioma.TabIndex = 10;
			this.m_tbIdIdioma.Text = "3";
			...
			this.m_gbRetorno.Location = new System.Drawing.Point(8, 459);
			...
			// m_btComercial
			// 
			this.m_btComercial.Location = new System.Drawing.Point(132, 20);
			...
			// m_btCotacao
			// 
			this.m_btCotacao.Location = new System.Drawing.Point(12, 20);
			...
			// m_gbStatic
			// 
			this.m_gbStatic.Controls.Add(this.m_btIdioma);
			this.m_gbStatic.Font = new System.Drawing.Font("Arial", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.m_gbStatic.Location = new System.Drawing.Point(8, 280);
			this.m_gbStatic.Name = "m_gbStatic";
			this.m_gbStatic.Size = new System.Drawing.Size(600, 48);
			this.m_gbStatic.TabIndex = 5;
			this.m_gbStatic.TabStop = false;
			this.m_gbStatic.Text = "Static";
			// 
			// m_btIdioma
			// 
			this.m_btIdioma.Location = new System.Drawing.Point(12, 17);
			this.m_btIdioma.Name = "m_btIdioma";
			this.m_btIdioma.Size = new System.Drawing.Size(96, 24);
			this.m_btIdioma.TabIndex = 1;
			this.m_btIdioma.Text = "Idioma";
			...
			this.m_gbStatic.ResumeLayout(false);
...
//				m_cls_dba_ConnectionBD = new mdlDataBaseAccess.clsDataBaseAccessMySql(ref m_cls_tre_tratadorErro,m_txtHost.Text,m_txtUser.Text,m_txtPassword.Text,m_txtDataBaseName.Text);
		...
		#region Eventos
			#region Static
				...
				{
					m_txtRetorno.Text = mdlIdioma.clsIdioma.nIdioma().ToString();
				}
			#endregion
        	...
        	private void m_btCotacao_Click(object sender, System.EventArgs e)
			{
				...
				this.m_txtRetorno.Text = "";
				CreateDataBase();
				mdlIdioma.clsIdioma modIdiomas = new mdlIdioma.clsIdiomaFaturaCotacao(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text,ref m_ilBandeiras);
				modIdiomas.ShowDialog();
				//if (modPesos.m_bModificado)
				//{
					modIdiomas.retornaValores(out nIdioma, out strIdioma);
					this.m_txtRetorno.Text = "IdIdioma: " + nIdioma.ToString() + " StrIdioma: " + strIdioma;
				//	modPesos.retornaValores(out dPesoLiquido,out dPesoBruto,out strUnidade);
				//	this.m_txtRetorno.Text = "Peso Líquido: " + dPesoLiquido.ToString() + " Peso Bruto: " + dPesoBruto.ToString() + " Unidade: " + strUnidade; 
				//}
			}
			...
			private void m_btComercial_Click(object sender, System.EventArgs e)
			{
				...
				this.m_txtRetorno.Text = "";
				CreateDataBase();
				mdlIdioma.clsIdioma modIdiomas = new mdlIdioma.clsIdiomaFaturaComercial(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text,ref m_ilBandeiras);
				modIdiomas.ShowDialog();
				//if (modPesos.m_bModificado)
				//{
					modIdiomas.retornaValores(out nIdioma, out strIdioma);
			...
			private void m_btProforma_Click(object sender, System.EventArgs e)
			{
				...
				this.m_txtRetorno.Text = "";
				CreateDataBase();
				mdlIdioma.clsIdioma modIdiomas = new mdlIdioma.clsIdiomaFaturaProforma(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text,ref m_ilBandeiras);
				modIdiomas.ShowDialog();
				//if (modPesos.m_bModificado)
				//{
					modIdiomas.retornaValores(out nIdioma, out strIdioma);
			...
			{
				int nIdioma, nPais;
				string strIdioma, strPais;
				this.m_txtRetorno.Text = "";
				CreateDataBase();
				mdlIdioma.clsPaisIdioma modPaisIdioma = new mdlIdioma.clsPaisIdiomaConsignatario(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),Int32.Parse(m_tbIdImportador.Text),Int32.Parse(m_txtIdCodigo.Text),Int32.Parse(m_tbIdIdioma.Text),ref m_ilBandeiras);
				modPaisIdioma.ShowDialog();
				//if (modPesos.m_bModificado)
				//{
				modPaisIdioma.retornaValores(out nIdioma, out strIdioma, out nPais, out strPais);
				this.m_txtRetorno.Text = "IdIdioma: " + nIdioma.ToString() + " StrIdioma: " + strIdioma + " IdPais: " + nPais + " StrPais: " + strPais;
				//	modPesos.retornaValores(out dPesoLiquido,out dPesoBruto,out strUnidade);
				//	this.m_txtRetorno.Text = "Peso Líquido: " + dPesoLiquido.ToString() + " Peso Bruto: " + dPesoBruto.ToString() + " Unidade: " + strUnidade; 
				//}
			}
			...
			private void button3_Click(object sender, System.EventArgs e)
			{
				...
				this.m_txtRetorno.Text = "";
				CreateDataBase();
				mdlIdioma.clsPaisIdioma modPaisIdioma = new mdlIdioma.clsPaisIdiomaImportador(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),Int32.Parse(m_tbIdImportador.Text),Int32.Parse(m_tbIdIdioma.Text),ref m_ilBandeiras);
				modPaisIdioma.ShowDialog();
				//if (modPesos.m_bModificado)
				//{
				modPaisIdioma.retornaValores(out nIdioma, out strIdioma, out nPais, out strPais);
			...
			private void button2_Click(object sender, System.EventArgs e)
			{
				...
				this.m_txtRetorno.Text = "";
				CreateDataBase();
				mdlIdioma.clsPaisIdioma modPaisIdioma = new mdlIdioma.clsPaisIdiomaEnderecoEntregaImportador(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),Int32.Parse(m_tbIdImportador.Text),Int32.Parse(m_txtIdCodigo.Text),Int32.Parse(m_tbIdIdioma.Text),ref m_ilBandeiras);
				modPaisIdioma.ShowDialog();
				//if (modPesos.m_bModificado)
				//{
				modPaisIdioma.retornaValores(out nIdioma, out strIdioma, out nPais, out strPais);
			...
			private void m_btSaque_Click(object sender, System.EventArgs e)
			{
				...
				this.m_txtRetorno.Text = "";
				CreateDataBase();
				mdlIdioma.clsIdioma modIdiomas = new mdlIdioma.clsIdiomaSaque(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text,ref m_ilBandeiras);
				modIdiomas.retornaValores(out nIdioma, out strIdioma);
				this.m_txtRetorno.Text = "IdIdioma: " + nIdioma.ToString() + " StrIdioma: " + strIdioma;
				modIdiomas.ShowDialog();
				//if (modPesos.m_bModificado)
			...
			private void m_btRomaneio_Click(object sender, System.EventArgs e)
			{
				...
				this.m_txtRetorno.Text = "";
				CreateDataBase();
				mdlIdioma.clsIdioma modIdiomas = new mdlIdioma.clsIdiomaRomaneio(ref m_cls_tre_tratadorErro,ref m_cls_dba_ConnectionBD,m_txtPath.Text,Int32.Parse(m_txtIdExportador.Text),m_txtIdCodigo.Text,ref m_ilBandeiras);
				modIdiomas.retornaValores(out nIdioma, out strIdioma);
				this.m_txtRetorno.Text = "IdIdioma: " + nIdioma.ToString() + " StrIdioma: " + strIdioma;
				modIdiomas.ShowDialog();
				//if (modPesos.m_bModificado)
